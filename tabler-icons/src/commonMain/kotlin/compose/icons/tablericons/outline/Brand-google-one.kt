...
public val OutlineGroup.`Brand-google-one`: ImageVector
    get() {
        if (`_brand-google-one` != null) {
            return `_brand-google-one`!!
        }
        `_brand-google-one` = Builder(name = "Brand-google-one", defaultWidth = 24.0.dp,
...
private var `_brand-google-one`: ImageVector? = null

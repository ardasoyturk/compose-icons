...
public val OutlineGroup.`Brand-vsco`: ImageVector
    get() {
        if (`_brand-vsco` != null) {
            return `_brand-vsco`!!
        }
        `_brand-vsco` = Builder(name = "Brand-vsco", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-vsco`: ImageVector? = null

...
public val OutlineGroup.`Brand-nord-vpn`: ImageVector
    get() {
        if (`_brand-nord-vpn` != null) {
            return `_brand-nord-vpn`!!
        }
        `_brand-nord-vpn` = Builder(name = "Brand-nord-vpn", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-nord-vpn`: ImageVector? = null

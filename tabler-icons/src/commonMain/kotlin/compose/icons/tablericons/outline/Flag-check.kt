...
public val OutlineGroup.`Flag-check`: ImageVector
    get() {
        if (`_flag-check` != null) {
            return `_flag-check`!!
        }
        `_flag-check` = Builder(name = "Flag-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flag-check`: ImageVector? = null

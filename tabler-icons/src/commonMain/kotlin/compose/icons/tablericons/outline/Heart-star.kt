...
public val OutlineGroup.`Heart-star`: ImageVector
    get() {
        if (`_heart-star` != null) {
            return `_heart-star`!!
        }
        `_heart-star` = Builder(name = "Heart-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_heart-star`: ImageVector? = null

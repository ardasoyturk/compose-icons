...
public val LucideIcons.LaptopMinimalCheck: ImageVector
    get() {
        if (_laptopMinimalCheck != null) {
            return _laptopMinimalCheck!!
        }
        _laptopMinimalCheck = Builder(name = "LaptopMinimalCheck", defaultWidth = 24.0.dp,

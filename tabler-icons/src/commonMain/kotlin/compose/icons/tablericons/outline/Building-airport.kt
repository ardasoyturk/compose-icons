...
public val OutlineGroup.`Building-airport`: ImageVector
    get() {
        if (`_building-airport` != null) {
            return `_building-airport`!!
        }
        `_building-airport` = Builder(name = "Building-airport", defaultWidth = 24.0.dp,
...
private var `_building-airport`: ImageVector? = null

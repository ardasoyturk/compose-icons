...
public val OutlineGroup.`Brand-swift`: ImageVector
    get() {
        if (`_brand-swift` != null) {
            return `_brand-swift`!!
        }
        `_brand-swift` = Builder(name = "Brand-swift", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-swift`: ImageVector? = null

...
public val OutlineGroup.`Cloud-network`: ImageVector
    get() {
        if (`_cloud-network` != null) {
            return `_cloud-network`!!
        }
        `_cloud-network` = Builder(name = "Cloud-network", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-network`: ImageVector? = null

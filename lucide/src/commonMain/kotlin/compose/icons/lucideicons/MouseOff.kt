...
public val LucideIcons.MouseOff: ImageVector
    get() {
        if (_mouseOff != null) {
            return _mouseOff!!
        }
        _mouseOff = Builder(name = "MouseOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                verticalLineTo(9.0f)
                arcToRelative(7.0f, 7.0f, 0.0f, false, true, 0.782f, -3.218f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(19.0f, 13.343f)
                verticalLineTo(9.0f)
                arcTo(7.0f, 7.0f, 0.0f, false, false, 8.56f, 2.902f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {

...
public val OutlineGroup.`Basket-plus`: ImageVector
    get() {
        if (`_basket-plus` != null) {
            return `_basket-plus`!!
        }
        `_basket-plus` = Builder(name = "Basket-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-plus`: ImageVector? = null

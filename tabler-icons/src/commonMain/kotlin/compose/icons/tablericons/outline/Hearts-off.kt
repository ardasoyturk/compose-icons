...
public val OutlineGroup.`Hearts-off`: ImageVector
    get() {
        if (`_hearts-off` != null) {
            return `_hearts-off`!!
        }
        `_hearts-off` = Builder(name = "Hearts-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hearts-off`: ImageVector? = null

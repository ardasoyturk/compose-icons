...
public val LucideIcons.ReceiptTurkishLira: ImageVector
    get() {
        if (_receiptTurkishLira != null) {
            return _receiptTurkishLira!!
        }
        _receiptTurkishLira = Builder(name = "ReceiptTurkishLira", defaultWidth = 24.0.dp,

...
public val OutlineGroup.`Brand-envato`: ImageVector
    get() {
        if (`_brand-envato` != null) {
            return `_brand-envato`!!
        }
        `_brand-envato` = Builder(name = "Brand-envato", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-envato`: ImageVector? = null

...
public val OutlineGroup.`Brand-codecov`: ImageVector
    get() {
        if (`_brand-codecov` != null) {
            return `_brand-codecov`!!
        }
        `_brand-codecov` = Builder(name = "Brand-codecov", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-codecov`: ImageVector? = null

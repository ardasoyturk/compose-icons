...
public val OutlineGroup.`Pointer-off`: ImageVector
    get() {
        if (`_pointer-off` != null) {
            return `_pointer-off`!!
        }
        `_pointer-off` = Builder(name = "Pointer-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-off`: ImageVector? = null

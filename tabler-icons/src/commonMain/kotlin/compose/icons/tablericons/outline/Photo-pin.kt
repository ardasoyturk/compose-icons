...
public val OutlineGroup.`Photo-pin`: ImageVector
    get() {
        if (`_photo-pin` != null) {
            return `_photo-pin`!!
        }
        `_photo-pin` = Builder(name = "Photo-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_photo-pin`: ImageVector? = null

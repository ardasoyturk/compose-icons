...
public val OutlineGroup.`Arrows-join-2`: ImageVector
    get() {
        if (`_arrows-join-2` != null) {
            return `_arrows-join-2`!!
        }
        `_arrows-join-2` = Builder(name = "Arrows-join-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrows-join-2`: ImageVector? = null

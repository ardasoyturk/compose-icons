...
public val OutlineGroup.`Haze-moon`: ImageVector
    get() {
        if (`_haze-moon` != null) {
            return `_haze-moon`!!
        }
        `_haze-moon` = Builder(name = "Haze-moon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_haze-moon`: ImageVector? = null

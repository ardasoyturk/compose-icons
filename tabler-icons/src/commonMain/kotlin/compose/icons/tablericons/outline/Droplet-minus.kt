...
public val OutlineGroup.`Droplet-minus`: ImageVector
    get() {
        if (`_droplet-minus` != null) {
            return `_droplet-minus`!!
        }
        `_droplet-minus` = Builder(name = "Droplet-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-minus`: ImageVector? = null

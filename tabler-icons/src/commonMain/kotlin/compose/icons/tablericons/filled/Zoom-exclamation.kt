...
public val FilledGroup.`Zoom-exclamation`: ImageVector
    get() {
        if (`_zoom-exclamation` != null) {
            return `_zoom-exclamation`!!
        }
        `_zoom-exclamation` = Builder(name = "Zoom-exclamation", defaultWidth = 24.0.dp,
...
private var `_zoom-exclamation`: ImageVector? = null

...
public val OutlineGroup.`Pentagon-minus`: ImageVector
    get() {
        if (`_pentagon-minus` != null) {
            return `_pentagon-minus`!!
        }
        `_pentagon-minus` = Builder(name = "Pentagon-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pentagon-minus`: ImageVector? = null

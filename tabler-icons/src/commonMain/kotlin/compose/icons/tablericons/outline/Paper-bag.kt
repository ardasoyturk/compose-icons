...
public val OutlineGroup.`Paper-bag`: ImageVector
    get() {
        if (`_paper-bag` != null) {
            return `_paper-bag`!!
        }
        `_paper-bag` = Builder(name = "Paper-bag", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_paper-bag`: ImageVector? = null

...
public val OutlineGroup.`Settings-pause`: ImageVector
    get() {
        if (`_settings-pause` != null) {
            return `_settings-pause`!!
        }
        `_settings-pause` = Builder(name = "Settings-pause", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-pause`: ImageVector? = null

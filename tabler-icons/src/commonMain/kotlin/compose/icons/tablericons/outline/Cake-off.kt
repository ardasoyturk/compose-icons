...
public val OutlineGroup.`Cake-off`: ImageVector
    get() {
        if (`_cake-off` != null) {
            return `_cake-off`!!
        }
        `_cake-off` = Builder(name = "Cake-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cake-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-ember`: ImageVector
    get() {
        if (`_brand-ember` != null) {
            return `_brand-ember`!!
        }
        `_brand-ember` = Builder(name = "Brand-ember", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-ember`: ImageVector? = null

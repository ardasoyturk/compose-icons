...
public val OutlineGroup.`Hexagon-plus-2`: ImageVector
    get() {
        if (`_hexagon-plus-2` != null) {
            return `_hexagon-plus-2`!!
        }
        `_hexagon-plus-2` = Builder(name = "Hexagon-plus-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hexagon-plus-2`: ImageVector? = null

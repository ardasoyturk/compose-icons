...
public val OutlineGroup.`Brand-twitter`: ImageVector
    get() {
        if (`_brand-twitter` != null) {
            return `_brand-twitter`!!
        }
        `_brand-twitter` = Builder(name = "Brand-twitter", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-twitter`: ImageVector? = null

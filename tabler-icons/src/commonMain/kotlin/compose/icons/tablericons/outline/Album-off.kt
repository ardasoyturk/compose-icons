...
public val OutlineGroup.`Album-off`: ImageVector
    get() {
        if (`_album-off` != null) {
            return `_album-off`!!
        }
        `_album-off` = Builder(name = "Album-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_album-off`: ImageVector? = null

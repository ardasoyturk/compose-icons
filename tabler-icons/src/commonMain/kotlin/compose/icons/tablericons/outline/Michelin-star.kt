...
public val OutlineGroup.`Michelin-star`: ImageVector
    get() {
        if (`_michelin-star` != null) {
            return `_michelin-star`!!
        }
        `_michelin-star` = Builder(name = "Michelin-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_michelin-star`: ImageVector? = null

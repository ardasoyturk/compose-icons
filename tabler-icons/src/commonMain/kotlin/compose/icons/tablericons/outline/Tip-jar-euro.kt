...
public val OutlineGroup.`Tip-jar-euro`: ImageVector
    get() {
        if (`_tip-jar-euro` != null) {
            return `_tip-jar-euro`!!
        }
        `_tip-jar-euro` = Builder(name = "Tip-jar-euro", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_tip-jar-euro`: ImageVector? = null

...
public val OutlineGroup.`Irregular-polyhedron`: ImageVector
    get() {
        if (`_irregular-polyhedron` != null) {
            return `_irregular-polyhedron`!!
        }
        `_irregular-polyhedron` = Builder(name = "Irregular-polyhedron", defaultWidth = 24.0.dp,
...
private var `_irregular-polyhedron`: ImageVector? = null

...
public val OutlineGroup.`Sun-off`: ImageVector
    get() {
        if (`_sun-off` != null) {
            return `_sun-off`!!
        }
        `_sun-off` = Builder(name = "Sun-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_sun-off`: ImageVector? = null

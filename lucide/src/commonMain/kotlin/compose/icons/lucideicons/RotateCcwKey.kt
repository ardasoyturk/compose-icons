...
public val LucideIcons.RotateCcwKey: ImageVector
    get() {
        if (_rotateCcwKey != null) {
            return _rotateCcwKey!!
        }
        _rotateCcwKey = Builder(name = "RotateCcwKey", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(9.74f, 9.74f, 0.0f, false, false, -6.74f, 2.74f)
                lineTo(3.0f, 8.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =

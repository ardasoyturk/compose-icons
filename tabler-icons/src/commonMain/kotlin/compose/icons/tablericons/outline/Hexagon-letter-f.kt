...
public val OutlineGroup.`Hexagon-letter-f`: ImageVector
    get() {
        if (`_hexagon-letter-f` != null) {
            return `_hexagon-letter-f`!!
        }
        `_hexagon-letter-f` = Builder(name = "Hexagon-letter-f", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-f`: ImageVector? = null

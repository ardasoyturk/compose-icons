...
public val LucideIcons.RulerDimensionLine: ImageVector
    get() {
        if (_rulerDimensionLine != null) {
            return _rulerDimensionLine!!
        }
        _rulerDimensionLine = Builder(name = "RulerDimensionLine", defaultWidth = 24.0.dp,

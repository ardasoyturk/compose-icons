...
public val OutlineGroup.`Pizza-off`: ImageVector
    get() {
        if (`_pizza-off` != null) {
            return `_pizza-off`!!
        }
        `_pizza-off` = Builder(name = "Pizza-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_pizza-off`: ImageVector? = null

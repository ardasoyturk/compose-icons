...
public val OutlineGroup.`Bubble-minus`: ImageVector
    get() {
        if (`_bubble-minus` != null) {
            return `_bubble-minus`!!
        }
        `_bubble-minus` = Builder(name = "Bubble-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bubble-minus`: ImageVector? = null

...
public val OutlineGroup.`Accessible-off`: ImageVector
    get() {
        if (`_accessible-off` != null) {
            return `_accessible-off`!!
        }
        `_accessible-off` = Builder(name = "Accessible-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_accessible-off`: ImageVector? = null

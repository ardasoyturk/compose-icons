...
public val OutlineGroup.`Hexagon-3d`: ImageVector
    get() {
        if (`_hexagon-3d` != null) {
            return `_hexagon-3d`!!
        }
        `_hexagon-3d` = Builder(name = "Hexagon-3d", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hexagon-3d`: ImageVector? = null

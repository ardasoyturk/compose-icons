...
public val OutlineGroup.`Device-tablet-star`: ImageVector
    get() {
        if (`_device-tablet-star` != null) {
            return `_device-tablet-star`!!
        }
        `_device-tablet-star` = Builder(name = "Device-tablet-star", defaultWidth = 24.0.dp,
...
private var `_device-tablet-star`: ImageVector? = null

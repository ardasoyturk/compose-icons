...
public val OutlineGroup.`Panorama-horizontal`: ImageVector
    get() {
        if (`_panorama-horizontal` != null) {
            return `_panorama-horizontal`!!
        }
        `_panorama-horizontal` = Builder(name = "Panorama-horizontal", defaultWidth = 24.0.dp,
...
private var `_panorama-horizontal`: ImageVector? = null

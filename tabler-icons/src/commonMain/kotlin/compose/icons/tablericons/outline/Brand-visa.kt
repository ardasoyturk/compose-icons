...
public val OutlineGroup.`Brand-visa`: ImageVector
    get() {
        if (`_brand-visa` != null) {
            return `_brand-visa`!!
        }
        `_brand-visa` = Builder(name = "Brand-visa", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-visa`: ImageVector? = null

...
public val OutlineGroup.`Hexagonal-pyramid-off`: ImageVector
    get() {
        if (`_hexagonal-pyramid-off` != null) {
            return `_hexagonal-pyramid-off`!!
        }
        `_hexagonal-pyramid-off` = Builder(name = "Hexagonal-pyramid-off", defaultWidth = 24.0.dp,
...
private var `_hexagonal-pyramid-off`: ImageVector? = null

...
public val OutlineGroup.`View-360-off`: ImageVector
    get() {
        if (`_view-360-off` != null) {
            return `_view-360-off`!!
        }
        `_view-360-off` = Builder(name = "View-360-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_view-360-off`: ImageVector? = null

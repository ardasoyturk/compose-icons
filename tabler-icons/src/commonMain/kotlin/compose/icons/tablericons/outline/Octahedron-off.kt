...
public val OutlineGroup.`Octahedron-off`: ImageVector
    get() {
        if (`_octahedron-off` != null) {
            return `_octahedron-off`!!
        }
        `_octahedron-off` = Builder(name = "Octahedron-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_octahedron-off`: ImageVector? = null

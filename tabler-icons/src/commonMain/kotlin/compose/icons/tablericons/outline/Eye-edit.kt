...
public val OutlineGroup.`Eye-edit`: ImageVector
    get() {
        if (`_eye-edit` != null) {
            return `_eye-edit`!!
        }
        `_eye-edit` = Builder(name = "Eye-edit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-edit`: ImageVector? = null

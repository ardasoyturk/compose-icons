...
public val OutlineGroup.`Panorama-vertical-off`: ImageVector
    get() {
        if (`_panorama-vertical-off` != null) {
            return `_panorama-vertical-off`!!
        }
        `_panorama-vertical-off` = Builder(name = "Panorama-vertical-off", defaultWidth = 24.0.dp,
...
private var `_panorama-vertical-off`: ImageVector? = null

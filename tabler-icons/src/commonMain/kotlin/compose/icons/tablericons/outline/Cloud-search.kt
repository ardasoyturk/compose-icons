...
public val OutlineGroup.`Cloud-search`: ImageVector
    get() {
        if (`_cloud-search` != null) {
            return `_cloud-search`!!
        }
        `_cloud-search` = Builder(name = "Cloud-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-search`: ImageVector? = null

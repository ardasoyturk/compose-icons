...
public val OutlineGroup.`Brand-onedrive`: ImageVector
    get() {
        if (`_brand-onedrive` != null) {
            return `_brand-onedrive`!!
        }
        `_brand-onedrive` = Builder(name = "Brand-onedrive", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-onedrive`: ImageVector? = null

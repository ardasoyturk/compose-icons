...
public val OutlineGroup.`Cash-banknote-heart`: ImageVector
    get() {
        if (`_cash-banknote-heart` != null) {
            return `_cash-banknote-heart`!!
        }
        `_cash-banknote-heart` = Builder(name = "Cash-banknote-heart", defaultWidth = 24.0.dp,
...
private var `_cash-banknote-heart`: ImageVector? = null

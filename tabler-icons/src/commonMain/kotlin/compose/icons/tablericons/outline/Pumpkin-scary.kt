...
public val OutlineGroup.`Pumpkin-scary`: ImageVector
    get() {
        if (`_pumpkin-scary` != null) {
            return `_pumpkin-scary`!!
        }
        `_pumpkin-scary` = Builder(name = "Pumpkin-scary", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pumpkin-scary`: ImageVector? = null

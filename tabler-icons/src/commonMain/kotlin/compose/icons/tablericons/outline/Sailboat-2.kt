...
public val OutlineGroup.`Sailboat-2`: ImageVector
    get() {
        if (`_sailboat-2` != null) {
            return `_sailboat-2`!!
        }
        `_sailboat-2` = Builder(name = "Sailboat-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sailboat-2`: ImageVector? = null

...
public val OutlineGroup.`Brand-adobe`: ImageVector
    get() {
        if (`_brand-adobe` != null) {
            return `_brand-adobe`!!
        }
        `_brand-adobe` = Builder(name = "Brand-adobe", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-adobe`: ImageVector? = null

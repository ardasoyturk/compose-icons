...
public val FilledGroup.`Play-card-7`: ImageVector
    get() {
        if (`_play-card-7` != null) {
            return `_play-card-7`!!
        }
        `_play-card-7` = Builder(name = "Play-card-7", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, true, false, 1.897f, 0.632f)
...
private var `_play-card-7`: ImageVector? = null

...
public val OutlineGroup.`Alert-square-rounded-off`: ImageVector
    get() {
        if (`_alert-square-rounded-off` != null) {
            return `_alert-square-rounded-off`!!
        }
        `_alert-square-rounded-off` = Builder(name = "Alert-square-rounded-off", defaultWidth =
...
private var `_alert-square-rounded-off`: ImageVector? = null

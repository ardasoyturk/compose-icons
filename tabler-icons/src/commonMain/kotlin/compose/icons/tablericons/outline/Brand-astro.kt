...
public val OutlineGroup.`Brand-astro`: ImageVector
    get() {
        if (`_brand-astro` != null) {
            return `_brand-astro`!!
        }
        `_brand-astro` = Builder(name = "Brand-astro", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-astro`: ImageVector? = null

...
public val OutlineGroup.`Home-shield`: ImageVector
    get() {
        if (`_home-shield` != null) {
            return `_home-shield`!!
        }
        `_home-shield` = Builder(name = "Home-shield", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-shield`: ImageVector? = null

...
public val OutlineGroup.`Message-circle-question`: ImageVector
    get() {
        if (`_message-circle-question` != null) {
            return `_message-circle-question`!!
        }
        `_message-circle-question` = Builder(name = "Message-circle-question", defaultWidth =
...
private var `_message-circle-question`: ImageVector? = null

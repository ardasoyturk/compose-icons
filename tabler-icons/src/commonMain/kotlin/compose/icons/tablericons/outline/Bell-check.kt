...
public val OutlineGroup.`Bell-check`: ImageVector
    get() {
        if (`_bell-check` != null) {
            return `_bell-check`!!
        }
        `_bell-check` = Builder(name = "Bell-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bell-check`: ImageVector? = null

...
public val OutlineGroup.`Triangle-plus`: ImageVector
    get() {
        if (`_triangle-plus` != null) {
            return `_triangle-plus`!!
        }
        `_triangle-plus` = Builder(name = "Triangle-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_triangle-plus`: ImageVector? = null

...
public val OutlineGroup.`Radioactive-off`: ImageVector
    get() {
        if (`_radioactive-off` != null) {
            return `_radioactive-off`!!
        }
        `_radioactive-off` = Builder(name = "Radioactive-off", defaultWidth = 24.0.dp, defaultHeight
...
private var `_radioactive-off`: ImageVector? = null

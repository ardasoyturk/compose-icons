...
public val LucideIcons.MessageSquareWarning: ImageVector
    get() {
        if (_messageSquareWarning != null) {
            return _messageSquareWarning!!
        }
        _messageSquareWarning = Builder(name = "MessageSquareWarning", defaultWidth = 24.0.dp,

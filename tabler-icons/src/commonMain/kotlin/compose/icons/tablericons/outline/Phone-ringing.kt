...
public val OutlineGroup.`Phone-ringing`: ImageVector
    get() {
        if (`_phone-ringing` != null) {
            return `_phone-ringing`!!
        }
        `_phone-ringing` = Builder(name = "Phone-ringing", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-ringing`: ImageVector? = null

...
public val OutlineGroup.`Brand-rust`: ImageVector
    get() {
        if (`_brand-rust` != null) {
            return `_brand-rust`!!
        }
        `_brand-rust` = Builder(name = "Brand-rust", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-rust`: ImageVector? = null

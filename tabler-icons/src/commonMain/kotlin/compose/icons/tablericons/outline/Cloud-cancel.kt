...
public val OutlineGroup.`Cloud-cancel`: ImageVector
    get() {
        if (`_cloud-cancel` != null) {
            return `_cloud-cancel`!!
        }
        `_cloud-cancel` = Builder(name = "Cloud-cancel", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-cancel`: ImageVector? = null

...
public val OutlineGroup.`Message-circle-star`: ImageVector
    get() {
        if (`_message-circle-star` != null) {
            return `_message-circle-star`!!
        }
        `_message-circle-star` = Builder(name = "Message-circle-star", defaultWidth = 24.0.dp,
...
private var `_message-circle-star`: ImageVector? = null

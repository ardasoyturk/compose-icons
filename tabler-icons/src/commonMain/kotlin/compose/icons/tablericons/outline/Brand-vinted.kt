...
public val OutlineGroup.`Brand-vinted`: ImageVector
    get() {
        if (`_brand-vinted` != null) {
            return `_brand-vinted`!!
        }
        `_brand-vinted` = Builder(name = "Brand-vinted", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-vinted`: ImageVector? = null

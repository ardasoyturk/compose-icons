...
public val OutlineGroup.`Navigation-question`: ImageVector
    get() {
        if (`_navigation-question` != null) {
            return `_navigation-question`!!
        }
        `_navigation-question` = Builder(name = "Navigation-question", defaultWidth = 24.0.dp,
...
private var `_navigation-question`: ImageVector? = null

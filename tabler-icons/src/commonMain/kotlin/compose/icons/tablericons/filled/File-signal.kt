...
public val FilledGroup.`File-signal`: ImageVector
    get() {
        if (`_file-signal` != null) {
            return `_file-signal`!!
        }
        `_file-signal` = Builder(name = "File-signal", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(4.5f, 4.5f, 0.0f, false, false, 0.0f, 6.364f)
...
private var `_file-signal`: ImageVector? = null

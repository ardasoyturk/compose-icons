...
public val OutlineGroup.`Brand-topbuzz`: ImageVector
    get() {
        if (`_brand-topbuzz` != null) {
            return `_brand-topbuzz`!!
        }
        `_brand-topbuzz` = Builder(name = "Brand-topbuzz", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-topbuzz`: ImageVector? = null

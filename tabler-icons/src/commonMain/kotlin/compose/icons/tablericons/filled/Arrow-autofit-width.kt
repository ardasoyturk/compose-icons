...
public val FilledGroup.`Arrow-autofit-width`: ImageVector
    get() {
        if (`_arrow-autofit-width` != null) {
            return `_arrow-autofit-width`!!
        }
        `_arrow-autofit-width` = Builder(name = "Arrow-autofit-width", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -0.515f, 1.59f)
                ...
                arcToRelative(0.514f, 0.514f, 0.0f, false, true, -0.878f, -0.363f)
                lineToRelative(-0.001f, -6.515f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 3.0f, -3.0f)
                horizontalLineToRelative(12.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 3.0f, 3.0f)
                verticalLineToRelative(6.514f)
                arcToRelative(0.515f, 0.515f, 0.0f, false, true, -0.879f, 0.365f)
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
...
private var `_arrow-autofit-width`: ImageVector? = null

...
public val OutlineGroup.`Horse-toy`: ImageVector
    get() {
        if (`_horse-toy` != null) {
            return `_horse-toy`!!
        }
        `_horse-toy` = Builder(name = "Horse-toy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_horse-toy`: ImageVector? = null

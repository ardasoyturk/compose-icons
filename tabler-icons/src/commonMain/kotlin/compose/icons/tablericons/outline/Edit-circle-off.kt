...
public val OutlineGroup.`Edit-circle-off`: ImageVector
    get() {
        if (`_edit-circle-off` != null) {
            return `_edit-circle-off`!!
        }
        `_edit-circle-off` = Builder(name = "Edit-circle-off", defaultWidth = 24.0.dp, defaultHeight
...
private var `_edit-circle-off`: ImageVector? = null

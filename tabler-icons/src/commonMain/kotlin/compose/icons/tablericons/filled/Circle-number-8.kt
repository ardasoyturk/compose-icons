...
public val FilledGroup.`Circle-number-8`: ImageVector
    get() {
        if (`_circle-number-8` != null) {
            return `_circle-number-8`!!
        }
        `_circle-number-8` = Builder(name = "Circle-number-8", defaultWidth = 24.0.dp, defaultHeight
...
private var `_circle-number-8`: ImageVector? = null

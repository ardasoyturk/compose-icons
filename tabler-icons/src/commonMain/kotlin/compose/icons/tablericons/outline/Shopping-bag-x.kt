...
public val OutlineGroup.`Shopping-bag-x`: ImageVector
    get() {
        if (`_shopping-bag-x` != null) {
            return `_shopping-bag-x`!!
        }
        `_shopping-bag-x` = Builder(name = "Shopping-bag-x", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shopping-bag-x`: ImageVector? = null

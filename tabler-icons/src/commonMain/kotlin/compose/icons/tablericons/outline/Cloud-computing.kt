...
public val OutlineGroup.`Cloud-computing`: ImageVector
    get() {
        if (`_cloud-computing` != null) {
            return `_cloud-computing`!!
        }
        `_cloud-computing` = Builder(name = "Cloud-computing", defaultWidth = 24.0.dp, defaultHeight
...
private var `_cloud-computing`: ImageVector? = null

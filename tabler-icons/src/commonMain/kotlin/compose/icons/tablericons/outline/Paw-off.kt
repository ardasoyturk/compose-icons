...
public val OutlineGroup.`Paw-off`: ImageVector
    get() {
        if (`_paw-off` != null) {
            return `_paw-off`!!
        }
        `_paw-off` = Builder(name = "Paw-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_paw-off`: ImageVector? = null

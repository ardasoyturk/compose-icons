...
public val OutlineGroup.`Premium-rights`: ImageVector
    get() {
        if (`_premium-rights` != null) {
            return `_premium-rights`!!
        }
        `_premium-rights` = Builder(name = "Premium-rights", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_premium-rights`: ImageVector? = null

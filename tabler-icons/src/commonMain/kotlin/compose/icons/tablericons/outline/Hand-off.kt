...
public val OutlineGroup.`Hand-off`: ImageVector
    get() {
        if (`_hand-off` != null) {
            return `_hand-off`!!
        }
        `_hand-off` = Builder(name = "Hand-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_hand-off`: ImageVector? = null

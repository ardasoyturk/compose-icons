...
public val LucideIcons.Cannabis: ImageVector
    get() {
        if (_cannabis != null) {
            return _cannabis!!
        }
        _cannabis = Builder(name = "Cannabis", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 0.0f, 2.5f, 0.5f, 6.0f, -1.0f)
                curveToRelative(-0.5f, -1.5f, -3.5f, -3.0f, -5.0f, -3.0f)
                curveToRelative(1.5f, -1.0f, 4.0f, -4.0f, 4.0f, -6.0f)
                curveToRelative(-2.5f, 0.0f, -5.5f, 1.5f, -7.0f, 3.0f)
                curveToRelative(0.0f, -2.5f, -0.5f, -5.0f, -2.0f, -7.0f)
                curveToRelative(-1.5f, 2.0f, -2.0f, 4.5f, -2.0f, 7.0f)
                curveToRelative(-1.5f, -1.5f, -4.5f, -3.0f, -7.0f, -3.0f)

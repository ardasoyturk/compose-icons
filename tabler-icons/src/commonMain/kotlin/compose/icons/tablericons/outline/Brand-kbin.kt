...
public val OutlineGroup.`Brand-kbin`: ImageVector
    get() {
        if (`_brand-kbin` != null) {
            return `_brand-kbin`!!
        }
        `_brand-kbin` = Builder(name = "Brand-kbin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-kbin`: ImageVector? = null

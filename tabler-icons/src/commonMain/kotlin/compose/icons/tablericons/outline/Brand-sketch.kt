...
public val OutlineGroup.`Brand-sketch`: ImageVector
    get() {
        if (`_brand-sketch` != null) {
            return `_brand-sketch`!!
        }
        `_brand-sketch` = Builder(name = "Brand-sketch", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-sketch`: ImageVector? = null

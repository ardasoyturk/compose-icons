...
public val OutlineGroup.`Hexagon-letter-k`: ImageVector
    get() {
        if (`_hexagon-letter-k` != null) {
            return `_hexagon-letter-k`!!
        }
        `_hexagon-letter-k` = Builder(name = "Hexagon-letter-k", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-k`: ImageVector? = null

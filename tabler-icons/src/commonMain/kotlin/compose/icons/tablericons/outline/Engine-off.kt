...
public val OutlineGroup.`Engine-off`: ImageVector
    get() {
        if (`_engine-off` != null) {
            return `_engine-off`!!
        }
        `_engine-off` = Builder(name = "Engine-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_engine-off`: ImageVector? = null

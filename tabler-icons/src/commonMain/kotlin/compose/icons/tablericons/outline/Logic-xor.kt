...
public val OutlineGroup.`Logic-xor`: ImageVector
    get() {
        if (`_logic-xor` != null) {
            return `_logic-xor`!!
        }
        `_logic-xor` = Builder(name = "Logic-xor", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_logic-xor`: ImageVector? = null

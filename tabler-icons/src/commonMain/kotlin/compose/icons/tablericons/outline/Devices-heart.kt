...
public val OutlineGroup.`Devices-heart`: ImageVector
    get() {
        if (`_devices-heart` != null) {
            return `_devices-heart`!!
        }
        `_devices-heart` = Builder(name = "Devices-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_devices-heart`: ImageVector? = null

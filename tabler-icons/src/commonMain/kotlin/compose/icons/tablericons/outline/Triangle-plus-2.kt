...
public val OutlineGroup.`Triangle-plus-2`: ImageVector
    get() {
        if (`_triangle-plus-2` != null) {
            return `_triangle-plus-2`!!
        }
        `_triangle-plus-2` = Builder(name = "Triangle-plus-2", defaultWidth = 24.0.dp, defaultHeight
...
private var `_triangle-plus-2`: ImageVector? = null

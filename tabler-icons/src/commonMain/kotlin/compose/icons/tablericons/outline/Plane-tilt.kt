...
public val OutlineGroup.`Plane-tilt`: ImageVector
    get() {
        if (`_plane-tilt` != null) {
            return `_plane-tilt`!!
        }
        `_plane-tilt` = Builder(name = "Plane-tilt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_plane-tilt`: ImageVector? = null

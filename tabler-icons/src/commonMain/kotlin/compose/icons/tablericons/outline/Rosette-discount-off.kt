...
public val OutlineGroup.`Rosette-discount-off`: ImageVector
    get() {
        if (`_rosette-discount-off` != null) {
            return `_rosette-discount-off`!!
        }
        `_rosette-discount-off` = Builder(name = "Rosette-discount-off", defaultWidth = 24.0.dp,
...
private var `_rosette-discount-off`: ImageVector? = null

...
public val OutlineGroup.`Circle-dashed-letter-z`: ImageVector
    get() {
        if (`_circle-dashed-letter-z` != null) {
            return `_circle-dashed-letter-z`!!
        }
        `_circle-dashed-letter-z` = Builder(name = "Circle-dashed-letter-z", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-z`: ImageVector? = null

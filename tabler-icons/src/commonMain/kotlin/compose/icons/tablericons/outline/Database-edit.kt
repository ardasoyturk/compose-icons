...
public val OutlineGroup.`Database-edit`: ImageVector
    get() {
        if (`_database-edit` != null) {
            return `_database-edit`!!
        }
        `_database-edit` = Builder(name = "Database-edit", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-edit`: ImageVector? = null

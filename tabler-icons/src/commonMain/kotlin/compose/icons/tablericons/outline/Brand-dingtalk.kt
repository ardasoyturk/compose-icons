...
public val OutlineGroup.`Brand-dingtalk`: ImageVector
    get() {
        if (`_brand-dingtalk` != null) {
            return `_brand-dingtalk`!!
        }
        `_brand-dingtalk` = Builder(name = "Brand-dingtalk", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-dingtalk`: ImageVector? = null

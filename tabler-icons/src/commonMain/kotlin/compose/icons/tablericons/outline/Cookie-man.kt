...
public val OutlineGroup.`Cookie-man`: ImageVector
    get() {
        if (`_cookie-man` != null) {
            return `_cookie-man`!!
        }
        `_cookie-man` = Builder(name = "Cookie-man", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cookie-man`: ImageVector? = null

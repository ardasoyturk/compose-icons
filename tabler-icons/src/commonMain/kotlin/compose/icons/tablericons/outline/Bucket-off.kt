...
public val OutlineGroup.`Bucket-off`: ImageVector
    get() {
        if (`_bucket-off` != null) {
            return `_bucket-off`!!
        }
        `_bucket-off` = Builder(name = "Bucket-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bucket-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-tinder`: ImageVector
    get() {
        if (`_brand-tinder` != null) {
            return `_brand-tinder`!!
        }
        `_brand-tinder` = Builder(name = "Brand-tinder", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-tinder`: ImageVector? = null

...
public val OutlineGroup.`Rosette-number-5`: ImageVector
    get() {
        if (`_rosette-number-5` != null) {
            return `_rosette-number-5`!!
        }
        `_rosette-number-5` = Builder(name = "Rosette-number-5", defaultWidth = 24.0.dp,
...
private var `_rosette-number-5`: ImageVector? = null

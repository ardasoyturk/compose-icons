...
public val OutlineGroup.`Brand-google-maps`: ImageVector
    get() {
        if (`_brand-google-maps` != null) {
            return `_brand-google-maps`!!
        }
        `_brand-google-maps` = Builder(name = "Brand-google-maps", defaultWidth = 24.0.dp,
...
private var `_brand-google-maps`: ImageVector? = null

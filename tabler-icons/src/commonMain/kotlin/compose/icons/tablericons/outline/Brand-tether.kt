...
public val OutlineGroup.`Brand-tether`: ImageVector
    get() {
        if (`_brand-tether` != null) {
            return `_brand-tether`!!
        }
        `_brand-tether` = Builder(name = "Brand-tether", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-tether`: ImageVector? = null

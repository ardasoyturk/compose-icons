...
public val OutlineGroup.`Message-2-heart`: ImageVector
    get() {
        if (`_message-2-heart` != null) {
            return `_message-2-heart`!!
        }
        `_message-2-heart` = Builder(name = "Message-2-heart", defaultWidth = 24.0.dp, defaultHeight
...
private var `_message-2-heart`: ImageVector? = null

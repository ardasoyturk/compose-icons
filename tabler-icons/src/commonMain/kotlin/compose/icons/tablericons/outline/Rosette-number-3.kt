...
public val OutlineGroup.`Rosette-number-3`: ImageVector
    get() {
        if (`_rosette-number-3` != null) {
            return `_rosette-number-3`!!
        }
        `_rosette-number-3` = Builder(name = "Rosette-number-3", defaultWidth = 24.0.dp,
...
private var `_rosette-number-3`: ImageVector? = null

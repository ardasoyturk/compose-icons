...
public val OutlineGroup.`Pointer-dollar`: ImageVector
    get() {
        if (`_pointer-dollar` != null) {
            return `_pointer-dollar`!!
        }
        `_pointer-dollar` = Builder(name = "Pointer-dollar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-dollar`: ImageVector? = null

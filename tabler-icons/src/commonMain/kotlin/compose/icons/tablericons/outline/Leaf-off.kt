...
public val OutlineGroup.`Leaf-off`: ImageVector
    get() {
        if (`_leaf-off` != null) {
            return `_leaf-off`!!
        }
        `_leaf-off` = Builder(name = "Leaf-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_leaf-off`: ImageVector? = null

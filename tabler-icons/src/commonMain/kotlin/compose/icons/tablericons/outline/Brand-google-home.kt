...
public val OutlineGroup.`Brand-google-home`: ImageVector
    get() {
        if (`_brand-google-home` != null) {
            return `_brand-google-home`!!
        }
        `_brand-google-home` = Builder(name = "Brand-google-home", defaultWidth = 24.0.dp,
...
private var `_brand-google-home`: ImageVector? = null

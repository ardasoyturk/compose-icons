...
public val OutlineGroup.`Sort-descending-small-big`: ImageVector
    get() {
        if (`_sort-descending-small-big` != null) {
            return `_sort-descending-small-big`!!
        }
        `_sort-descending-small-big` = Builder(name = "Sort-descending-small-big", defaultWidth =
...
private var `_sort-descending-small-big`: ImageVector? = null

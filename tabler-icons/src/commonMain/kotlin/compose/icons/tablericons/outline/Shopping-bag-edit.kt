...
public val OutlineGroup.`Shopping-bag-edit`: ImageVector
    get() {
        if (`_shopping-bag-edit` != null) {
            return `_shopping-bag-edit`!!
        }
        `_shopping-bag-edit` = Builder(name = "Shopping-bag-edit", defaultWidth = 24.0.dp,
...
private var `_shopping-bag-edit`: ImageVector? = null

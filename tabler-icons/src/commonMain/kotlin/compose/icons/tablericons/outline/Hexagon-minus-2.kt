...
public val OutlineGroup.`Hexagon-minus-2`: ImageVector
    get() {
        if (`_hexagon-minus-2` != null) {
            return `_hexagon-minus-2`!!
        }
        `_hexagon-minus-2` = Builder(name = "Hexagon-minus-2", defaultWidth = 24.0.dp, defaultHeight
...
private var `_hexagon-minus-2`: ImageVector? = null

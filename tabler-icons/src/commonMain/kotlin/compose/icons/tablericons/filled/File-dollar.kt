...
public val FilledGroup.`File-dollar`: ImageVector
    get() {
        if (`_file-dollar` != null) {
            return `_file-dollar`!!
        }
        `_file-dollar` = Builder(name = "File-dollar", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.5f, 2.5f, 0.0f, false, false, 0.5f, 4.95f)
...
private var `_file-dollar`: ImageVector? = null

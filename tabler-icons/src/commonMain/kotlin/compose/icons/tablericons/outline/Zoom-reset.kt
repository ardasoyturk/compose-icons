...
public val OutlineGroup.`Zoom-reset`: ImageVector
    get() {
        if (`_zoom-reset` != null) {
            return `_zoom-reset`!!
        }
        `_zoom-reset` = Builder(name = "Zoom-reset", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_zoom-reset`: ImageVector? = null

...
public val OutlineGroup.`Brand-adobe-illustrator`: ImageVector
    get() {
        if (`_brand-adobe-illustrator` != null) {
            return `_brand-adobe-illustrator`!!
        }
        `_brand-adobe-illustrator` = Builder(name = "Brand-adobe-illustrator", defaultWidth =
...
private var `_brand-adobe-illustrator`: ImageVector? = null

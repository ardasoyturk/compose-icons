...
public val OutlineGroup.`Brand-adonis-js`: ImageVector
    get() {
        if (`_brand-adonis-js` != null) {
            return `_brand-adonis-js`!!
        }
        `_brand-adonis-js` = Builder(name = "Brand-adonis-js", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-adonis-js`: ImageVector? = null

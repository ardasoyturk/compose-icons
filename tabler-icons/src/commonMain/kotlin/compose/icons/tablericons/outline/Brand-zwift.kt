...
public val OutlineGroup.`Brand-zwift`: ImageVector
    get() {
        if (`_brand-zwift` != null) {
            return `_brand-zwift`!!
        }
        `_brand-zwift` = Builder(name = "Brand-zwift", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-zwift`: ImageVector? = null

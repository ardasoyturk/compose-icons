...
public val OutlineGroup.`Brand-wechat`: ImageVector
    get() {
        if (`_brand-wechat` != null) {
            return `_brand-wechat`!!
        }
        `_brand-wechat` = Builder(name = "Brand-wechat", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-wechat`: ImageVector? = null

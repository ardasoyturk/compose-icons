...
public val OutlineGroup.`Brand-mastodon`: ImageVector
    get() {
        if (`_brand-mastodon` != null) {
            return `_brand-mastodon`!!
        }
        `_brand-mastodon` = Builder(name = "Brand-mastodon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-mastodon`: ImageVector? = null

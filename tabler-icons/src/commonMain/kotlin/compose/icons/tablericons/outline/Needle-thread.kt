...
public val OutlineGroup.`Needle-thread`: ImageVector
    get() {
        if (`_needle-thread` != null) {
            return `_needle-thread`!!
        }
        `_needle-thread` = Builder(name = "Needle-thread", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_needle-thread`: ImageVector? = null

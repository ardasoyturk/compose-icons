...
public val OutlineGroup.`Irregular-polyhedron-off`: ImageVector
    get() {
        if (`_irregular-polyhedron-off` != null) {
            return `_irregular-polyhedron-off`!!
        }
        `_irregular-polyhedron-off` = Builder(name = "Irregular-polyhedron-off", defaultWidth =
...
private var `_irregular-polyhedron-off`: ImageVector? = null

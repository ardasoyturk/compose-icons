...
public val OutlineGroup.`Scale-outline`: ImageVector
    get() {
        if (`_scale-outline` != null) {
            return `_scale-outline`!!
        }
        `_scale-outline` = Builder(name = "Scale-outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_scale-outline`: ImageVector? = null

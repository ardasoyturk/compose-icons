...
public val OutlineGroup.`Bread-off`: ImageVector
    get() {
        if (`_bread-off` != null) {
            return `_bread-off`!!
        }
        `_bread-off` = Builder(name = "Bread-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bread-off`: ImageVector? = null

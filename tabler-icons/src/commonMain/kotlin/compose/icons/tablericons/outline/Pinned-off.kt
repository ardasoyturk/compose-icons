...
public val OutlineGroup.`Pinned-off`: ImageVector
    get() {
        if (`_pinned-off` != null) {
            return `_pinned-off`!!
        }
        `_pinned-off` = Builder(name = "Pinned-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pinned-off`: ImageVector? = null

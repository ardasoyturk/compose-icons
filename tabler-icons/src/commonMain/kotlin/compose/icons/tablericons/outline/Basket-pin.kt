...
public val OutlineGroup.`Basket-pin`: ImageVector
    get() {
        if (`_basket-pin` != null) {
            return `_basket-pin`!!
        }
        `_basket-pin` = Builder(name = "Basket-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-pin`: ImageVector? = null

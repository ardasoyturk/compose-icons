...
public val OutlineGroup.`Bottle-off`: ImageVector
    get() {
        if (`_bottle-off` != null) {
            return `_bottle-off`!!
        }
        `_bottle-off` = Builder(name = "Bottle-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bottle-off`: ImageVector? = null

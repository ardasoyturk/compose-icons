...
public val OutlineGroup.`Brand-git`: ImageVector
    get() {
        if (`_brand-git` != null) {
            return `_brand-git`!!
        }
        `_brand-git` = Builder(name = "Brand-git", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-git`: ImageVector? = null

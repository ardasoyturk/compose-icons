...
public val OutlineGroup.`Hand-ring-finger`: ImageVector
    get() {
        if (`_hand-ring-finger` != null) {
            return `_hand-ring-finger`!!
        }
        `_hand-ring-finger` = Builder(name = "Hand-ring-finger", defaultWidth = 24.0.dp,
...
private var `_hand-ring-finger`: ImageVector? = null

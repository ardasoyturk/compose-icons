...
public val OutlineGroup.`Brand-airbnb`: ImageVector
    get() {
        if (`_brand-airbnb` != null) {
            return `_brand-airbnb`!!
        }
        `_brand-airbnb` = Builder(name = "Brand-airbnb", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-airbnb`: ImageVector? = null

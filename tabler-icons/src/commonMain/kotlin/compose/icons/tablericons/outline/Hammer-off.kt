...
public val OutlineGroup.`Hammer-off`: ImageVector
    get() {
        if (`_hammer-off` != null) {
            return `_hammer-off`!!
        }
        `_hammer-off` = Builder(name = "Hammer-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hammer-off`: ImageVector? = null

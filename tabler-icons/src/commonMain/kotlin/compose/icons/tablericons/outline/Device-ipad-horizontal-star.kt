...
public val OutlineGroup.`Device-ipad-horizontal-star`: ImageVector
    get() {
        if (`_device-ipad-horizontal-star` != null) {
            return `_device-ipad-horizontal-star`!!
        }
        `_device-ipad-horizontal-star` = Builder(name = "Device-ipad-horizontal-star", defaultWidth
...
private var `_device-ipad-horizontal-star`: ImageVector? = null

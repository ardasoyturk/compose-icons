...
public val OutlineGroup.`Device-imac-star`: ImageVector
    get() {
        if (`_device-imac-star` != null) {
            return `_device-imac-star`!!
        }
        `_device-imac-star` = Builder(name = "Device-imac-star", defaultWidth = 24.0.dp,
...
private var `_device-imac-star`: ImageVector? = null

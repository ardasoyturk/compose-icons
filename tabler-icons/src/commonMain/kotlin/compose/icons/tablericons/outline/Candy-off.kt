...
public val OutlineGroup.`Candy-off`: ImageVector
    get() {
        if (`_candy-off` != null) {
            return `_candy-off`!!
        }
        `_candy-off` = Builder(name = "Candy-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_candy-off`: ImageVector? = null

...
public val OutlineGroup.`Clock-heart`: ImageVector
    get() {
        if (`_clock-heart` != null) {
            return `_clock-heart`!!
        }
        `_clock-heart` = Builder(name = "Clock-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_clock-heart`: ImageVector? = null

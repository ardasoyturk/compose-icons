...
public val OutlineGroup.`Car-off`: ImageVector
    get() {
        if (`_car-off` != null) {
            return `_car-off`!!
        }
        `_car-off` = Builder(name = "Car-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_car-off`: ImageVector? = null

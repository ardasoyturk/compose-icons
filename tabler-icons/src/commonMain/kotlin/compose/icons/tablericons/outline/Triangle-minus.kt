...
public val OutlineGroup.`Triangle-minus`: ImageVector
    get() {
        if (`_triangle-minus` != null) {
            return `_triangle-minus`!!
        }
        `_triangle-minus` = Builder(name = "Triangle-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_triangle-minus`: ImageVector? = null

...
public val OutlineGroup.`Bell-star`: ImageVector
    get() {
        if (`_bell-star` != null) {
            return `_bell-star`!!
        }
        `_bell-star` = Builder(name = "Bell-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bell-star`: ImageVector? = null

...
public val OutlineGroup.`Brand-amd`: ImageVector
    get() {
        if (`_brand-amd` != null) {
            return `_brand-amd`!!
        }
        `_brand-amd` = Builder(name = "Brand-amd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-amd`: ImageVector? = null

...
public val OutlineGroup.`Database-leak`: ImageVector
    get() {
        if (`_database-leak` != null) {
            return `_database-leak`!!
        }
        `_database-leak` = Builder(name = "Database-leak", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-leak`: ImageVector? = null

...
public val OutlineGroup.`Pentagon-plus`: ImageVector
    get() {
        if (`_pentagon-plus` != null) {
            return `_pentagon-plus`!!
        }
        `_pentagon-plus` = Builder(name = "Pentagon-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pentagon-plus`: ImageVector? = null

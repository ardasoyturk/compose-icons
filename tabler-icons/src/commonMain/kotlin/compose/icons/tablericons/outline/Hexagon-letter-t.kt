...
public val OutlineGroup.`Hexagon-letter-t`: ImageVector
    get() {
        if (`_hexagon-letter-t` != null) {
            return `_hexagon-letter-t`!!
        }
        `_hexagon-letter-t` = Builder(name = "Hexagon-letter-t", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-t`: ImageVector? = null

...
public val OutlineGroup.`Sparkles-2`: ImageVector
    get() {
        if (`_sparkles-2` != null) {
            return `_sparkles-2`!!
        }
        `_sparkles-2` = Builder(name = "Sparkles-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sparkles-2`: ImageVector? = null

...
public val OutlineGroup.`Bucket-droplet`: ImageVector
    get() {
        if (`_bucket-droplet` != null) {
            return `_bucket-droplet`!!
        }
        `_bucket-droplet` = Builder(name = "Bucket-droplet", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bucket-droplet`: ImageVector? = null

...
public val OutlineGroup.`Hexagonal-pyramid`: ImageVector
    get() {
        if (`_hexagonal-pyramid` != null) {
            return `_hexagonal-pyramid`!!
        }
        `_hexagonal-pyramid` = Builder(name = "Hexagonal-pyramid", defaultWidth = 24.0.dp,
...
private var `_hexagonal-pyramid`: ImageVector? = null

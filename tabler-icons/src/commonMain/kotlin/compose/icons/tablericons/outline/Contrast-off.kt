...
public val OutlineGroup.`Contrast-off`: ImageVector
    get() {
        if (`_contrast-off` != null) {
            return `_contrast-off`!!
        }
        `_contrast-off` = Builder(name = "Contrast-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_contrast-off`: ImageVector? = null

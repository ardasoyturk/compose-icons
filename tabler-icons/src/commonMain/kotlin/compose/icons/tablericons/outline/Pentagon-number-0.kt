...
public val OutlineGroup.`Pentagon-number-0`: ImageVector
    get() {
        if (`_pentagon-number-0` != null) {
            return `_pentagon-number-0`!!
        }
        `_pentagon-number-0` = Builder(name = "Pentagon-number-0", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-0`: ImageVector? = null

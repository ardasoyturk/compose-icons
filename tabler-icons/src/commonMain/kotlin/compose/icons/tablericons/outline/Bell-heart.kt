...
public val OutlineGroup.`Bell-heart`: ImageVector
    get() {
        if (`_bell-heart` != null) {
            return `_bell-heart`!!
        }
        `_bell-heart` = Builder(name = "Bell-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bell-heart`: ImageVector? = null

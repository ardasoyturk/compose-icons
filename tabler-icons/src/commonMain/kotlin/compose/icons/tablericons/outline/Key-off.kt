...
public val OutlineGroup.`Key-off`: ImageVector
    get() {
        if (`_key-off` != null) {
            return `_key-off`!!
        }
        `_key-off` = Builder(name = "Key-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_key-off`: ImageVector? = null

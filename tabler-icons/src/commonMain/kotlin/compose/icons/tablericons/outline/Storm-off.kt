...
public val OutlineGroup.`Storm-off`: ImageVector
    get() {
        if (`_storm-off` != null) {
            return `_storm-off`!!
        }
        `_storm-off` = Builder(name = "Storm-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_storm-off`: ImageVector? = null

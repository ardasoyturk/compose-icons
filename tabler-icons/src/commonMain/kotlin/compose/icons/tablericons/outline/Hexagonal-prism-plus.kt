...
public val OutlineGroup.`Hexagonal-prism-plus`: ImageVector
    get() {
        if (`_hexagonal-prism-plus` != null) {
            return `_hexagonal-prism-plus`!!
        }
        `_hexagonal-prism-plus` = Builder(name = "Hexagonal-prism-plus", defaultWidth = 24.0.dp,
...
private var `_hexagonal-prism-plus`: ImageVector? = null

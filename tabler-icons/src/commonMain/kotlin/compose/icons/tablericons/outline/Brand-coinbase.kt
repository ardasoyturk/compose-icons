...
public val OutlineGroup.`Brand-coinbase`: ImageVector
    get() {
        if (`_brand-coinbase` != null) {
            return `_brand-coinbase`!!
        }
        `_brand-coinbase` = Builder(name = "Brand-coinbase", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-coinbase`: ImageVector? = null

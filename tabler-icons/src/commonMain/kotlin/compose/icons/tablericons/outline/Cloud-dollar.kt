...
public val OutlineGroup.`Cloud-dollar`: ImageVector
    get() {
        if (`_cloud-dollar` != null) {
            return `_cloud-dollar`!!
        }
        `_cloud-dollar` = Builder(name = "Cloud-dollar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-dollar`: ImageVector? = null

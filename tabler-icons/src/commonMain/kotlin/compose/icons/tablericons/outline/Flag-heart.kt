...
public val OutlineGroup.`Flag-heart`: ImageVector
    get() {
        if (`_flag-heart` != null) {
            return `_flag-heart`!!
        }
        `_flag-heart` = Builder(name = "Flag-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flag-heart`: ImageVector? = null

...
public val OutlineGroup.`Broadcast-off`: ImageVector
    get() {
        if (`_broadcast-off` != null) {
            return `_broadcast-off`!!
        }
        `_broadcast-off` = Builder(name = "Broadcast-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_broadcast-off`: ImageVector? = null

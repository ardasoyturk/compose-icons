...
public val OutlineGroup.`Hexagon-letter-a`: ImageVector
    get() {
        if (`_hexagon-letter-a` != null) {
            return `_hexagon-letter-a`!!
        }
        `_hexagon-letter-a` = Builder(name = "Hexagon-letter-a", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-a`: ImageVector? = null

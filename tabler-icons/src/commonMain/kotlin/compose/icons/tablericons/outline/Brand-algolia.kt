...
public val OutlineGroup.`Brand-algolia`: ImageVector
    get() {
        if (`_brand-algolia` != null) {
            return `_brand-algolia`!!
        }
        `_brand-algolia` = Builder(name = "Brand-algolia", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-algolia`: ImageVector? = null

...
public val OutlineGroup.`Basket-cog`: ImageVector
    get() {
        if (`_basket-cog` != null) {
            return `_basket-cog`!!
        }
        `_basket-cog` = Builder(name = "Basket-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-cog`: ImageVector? = null

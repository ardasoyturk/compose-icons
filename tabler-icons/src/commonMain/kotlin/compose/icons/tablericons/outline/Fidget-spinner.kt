...
public val OutlineGroup.`Fidget-spinner`: ImageVector
    get() {
        if (`_fidget-spinner` != null) {
            return `_fidget-spinner`!!
        }
        `_fidget-spinner` = Builder(name = "Fidget-spinner", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_fidget-spinner`: ImageVector? = null

...
public val OutlineGroup.`Bell-pin`: ImageVector
    get() {
        if (`_bell-pin` != null) {
            return `_bell-pin`!!
        }
        `_bell-pin` = Builder(name = "Bell-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bell-pin`: ImageVector? = null

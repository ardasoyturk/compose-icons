...
public val OutlineGroup.`Hexagon-letter-s`: ImageVector
    get() {
        if (`_hexagon-letter-s` != null) {
            return `_hexagon-letter-s`!!
        }
        `_hexagon-letter-s` = Builder(name = "Hexagon-letter-s", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-s`: ImageVector? = null

...
public val OutlineGroup.`Adjustments-star`: ImageVector
    get() {
        if (`_adjustments-star` != null) {
            return `_adjustments-star`!!
        }
        `_adjustments-star` = Builder(name = "Adjustments-star", defaultWidth = 24.0.dp,
...
private var `_adjustments-star`: ImageVector? = null

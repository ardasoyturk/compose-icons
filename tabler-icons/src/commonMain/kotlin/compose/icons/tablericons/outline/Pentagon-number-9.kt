...
public val OutlineGroup.`Pentagon-number-9`: ImageVector
    get() {
        if (`_pentagon-number-9` != null) {
            return `_pentagon-number-9`!!
        }
        `_pentagon-number-9` = Builder(name = "Pentagon-number-9", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-9`: ImageVector? = null

...
public val OutlineGroup.`Telescope-off`: ImageVector
    get() {
        if (`_telescope-off` != null) {
            return `_telescope-off`!!
        }
        `_telescope-off` = Builder(name = "Telescope-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_telescope-off`: ImageVector? = null

...
public val OutlineGroup.`Circle-dashed-letter-n`: ImageVector
    get() {
        if (`_circle-dashed-letter-n` != null) {
            return `_circle-dashed-letter-n`!!
        }
        `_circle-dashed-letter-n` = Builder(name = "Circle-dashed-letter-n", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-n`: ImageVector? = null

...
public val OutlineGroup.`Masks-theater-off`: ImageVector
    get() {
        if (`_masks-theater-off` != null) {
            return `_masks-theater-off`!!
        }
        `_masks-theater-off` = Builder(name = "Masks-theater-off", defaultWidth = 24.0.dp,
...
private var `_masks-theater-off`: ImageVector? = null

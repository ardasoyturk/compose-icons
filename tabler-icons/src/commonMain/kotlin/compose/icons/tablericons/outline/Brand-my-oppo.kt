...
public val OutlineGroup.`Brand-my-oppo`: ImageVector
    get() {
        if (`_brand-my-oppo` != null) {
            return `_brand-my-oppo`!!
        }
        `_brand-my-oppo` = Builder(name = "Brand-my-oppo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-my-oppo`: ImageVector? = null

...
public val OutlineGroup.`Cloud-bitcoin`: ImageVector
    get() {
        if (`_cloud-bitcoin` != null) {
            return `_cloud-bitcoin`!!
        }
        `_cloud-bitcoin` = Builder(name = "Cloud-bitcoin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-bitcoin`: ImageVector? = null

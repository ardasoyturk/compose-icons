...
public val OutlineGroup.`Droplet-search`: ImageVector
    get() {
        if (`_droplet-search` != null) {
            return `_droplet-search`!!
        }
        `_droplet-search` = Builder(name = "Droplet-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-search`: ImageVector? = null

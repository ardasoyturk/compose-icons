...
public val OutlineGroup.`Brand-youtube-kids`: ImageVector
    get() {
        if (`_brand-youtube-kids` != null) {
            return `_brand-youtube-kids`!!
        }
        `_brand-youtube-kids` = Builder(name = "Brand-youtube-kids", defaultWidth = 24.0.dp,
...
private var `_brand-youtube-kids`: ImageVector? = null

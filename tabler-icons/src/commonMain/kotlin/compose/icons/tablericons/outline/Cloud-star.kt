...
public val OutlineGroup.`Cloud-star`: ImageVector
    get() {
        if (`_cloud-star` != null) {
            return `_cloud-star`!!
        }
        `_cloud-star` = Builder(name = "Cloud-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-star`: ImageVector? = null

...
public val OutlineGroup.`Brand-arc`: ImageVector
    get() {
        if (`_brand-arc` != null) {
            return `_brand-arc`!!
        }
        `_brand-arc` = Builder(name = "Brand-arc", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-arc`: ImageVector? = null

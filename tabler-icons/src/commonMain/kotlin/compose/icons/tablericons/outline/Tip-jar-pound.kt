...
public val OutlineGroup.`Tip-jar-pound`: ImageVector
    get() {
        if (`_tip-jar-pound` != null) {
            return `_tip-jar-pound`!!
        }
        `_tip-jar-pound` = Builder(name = "Tip-jar-pound", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_tip-jar-pound`: ImageVector? = null

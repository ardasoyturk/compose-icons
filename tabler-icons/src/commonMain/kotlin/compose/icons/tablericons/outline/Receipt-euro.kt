...
public val OutlineGroup.`Receipt-euro`: ImageVector
    get() {
        if (`_receipt-euro` != null) {
            return `_receipt-euro`!!
        }
        `_receipt-euro` = Builder(name = "Receipt-euro", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-euro`: ImageVector? = null

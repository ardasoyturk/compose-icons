...
public val OutlineGroup.`Brand-webflow`: ImageVector
    get() {
        if (`_brand-webflow` != null) {
            return `_brand-webflow`!!
        }
        `_brand-webflow` = Builder(name = "Brand-webflow", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-webflow`: ImageVector? = null

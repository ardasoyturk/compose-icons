...
public val OutlineGroup.`Database-off`: ImageVector
    get() {
        if (`_database-off` != null) {
            return `_database-off`!!
        }
        `_database-off` = Builder(name = "Database-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-off`: ImageVector? = null

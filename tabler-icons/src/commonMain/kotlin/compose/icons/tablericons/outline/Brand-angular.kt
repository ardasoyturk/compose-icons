...
public val OutlineGroup.`Brand-angular`: ImageVector
    get() {
        if (`_brand-angular` != null) {
            return `_brand-angular`!!
        }
        `_brand-angular` = Builder(name = "Brand-angular", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-angular`: ImageVector? = null

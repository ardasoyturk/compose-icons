...
public val OutlineGroup.`Octagon-off`: ImageVector
    get() {
        if (`_octagon-off` != null) {
            return `_octagon-off`!!
        }
        `_octagon-off` = Builder(name = "Octagon-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_octagon-off`: ImageVector? = null

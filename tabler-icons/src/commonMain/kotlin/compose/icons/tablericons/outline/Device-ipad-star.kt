...
public val OutlineGroup.`Device-ipad-star`: ImageVector
    get() {
        if (`_device-ipad-star` != null) {
            return `_device-ipad-star`!!
        }
        `_device-ipad-star` = Builder(name = "Device-ipad-star", defaultWidth = 24.0.dp,
...
private var `_device-ipad-star`: ImageVector? = null

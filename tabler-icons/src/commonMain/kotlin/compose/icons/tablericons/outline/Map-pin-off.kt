...
public val OutlineGroup.`Map-pin-off`: ImageVector
    get() {
        if (`_map-pin-off` != null) {
            return `_map-pin-off`!!
        }
        `_map-pin-off` = Builder(name = "Map-pin-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_map-pin-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-ctemplar`: ImageVector
    get() {
        if (`_brand-ctemplar` != null) {
            return `_brand-ctemplar`!!
        }
        `_brand-ctemplar` = Builder(name = "Brand-ctemplar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-ctemplar`: ImageVector? = null

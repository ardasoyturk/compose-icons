...
public val OutlineGroup.`Circle-dashed-number-7`: ImageVector
    get() {
        if (`_circle-dashed-number-7` != null) {
            return `_circle-dashed-number-7`!!
        }
        `_circle-dashed-number-7` = Builder(name = "Circle-dashed-number-7", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-number-7`: ImageVector? = null

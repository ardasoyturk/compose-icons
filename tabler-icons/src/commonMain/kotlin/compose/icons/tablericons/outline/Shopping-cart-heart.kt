...
public val OutlineGroup.`Shopping-cart-heart`: ImageVector
    get() {
        if (`_shopping-cart-heart` != null) {
            return `_shopping-cart-heart`!!
        }
        `_shopping-cart-heart` = Builder(name = "Shopping-cart-heart", defaultWidth = 24.0.dp,
...
private var `_shopping-cart-heart`: ImageVector? = null

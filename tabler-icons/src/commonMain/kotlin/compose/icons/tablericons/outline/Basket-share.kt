...
public val OutlineGroup.`Basket-share`: ImageVector
    get() {
        if (`_basket-share` != null) {
            return `_basket-share`!!
        }
        `_basket-share` = Builder(name = "Basket-share", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-share`: ImageVector? = null

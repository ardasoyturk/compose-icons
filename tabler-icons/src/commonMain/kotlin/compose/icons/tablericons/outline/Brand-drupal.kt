...
public val OutlineGroup.`Brand-drupal`: ImageVector
    get() {
        if (`_brand-drupal` != null) {
            return `_brand-drupal`!!
        }
        `_brand-drupal` = Builder(name = "Brand-drupal", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-drupal`: ImageVector? = null

...
public val LucideIcons.BetweenVerticalStart: ImageVector
    get() {
        if (_betweenVerticalStart != null) {
            return _betweenVerticalStart!!
        }
        _betweenVerticalStart = Builder(name = "BetweenVerticalStart", defaultWidth = 24.0.dp,

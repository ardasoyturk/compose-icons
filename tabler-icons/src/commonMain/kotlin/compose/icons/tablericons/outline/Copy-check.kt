...
public val OutlineGroup.`Copy-check`: ImageVector
    get() {
        if (`_copy-check` != null) {
            return `_copy-check`!!
        }
        `_copy-check` = Builder(name = "Copy-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_copy-check`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-d`: ImageVector
    get() {
        if (`_hexagon-letter-d` != null) {
            return `_hexagon-letter-d`!!
        }
        `_hexagon-letter-d` = Builder(name = "Hexagon-letter-d", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-d`: ImageVector? = null

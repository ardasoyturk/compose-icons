...
public val OutlineGroup.`Brand-google-big-query`: ImageVector
    get() {
        if (`_brand-google-big-query` != null) {
            return `_brand-google-big-query`!!
        }
        `_brand-google-big-query` = Builder(name = "Brand-google-big-query", defaultWidth = 24.0.dp,
...
private var `_brand-google-big-query`: ImageVector? = null

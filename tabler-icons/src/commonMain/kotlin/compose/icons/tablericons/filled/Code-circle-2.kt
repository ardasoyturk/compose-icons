...
public val FilledGroup.`Code-circle-2`: ImageVector
    get() {
        if (`_code-circle-2` != null) {
            return `_code-circle-2`!!
        }
        `_code-circle-2` = Builder(name = "Code-circle-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_code-circle-2`: ImageVector? = null

...
public val OutlineGroup.`Ghost-3`: ImageVector
    get() {
        if (`_ghost-3` != null) {
            return `_ghost-3`!!
        }
        `_ghost-3` = Builder(name = "Ghost-3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ghost-3`: ImageVector? = null

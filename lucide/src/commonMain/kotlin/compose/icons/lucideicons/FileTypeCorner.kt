...
public val LucideIcons.FileTypeCorner: ImageVector
    get() {
        if (_fileTypeCorner != null) {
            return _fileTypeCorner!!
        }
        _fileTypeCorner = Builder(name = "FileTypeCorner", defaultWidth = 24.0.dp, defaultHeight =

...
public val OutlineGroup.`Camera-heart`: ImageVector
    get() {
        if (`_camera-heart` != null) {
            return `_camera-heart`!!
        }
        `_camera-heart` = Builder(name = "Camera-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_camera-heart`: ImageVector? = null

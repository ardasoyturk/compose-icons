...
public val OutlineGroup.`Flag-star`: ImageVector
    get() {
        if (`_flag-star` != null) {
            return `_flag-star`!!
        }
        `_flag-star` = Builder(name = "Flag-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_flag-star`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-b`: ImageVector
    get() {
        if (`_hexagon-letter-b` != null) {
            return `_hexagon-letter-b`!!
        }
        `_hexagon-letter-b` = Builder(name = "Hexagon-letter-b", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-b`: ImageVector? = null

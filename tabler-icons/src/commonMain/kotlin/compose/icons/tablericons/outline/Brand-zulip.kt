...
public val OutlineGroup.`Brand-zulip`: ImageVector
    get() {
        if (`_brand-zulip` != null) {
            return `_brand-zulip`!!
        }
        `_brand-zulip` = Builder(name = "Brand-zulip", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-zulip`: ImageVector? = null

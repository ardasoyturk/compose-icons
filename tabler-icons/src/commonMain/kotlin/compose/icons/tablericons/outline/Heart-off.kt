...
public val OutlineGroup.`Heart-off`: ImageVector
    get() {
        if (`_heart-off` != null) {
            return `_heart-off`!!
        }
        `_heart-off` = Builder(name = "Heart-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_heart-off`: ImageVector? = null

...
public val OutlineGroup.`Photo-hexagon`: ImageVector
    get() {
        if (`_photo-hexagon` != null) {
            return `_photo-hexagon`!!
        }
        `_photo-hexagon` = Builder(name = "Photo-hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-hexagon`: ImageVector? = null

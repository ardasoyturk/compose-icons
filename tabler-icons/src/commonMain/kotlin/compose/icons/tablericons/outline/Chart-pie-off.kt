...
public val OutlineGroup.`Chart-pie-off`: ImageVector
    get() {
        if (`_chart-pie-off` != null) {
            return `_chart-pie-off`!!
        }
        `_chart-pie-off` = Builder(name = "Chart-pie-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_chart-pie-off`: ImageVector? = null

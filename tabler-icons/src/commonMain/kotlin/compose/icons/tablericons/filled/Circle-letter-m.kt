...
public val FilledGroup.`Circle-letter-m`: ImageVector
    get() {
        if (`_circle-letter-m` != null) {
            return `_circle-letter-m`!!
        }
        `_circle-letter-m` = Builder(name = "Circle-letter-m", defaultWidth = 24.0.dp, defaultHeight
...
private var `_circle-letter-m`: ImageVector? = null

...
public val OutlineGroup.`Location-star`: ImageVector
    get() {
        if (`_location-star` != null) {
            return `_location-star`!!
        }
        `_location-star` = Builder(name = "Location-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_location-star`: ImageVector? = null

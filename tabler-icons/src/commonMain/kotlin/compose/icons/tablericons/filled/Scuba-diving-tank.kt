...
public val FilledGroup.`Scuba-diving-tank`: ImageVector
    get() {
        if (`_scuba-diving-tank` != null) {
            return `_scuba-diving-tank`!!
        }
        `_scuba-diving-tank` = Builder(name = "Scuba-diving-tank", defaultWidth = 24.0.dp,
...
private var `_scuba-diving-tank`: ImageVector? = null

...
public val FilledGroup.`Car-suv`: ImageVector
    get() {
        if (`_car-suv` != null) {
            return `_car-suv`!!
        }
        `_car-suv` = Builder(name = "Car-suv", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.286f, 0.575f)
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.362f, -0.24f)
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.8f, -0.4f)
                arcToRelative(3.998f, 3.998f, 0.0f, false, false, -6.402f, 0.002f)
                arcToRelative(1.0f, 1.0f, 0.0f, true, true, -1.602f, -1.198f)
                ...
                moveToRelative(-5.438f, 0.0f)
                horizontalLineToRelative(-1.382f)
                lineToRelative(-1.001f, 2.0f)
...
private var `_car-suv`: ImageVector? = null

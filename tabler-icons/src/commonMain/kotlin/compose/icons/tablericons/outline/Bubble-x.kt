...
public val OutlineGroup.`Bubble-x`: ImageVector
    get() {
        if (`_bubble-x` != null) {
            return `_bubble-x`!!
        }
        `_bubble-x` = Builder(name = "Bubble-x", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bubble-x`: ImageVector? = null

...
public val OutlineGroup.`Message-circle-x`: ImageVector
    get() {
        if (`_message-circle-x` != null) {
            return `_message-circle-x`!!
        }
        `_message-circle-x` = Builder(name = "Message-circle-x", defaultWidth = 24.0.dp,
...
private var `_message-circle-x`: ImageVector? = null

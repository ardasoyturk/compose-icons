...
public val OutlineGroup.`Bubble-tea`: ImageVector
    get() {
        if (`_bubble-tea` != null) {
            return `_bubble-tea`!!
        }
        `_bubble-tea` = Builder(name = "Bubble-tea", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bubble-tea`: ImageVector? = null

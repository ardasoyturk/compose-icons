...
public val FilledGroup.`Badge-3d`: ImageVector
    get() {
        if (`_badge-3d` != null) {
            return `_badge-3d`!!
        }
        `_badge-3d` = Builder(name = "Badge-3d", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_badge-3d`: ImageVector? = null

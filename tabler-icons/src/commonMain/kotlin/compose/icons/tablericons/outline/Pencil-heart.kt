...
public val OutlineGroup.`Pencil-heart`: ImageVector
    get() {
        if (`_pencil-heart` != null) {
            return `_pencil-heart`!!
        }
        `_pencil-heart` = Builder(name = "Pencil-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pencil-heart`: ImageVector? = null

...
public val OutlineGroup.`Cube-off`: ImageVector
    get() {
        if (`_cube-off` != null) {
            return `_cube-off`!!
        }
        `_cube-off` = Builder(name = "Cube-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cube-off`: ImageVector? = null

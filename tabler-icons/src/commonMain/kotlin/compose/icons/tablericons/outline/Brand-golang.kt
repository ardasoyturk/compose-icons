...
public val OutlineGroup.`Brand-golang`: ImageVector
    get() {
        if (`_brand-golang` != null) {
            return `_brand-golang`!!
        }
        `_brand-golang` = Builder(name = "Brand-golang", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-golang`: ImageVector? = null

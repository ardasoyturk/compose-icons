...
public val OutlineGroup.`Wash-temperature-6`: ImageVector
    get() {
        if (`_wash-temperature-6` != null) {
            return `_wash-temperature-6`!!
        }
        `_wash-temperature-6` = Builder(name = "Wash-temperature-6", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-6`: ImageVector? = null

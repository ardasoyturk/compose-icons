...
public val OutlineGroup.`Variable-off`: ImageVector
    get() {
        if (`_variable-off` != null) {
            return `_variable-off`!!
        }
        `_variable-off` = Builder(name = "Variable-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_variable-off`: ImageVector? = null

...
public val OutlineGroup.`Octahedron-plus`: ImageVector
    get() {
        if (`_octahedron-plus` != null) {
            return `_octahedron-plus`!!
        }
        `_octahedron-plus` = Builder(name = "Octahedron-plus", defaultWidth = 24.0.dp, defaultHeight
...
private var `_octahedron-plus`: ImageVector? = null

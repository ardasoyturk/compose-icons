...
public val OutlineGroup.`Spiral-off`: ImageVector
    get() {
        if (`_spiral-off` != null) {
            return `_spiral-off`!!
        }
        `_spiral-off` = Builder(name = "Spiral-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_spiral-off`: ImageVector? = null

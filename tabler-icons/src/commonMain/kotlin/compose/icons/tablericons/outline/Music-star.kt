...
public val OutlineGroup.`Music-star`: ImageVector
    get() {
        if (`_music-star` != null) {
            return `_music-star`!!
        }
        `_music-star` = Builder(name = "Music-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_music-star`: ImageVector? = null

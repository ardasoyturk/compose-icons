...
public val OutlineGroup.`Medical-cross-off`: ImageVector
    get() {
        if (`_medical-cross-off` != null) {
            return `_medical-cross-off`!!
        }
        `_medical-cross-off` = Builder(name = "Medical-cross-off", defaultWidth = 24.0.dp,
...
private var `_medical-cross-off`: ImageVector? = null

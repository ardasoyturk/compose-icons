...
public val OutlineGroup.`Pointer-cancel`: ImageVector
    get() {
        if (`_pointer-cancel` != null) {
            return `_pointer-cancel`!!
        }
        `_pointer-cancel` = Builder(name = "Pointer-cancel", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-cancel`: ImageVector? = null

...
public val OutlineGroup.`Rocket-off`: ImageVector
    get() {
        if (`_rocket-off` != null) {
            return `_rocket-off`!!
        }
        `_rocket-off` = Builder(name = "Rocket-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rocket-off`: ImageVector? = null

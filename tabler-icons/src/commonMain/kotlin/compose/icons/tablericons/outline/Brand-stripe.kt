...
public val OutlineGroup.`Brand-stripe`: ImageVector
    get() {
        if (`_brand-stripe` != null) {
            return `_brand-stripe`!!
        }
        `_brand-stripe` = Builder(name = "Brand-stripe", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-stripe`: ImageVector? = null

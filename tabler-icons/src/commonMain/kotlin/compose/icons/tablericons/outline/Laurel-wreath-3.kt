...
public val OutlineGroup.`Laurel-wreath-3`: ImageVector
    get() {
        if (`_laurel-wreath-3` != null) {
            return `_laurel-wreath-3`!!
        }
        `_laurel-wreath-3` = Builder(name = "Laurel-wreath-3", defaultWidth = 24.0.dp, defaultHeight
...
private var `_laurel-wreath-3`: ImageVector? = null

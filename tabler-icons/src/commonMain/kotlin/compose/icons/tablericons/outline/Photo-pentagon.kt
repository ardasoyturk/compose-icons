...
public val OutlineGroup.`Photo-pentagon`: ImageVector
    get() {
        if (`_photo-pentagon` != null) {
            return `_photo-pentagon`!!
        }
        `_photo-pentagon` = Builder(name = "Photo-pentagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-pentagon`: ImageVector? = null

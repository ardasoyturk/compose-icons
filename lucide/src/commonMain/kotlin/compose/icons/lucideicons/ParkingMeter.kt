...
public val LucideIcons.ParkingMeter: ImageVector
    get() {
        ...
        _parkingMeter = Builder(name = "ParkingMeter", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.282f, 19.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.948f, -0.68f)
                lineToRelative(2.37f, -6.988f)
                arcToRelative(7.0f, 7.0f, 0.0f, true, false, -13.2f, 0.0f)
                lineToRelative(2.37f, 6.988f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.948f, 0.68f)
                close()
            }

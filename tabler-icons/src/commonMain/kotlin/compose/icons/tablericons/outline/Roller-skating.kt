...
public val OutlineGroup.`Roller-skating`: ImageVector
    get() {
        if (`_roller-skating` != null) {
            return `_roller-skating`!!
        }
        `_roller-skating` = Builder(name = "Roller-skating", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_roller-skating`: ImageVector? = null

...
public val OutlineGroup.`Cloud-heart`: ImageVector
    get() {
        if (`_cloud-heart` != null) {
            return `_cloud-heart`!!
        }
        `_cloud-heart` = Builder(name = "Cloud-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-heart`: ImageVector? = null

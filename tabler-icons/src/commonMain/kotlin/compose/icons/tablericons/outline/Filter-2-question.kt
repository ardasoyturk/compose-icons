...
public val OutlineGroup.`Filter-2-question`: ImageVector
    get() {
        if (`_filter-2-question` != null) {
            return `_filter-2-question`!!
        }
        `_filter-2-question` = Builder(name = "Filter-2-question", defaultWidth = 24.0.dp,
...
private var `_filter-2-question`: ImageVector? = null

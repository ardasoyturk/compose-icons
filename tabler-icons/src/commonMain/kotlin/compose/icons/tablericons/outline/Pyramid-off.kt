...
public val OutlineGroup.`Pyramid-off`: ImageVector
    get() {
        if (`_pyramid-off` != null) {
            return `_pyramid-off`!!
        }
        `_pyramid-off` = Builder(name = "Pyramid-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pyramid-off`: ImageVector? = null

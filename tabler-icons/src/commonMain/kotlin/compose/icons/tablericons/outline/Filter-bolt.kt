...
public val OutlineGroup.`Filter-bolt`: ImageVector
    get() {
        if (`_filter-bolt` != null) {
            return `_filter-bolt`!!
        }
        `_filter-bolt` = Builder(name = "Filter-bolt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-bolt`: ImageVector? = null

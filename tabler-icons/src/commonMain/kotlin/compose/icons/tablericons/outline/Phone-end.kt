...
public val OutlineGroup.`Phone-end`: ImageVector
    get() {
        if (`_phone-end` != null) {
            return `_phone-end`!!
        }
        `_phone-end` = Builder(name = "Phone-end", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_phone-end`: ImageVector? = null

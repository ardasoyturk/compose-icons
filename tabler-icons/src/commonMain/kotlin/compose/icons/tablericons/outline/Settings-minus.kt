...
public val OutlineGroup.`Settings-minus`: ImageVector
    get() {
        if (`_settings-minus` != null) {
            return `_settings-minus`!!
        }
        `_settings-minus` = Builder(name = "Settings-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-minus`: ImageVector? = null

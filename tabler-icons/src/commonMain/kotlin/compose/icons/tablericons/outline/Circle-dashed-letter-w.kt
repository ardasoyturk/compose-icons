...
public val OutlineGroup.`Circle-dashed-letter-w`: ImageVector
    get() {
        if (`_circle-dashed-letter-w` != null) {
            return `_circle-dashed-letter-w`!!
        }
        `_circle-dashed-letter-w` = Builder(name = "Circle-dashed-letter-w", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-w`: ImageVector? = null

...
public val OutlineGroup.`Ufo-off`: ImageVector
    get() {
        if (`_ufo-off` != null) {
            return `_ufo-off`!!
        }
        `_ufo-off` = Builder(name = "Ufo-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ufo-off`: ImageVector? = null

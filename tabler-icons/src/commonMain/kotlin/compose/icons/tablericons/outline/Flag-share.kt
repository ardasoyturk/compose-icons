...
public val OutlineGroup.`Flag-share`: ImageVector
    get() {
        if (`_flag-share` != null) {
            return `_flag-share`!!
        }
        `_flag-share` = Builder(name = "Flag-share", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flag-share`: ImageVector? = null

...
public val OutlineGroup.`Join-bevel`: ImageVector
    get() {
        if (`_join-bevel` != null) {
            return `_join-bevel`!!
        }
        `_join-bevel` = Builder(name = "Join-bevel", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_join-bevel`: ImageVector? = null

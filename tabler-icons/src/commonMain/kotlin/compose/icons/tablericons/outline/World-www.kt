...
public val OutlineGroup.`World-www`: ImageVector
    get() {
        if (`_world-www` != null) {
            return `_world-www`!!
        }
        `_world-www` = Builder(name = "World-www", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_world-www`: ImageVector? = null

...
public val OutlineGroup.`Brand-toyota`: ImageVector
    get() {
        if (`_brand-toyota` != null) {
            return `_brand-toyota`!!
        }
        `_brand-toyota` = Builder(name = "Brand-toyota", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-toyota`: ImageVector? = null

...
public val OutlineGroup.`Currency-dollar-off`: ImageVector
    get() {
        if (`_currency-dollar-off` != null) {
            return `_currency-dollar-off`!!
        }
        `_currency-dollar-off` = Builder(name = "Currency-dollar-off", defaultWidth = 24.0.dp,
...
private var `_currency-dollar-off`: ImageVector? = null

...
public val OutlineGroup.`Cylinder-off`: ImageVector
    get() {
        if (`_cylinder-off` != null) {
            return `_cylinder-off`!!
        }
        `_cylinder-off` = Builder(name = "Cylinder-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cylinder-off`: ImageVector? = null

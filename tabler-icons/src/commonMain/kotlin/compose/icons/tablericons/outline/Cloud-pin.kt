...
public val OutlineGroup.`Cloud-pin`: ImageVector
    get() {
        if (`_cloud-pin` != null) {
            return `_cloud-pin`!!
        }
        `_cloud-pin` = Builder(name = "Cloud-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cloud-pin`: ImageVector? = null

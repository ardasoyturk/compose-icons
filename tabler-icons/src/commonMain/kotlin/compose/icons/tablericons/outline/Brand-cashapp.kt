...
public val OutlineGroup.`Brand-cashapp`: ImageVector
    get() {
        if (`_brand-cashapp` != null) {
            return `_brand-cashapp`!!
        }
        `_brand-cashapp` = Builder(name = "Brand-cashapp", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cashapp`: ImageVector? = null

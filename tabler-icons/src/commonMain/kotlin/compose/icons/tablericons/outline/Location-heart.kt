...
public val OutlineGroup.`Location-heart`: ImageVector
    get() {
        if (`_location-heart` != null) {
            return `_location-heart`!!
        }
        `_location-heart` = Builder(name = "Location-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_location-heart`: ImageVector? = null

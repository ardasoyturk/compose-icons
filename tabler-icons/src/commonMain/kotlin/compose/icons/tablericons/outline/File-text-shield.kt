...
public val OutlineGroup.`File-text-shield`: ImageVector
    get() {
        if (`_file-text-shield` != null) {
            return `_file-text-shield`!!
        }
        `_file-text-shield` = Builder(name = "File-text-shield", defaultWidth = 24.0.dp,
...
private var `_file-text-shield`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-r`: ImageVector
    get() {
        if (`_hexagon-letter-r` != null) {
            return `_hexagon-letter-r`!!
        }
        `_hexagon-letter-r` = Builder(name = "Hexagon-letter-r", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-r`: ImageVector? = null

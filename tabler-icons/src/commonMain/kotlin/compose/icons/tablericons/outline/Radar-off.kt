...
public val OutlineGroup.`Radar-off`: ImageVector
    get() {
        if (`_radar-off` != null) {
            return `_radar-off`!!
        }
        `_radar-off` = Builder(name = "Radar-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_radar-off`: ImageVector? = null

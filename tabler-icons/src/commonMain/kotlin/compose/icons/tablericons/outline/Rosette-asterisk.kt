...
public val OutlineGroup.`Rosette-asterisk`: ImageVector
    get() {
        if (`_rosette-asterisk` != null) {
            return `_rosette-asterisk`!!
        }
        `_rosette-asterisk` = Builder(name = "Rosette-asterisk", defaultWidth = 24.0.dp,
...
private var `_rosette-asterisk`: ImageVector? = null

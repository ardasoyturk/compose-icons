...
public val OutlineGroup.`Tilt-shift`: ImageVector
    get() {
        if (`_tilt-shift` != null) {
            return `_tilt-shift`!!
        }
        `_tilt-shift` = Builder(name = "Tilt-shift", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_tilt-shift`: ImageVector? = null

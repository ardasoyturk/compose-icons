...
public val OutlineGroup.`Laurel-wreath-1`: ImageVector
    get() {
        if (`_laurel-wreath-1` != null) {
            return `_laurel-wreath-1`!!
        }
        `_laurel-wreath-1` = Builder(name = "Laurel-wreath-1", defaultWidth = 24.0.dp, defaultHeight
...
private var `_laurel-wreath-1`: ImageVector? = null

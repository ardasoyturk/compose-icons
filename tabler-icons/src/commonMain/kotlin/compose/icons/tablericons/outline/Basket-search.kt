...
public val OutlineGroup.`Basket-search`: ImageVector
    get() {
        if (`_basket-search` != null) {
            return `_basket-search`!!
        }
        `_basket-search` = Builder(name = "Basket-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-search`: ImageVector? = null

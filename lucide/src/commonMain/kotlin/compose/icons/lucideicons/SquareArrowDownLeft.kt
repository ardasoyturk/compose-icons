...
public val LucideIcons.SquareArrowDownLeft: ImageVector
    get() {
        if (_squareArrowDownLeft != null) {
            return _squareArrowDownLeft!!
        }
        _squareArrowDownLeft = Builder(name = "SquareArrowDownLeft", defaultWidth = 24.0.dp,

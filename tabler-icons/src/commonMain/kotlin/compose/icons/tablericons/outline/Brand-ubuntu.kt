...
public val OutlineGroup.`Brand-ubuntu`: ImageVector
    get() {
        if (`_brand-ubuntu` != null) {
            return `_brand-ubuntu`!!
        }
        `_brand-ubuntu` = Builder(name = "Brand-ubuntu", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-ubuntu`: ImageVector? = null

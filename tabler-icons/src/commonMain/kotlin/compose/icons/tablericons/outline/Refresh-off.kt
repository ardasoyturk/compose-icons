...
public val OutlineGroup.`Refresh-off`: ImageVector
    get() {
        if (`_refresh-off` != null) {
            return `_refresh-off`!!
        }
        `_refresh-off` = Builder(name = "Refresh-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_refresh-off`: ImageVector? = null

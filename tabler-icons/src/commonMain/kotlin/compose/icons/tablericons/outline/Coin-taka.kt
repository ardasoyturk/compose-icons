...
public val OutlineGroup.`Coin-taka`: ImageVector
    get() {
        if (`_coin-taka` != null) {
            return `_coin-taka`!!
        }
        `_coin-taka` = Builder(name = "Coin-taka", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_coin-taka`: ImageVector? = null

...
public val OutlineGroup.`Pig-off`: ImageVector
    get() {
        if (`_pig-off` != null) {
            return `_pig-off`!!
        }
        `_pig-off` = Builder(name = "Pig-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_pig-off`: ImageVector? = null

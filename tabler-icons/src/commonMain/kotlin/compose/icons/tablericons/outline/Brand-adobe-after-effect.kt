...
public val OutlineGroup.`Brand-adobe-after-effect`: ImageVector
    get() {
        if (`_brand-adobe-after-effect` != null) {
            return `_brand-adobe-after-effect`!!
        }
        `_brand-adobe-after-effect` = Builder(name = "Brand-adobe-after-effect", defaultWidth =
...
private var `_brand-adobe-after-effect`: ImageVector? = null

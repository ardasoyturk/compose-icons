...
public val OutlineGroup.`Building-minus`: ImageVector
    get() {
        if (`_building-minus` != null) {
            return `_building-minus`!!
        }
        `_building-minus` = Builder(name = "Building-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_building-minus`: ImageVector? = null

...
public val LucideIcons.SquareBottomDashedScissors: ImageVector
    get() {
        if (_squareBottomDashedScissors != null) {
            return _squareBottomDashedScissors!!
        }
        _squareBottomDashedScissors = Builder(name = "SquareBottomDashedScissors", defaultWidth =

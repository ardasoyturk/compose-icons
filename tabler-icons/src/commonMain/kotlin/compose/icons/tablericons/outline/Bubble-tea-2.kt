...
public val OutlineGroup.`Bubble-tea-2`: ImageVector
    get() {
        if (`_bubble-tea-2` != null) {
            return `_bubble-tea-2`!!
        }
        `_bubble-tea-2` = Builder(name = "Bubble-tea-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bubble-tea-2`: ImageVector? = null

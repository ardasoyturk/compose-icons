...
public val OutlineGroup.`Hexagon-number-8`: ImageVector
    get() {
        if (`_hexagon-number-8` != null) {
            return `_hexagon-number-8`!!
        }
        `_hexagon-number-8` = Builder(name = "Hexagon-number-8", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-8`: ImageVector? = null

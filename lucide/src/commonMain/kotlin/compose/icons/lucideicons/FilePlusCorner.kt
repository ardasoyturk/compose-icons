...
public val LucideIcons.FilePlusCorner: ImageVector
    get() {
        if (_filePlusCorner != null) {
            return _filePlusCorner!!
        }
        _filePlusCorner = Builder(name = "FilePlusCorner", defaultWidth = 24.0.dp, defaultHeight =

...
public val OutlineGroup.`Variable-plus`: ImageVector
    get() {
        if (`_variable-plus` != null) {
            return `_variable-plus`!!
        }
        `_variable-plus` = Builder(name = "Variable-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_variable-plus`: ImageVector? = null

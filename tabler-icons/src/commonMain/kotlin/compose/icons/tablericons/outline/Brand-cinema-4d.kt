...
public val OutlineGroup.`Brand-cinema-4d`: ImageVector
    get() {
        if (`_brand-cinema-4d` != null) {
            return `_brand-cinema-4d`!!
        }
        `_brand-cinema-4d` = Builder(name = "Brand-cinema-4d", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-cinema-4d`: ImageVector? = null

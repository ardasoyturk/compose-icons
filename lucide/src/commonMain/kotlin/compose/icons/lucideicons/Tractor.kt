...
public val LucideIcons.Tractor: ImageVector
    get() {
        if (_tractor != null) {
            return _tractor!!
        }
        _tractor = Builder(name = "Tractor", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.8f, 1.1f)
                lineToRelative(-0.665f, 4.158f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.988f, 0.842f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.99f, 0.863f)
                lineTo(13.0f, 11.246f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {

...
public val OutlineGroup.`Hand-love-you`: ImageVector
    get() {
        if (`_hand-love-you` != null) {
            return `_hand-love-you`!!
        }
        `_hand-love-you` = Builder(name = "Hand-love-you", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hand-love-you`: ImageVector? = null

...
public val OutlineGroup.`Mood-heart`: ImageVector
    get() {
        if (`_mood-heart` != null) {
            return `_mood-heart`!!
        }
        `_mood-heart` = Builder(name = "Mood-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_mood-heart`: ImageVector? = null

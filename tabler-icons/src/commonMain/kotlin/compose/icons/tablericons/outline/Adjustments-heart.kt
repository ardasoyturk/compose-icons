...
public val OutlineGroup.`Adjustments-heart`: ImageVector
    get() {
        if (`_adjustments-heart` != null) {
            return `_adjustments-heart`!!
        }
        `_adjustments-heart` = Builder(name = "Adjustments-heart", defaultWidth = 24.0.dp,
...
private var `_adjustments-heart`: ImageVector? = null

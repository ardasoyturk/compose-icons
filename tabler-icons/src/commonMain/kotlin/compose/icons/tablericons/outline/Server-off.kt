...
public val OutlineGroup.`Server-off`: ImageVector
    get() {
        if (`_server-off` != null) {
            return `_server-off`!!
        }
        `_server-off` = Builder(name = "Server-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_server-off`: ImageVector? = null

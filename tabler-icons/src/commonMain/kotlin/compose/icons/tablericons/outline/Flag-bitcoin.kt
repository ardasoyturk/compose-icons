...
public val OutlineGroup.`Flag-bitcoin`: ImageVector
    get() {
        if (`_flag-bitcoin` != null) {
            return `_flag-bitcoin`!!
        }
        `_flag-bitcoin` = Builder(name = "Flag-bitcoin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flag-bitcoin`: ImageVector? = null

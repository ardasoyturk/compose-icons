...
public val OutlineGroup.`Settings-x`: ImageVector
    get() {
        if (`_settings-x` != null) {
            return `_settings-x`!!
        }
        `_settings-x` = Builder(name = "Settings-x", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-x`: ImageVector? = null

...
public val OutlineGroup.`Fish-off`: ImageVector
    get() {
        if (`_fish-off` != null) {
            return `_fish-off`!!
        }
        `_fish-off` = Builder(name = "Fish-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_fish-off`: ImageVector? = null

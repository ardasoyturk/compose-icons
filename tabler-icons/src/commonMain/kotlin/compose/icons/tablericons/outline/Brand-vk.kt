...
public val OutlineGroup.`Brand-vk`: ImageVector
    get() {
        if (`_brand-vk` != null) {
            return `_brand-vk`!!
        }
        `_brand-vk` = Builder(name = "Brand-vk", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-vk`: ImageVector? = null

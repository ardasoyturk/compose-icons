...
public val OutlineGroup.`Windmill-off`: ImageVector
    get() {
        if (`_windmill-off` != null) {
            return `_windmill-off`!!
        }
        `_windmill-off` = Builder(name = "Windmill-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_windmill-off`: ImageVector? = null

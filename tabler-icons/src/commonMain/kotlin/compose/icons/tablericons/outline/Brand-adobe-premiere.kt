...
public val OutlineGroup.`Brand-adobe-premiere`: ImageVector
    get() {
        if (`_brand-adobe-premiere` != null) {
            return `_brand-adobe-premiere`!!
        }
        `_brand-adobe-premiere` = Builder(name = "Brand-adobe-premiere", defaultWidth = 24.0.dp,
...
private var `_brand-adobe-premiere`: ImageVector? = null

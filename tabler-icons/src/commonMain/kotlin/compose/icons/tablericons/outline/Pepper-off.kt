...
public val OutlineGroup.`Pepper-off`: ImageVector
    get() {
        if (`_pepper-off` != null) {
            return `_pepper-off`!!
        }
        `_pepper-off` = Builder(name = "Pepper-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pepper-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-foursquare`: ImageVector
    get() {
        if (`_brand-foursquare` != null) {
            return `_brand-foursquare`!!
        }
        `_brand-foursquare` = Builder(name = "Brand-foursquare", defaultWidth = 24.0.dp,
...
private var `_brand-foursquare`: ImageVector? = null

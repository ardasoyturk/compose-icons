...
public val OutlineGroup.`Disc-off`: ImageVector
    get() {
        if (`_disc-off` != null) {
            return `_disc-off`!!
        }
        `_disc-off` = Builder(name = "Disc-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_disc-off`: ImageVector? = null

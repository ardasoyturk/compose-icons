...
public val OutlineGroup.`Cloud-cog`: ImageVector
    get() {
        if (`_cloud-cog` != null) {
            return `_cloud-cog`!!
        }
        `_cloud-cog` = Builder(name = "Cloud-cog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cloud-cog`: ImageVector? = null

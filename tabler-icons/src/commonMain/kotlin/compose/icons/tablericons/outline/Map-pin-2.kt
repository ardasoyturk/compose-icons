...
public val OutlineGroup.`Map-pin-2`: ImageVector
    get() {
        if (`_map-pin-2` != null) {
            return `_map-pin-2`!!
        }
        `_map-pin-2` = Builder(name = "Map-pin-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_map-pin-2`: ImageVector? = null

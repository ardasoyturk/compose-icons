...
public val OutlineGroup.`Pencil-star`: ImageVector
    get() {
        if (`_pencil-star` != null) {
            return `_pencil-star`!!
        }
        `_pencil-star` = Builder(name = "Pencil-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pencil-star`: ImageVector? = null

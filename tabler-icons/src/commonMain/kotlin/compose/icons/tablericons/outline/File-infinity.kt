...
public val OutlineGroup.`File-infinity`: ImageVector
    get() {
        if (`_file-infinity` != null) {
            return `_file-infinity`!!
        }
        `_file-infinity` = Builder(name = "File-infinity", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-infinity`: ImageVector? = null

...
public val OutlineGroup.`Play-card-star`: ImageVector
    get() {
        if (`_play-card-star` != null) {
            return `_play-card-star`!!
        }
        `_play-card-star` = Builder(name = "Play-card-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_play-card-star`: ImageVector? = null

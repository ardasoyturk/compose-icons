...
public val OutlineGroup.`Bubble-plus`: ImageVector
    get() {
        if (`_bubble-plus` != null) {
            return `_bubble-plus`!!
        }
        `_bubble-plus` = Builder(name = "Bubble-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bubble-plus`: ImageVector? = null

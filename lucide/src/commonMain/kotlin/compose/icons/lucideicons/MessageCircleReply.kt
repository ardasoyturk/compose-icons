...
public val LucideIcons.MessageCircleReply: ImageVector
    get() {
        if (_messageCircleReply != null) {
            return _messageCircleReply!!
        }
        _messageCircleReply = Builder(name = "MessageCircleReply", defaultWidth = 24.0.dp,

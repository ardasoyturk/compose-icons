...
public val LucideIcons.MessageSquareX: ImageVector
    get() {
        if (_messageSquareX != null) {
            return _messageSquareX!!
        }
        _messageSquareX = Builder(name = "MessageSquareX", defaultWidth = 24.0.dp, defaultHeight =

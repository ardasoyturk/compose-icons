...
public val OutlineGroup.`Tag-off`: ImageVector
    get() {
        if (`_tag-off` != null) {
            return `_tag-off`!!
        }
        `_tag-off` = Builder(name = "Tag-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tag-off`: ImageVector? = null

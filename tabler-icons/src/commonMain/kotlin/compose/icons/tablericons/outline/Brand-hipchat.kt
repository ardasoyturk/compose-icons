...
public val OutlineGroup.`Brand-hipchat`: ImageVector
    get() {
        if (`_brand-hipchat` != null) {
            return `_brand-hipchat`!!
        }
        `_brand-hipchat` = Builder(name = "Brand-hipchat", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-hipchat`: ImageVector? = null

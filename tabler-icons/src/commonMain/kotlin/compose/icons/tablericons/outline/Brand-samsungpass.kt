...
public val OutlineGroup.`Brand-samsungpass`: ImageVector
    get() {
        if (`_brand-samsungpass` != null) {
            return `_brand-samsungpass`!!
        }
        `_brand-samsungpass` = Builder(name = "Brand-samsungpass", defaultWidth = 24.0.dp,
...
private var `_brand-samsungpass`: ImageVector? = null

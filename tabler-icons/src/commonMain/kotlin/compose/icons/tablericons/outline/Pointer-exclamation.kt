...
public val OutlineGroup.`Pointer-exclamation`: ImageVector
    get() {
        if (`_pointer-exclamation` != null) {
            return `_pointer-exclamation`!!
        }
        `_pointer-exclamation` = Builder(name = "Pointer-exclamation", defaultWidth = 24.0.dp,
...
private var `_pointer-exclamation`: ImageVector? = null

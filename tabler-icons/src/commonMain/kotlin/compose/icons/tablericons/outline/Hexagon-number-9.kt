...
public val OutlineGroup.`Hexagon-number-9`: ImageVector
    get() {
        if (`_hexagon-number-9` != null) {
            return `_hexagon-number-9`!!
        }
        `_hexagon-number-9` = Builder(name = "Hexagon-number-9", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-9`: ImageVector? = null

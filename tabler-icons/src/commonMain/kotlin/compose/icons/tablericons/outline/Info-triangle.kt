...
public val OutlineGroup.`Info-triangle`: ImageVector
    get() {
        if (`_info-triangle` != null) {
            return `_info-triangle`!!
        }
        `_info-triangle` = Builder(name = "Info-triangle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_info-triangle`: ImageVector? = null

...
public val OutlineGroup.`Wash-off`: ImageVector
    get() {
        if (`_wash-off` != null) {
            return `_wash-off`!!
        }
        `_wash-off` = Builder(name = "Wash-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wash-off`: ImageVector? = null

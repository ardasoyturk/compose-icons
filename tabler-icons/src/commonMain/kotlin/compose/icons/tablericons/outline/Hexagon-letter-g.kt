...
public val OutlineGroup.`Hexagon-letter-g`: ImageVector
    get() {
        if (`_hexagon-letter-g` != null) {
            return `_hexagon-letter-g`!!
        }
        `_hexagon-letter-g` = Builder(name = "Hexagon-letter-g", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-g`: ImageVector? = null

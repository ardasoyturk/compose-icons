...
public val OutlineGroup.`Pointer-star`: ImageVector
    get() {
        if (`_pointer-star` != null) {
            return `_pointer-star`!!
        }
        `_pointer-star` = Builder(name = "Pointer-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-star`: ImageVector? = null

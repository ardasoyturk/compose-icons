...
public val OutlineGroup.`Brand-terraform`: ImageVector
    get() {
        if (`_brand-terraform` != null) {
            return `_brand-terraform`!!
        }
        `_brand-terraform` = Builder(name = "Brand-terraform", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-terraform`: ImageVector? = null

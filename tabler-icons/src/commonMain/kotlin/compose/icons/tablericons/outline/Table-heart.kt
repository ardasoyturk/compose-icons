...
public val OutlineGroup.`Table-heart`: ImageVector
    get() {
        if (`_table-heart` != null) {
            return `_table-heart`!!
        }
        `_table-heart` = Builder(name = "Table-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_table-heart`: ImageVector? = null

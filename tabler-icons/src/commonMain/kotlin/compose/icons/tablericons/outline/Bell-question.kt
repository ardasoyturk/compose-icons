...
public val OutlineGroup.`Bell-question`: ImageVector
    get() {
        if (`_bell-question` != null) {
            return `_bell-question`!!
        }
        `_bell-question` = Builder(name = "Bell-question", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bell-question`: ImageVector? = null

...
public val OutlineGroup.`Cone-off`: ImageVector
    get() {
        if (`_cone-off` != null) {
            return `_cone-off`!!
        }
        `_cone-off` = Builder(name = "Cone-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cone-off`: ImageVector? = null

...
public val OutlineGroup.`Shield-pin`: ImageVector
    get() {
        if (`_shield-pin` != null) {
            return `_shield-pin`!!
        }
        `_shield-pin` = Builder(name = "Shield-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shield-pin`: ImageVector? = null

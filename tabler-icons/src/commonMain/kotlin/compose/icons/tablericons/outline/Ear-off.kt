...
public val OutlineGroup.`Ear-off`: ImageVector
    get() {
        if (`_ear-off` != null) {
            return `_ear-off`!!
        }
        `_ear-off` = Builder(name = "Ear-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ear-off`: ImageVector? = null

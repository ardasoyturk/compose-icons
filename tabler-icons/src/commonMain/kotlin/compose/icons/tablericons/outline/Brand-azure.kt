...
public val OutlineGroup.`Brand-azure`: ImageVector
    get() {
        if (`_brand-azure` != null) {
            return `_brand-azure`!!
        }
        `_brand-azure` = Builder(name = "Brand-azure", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-azure`: ImageVector? = null

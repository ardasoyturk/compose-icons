...
public val OutlineGroup.`Brand-apple-arcade`: ImageVector
    get() {
        if (`_brand-apple-arcade` != null) {
            return `_brand-apple-arcade`!!
        }
        `_brand-apple-arcade` = Builder(name = "Brand-apple-arcade", defaultWidth = 24.0.dp,
...
private var `_brand-apple-arcade`: ImageVector? = null

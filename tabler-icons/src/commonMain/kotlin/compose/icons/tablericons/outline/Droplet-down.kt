...
public val OutlineGroup.`Droplet-down`: ImageVector
    get() {
        if (`_droplet-down` != null) {
            return `_droplet-down`!!
        }
        `_droplet-down` = Builder(name = "Droplet-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-down`: ImageVector? = null

...
public val OutlineGroup.`Brand-docker`: ImageVector
    get() {
        if (`_brand-docker` != null) {
            return `_brand-docker`!!
        }
        `_brand-docker` = Builder(name = "Brand-docker", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-docker`: ImageVector? = null

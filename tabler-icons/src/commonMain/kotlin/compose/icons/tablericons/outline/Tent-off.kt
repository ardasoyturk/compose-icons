...
public val OutlineGroup.`Tent-off`: ImageVector
    get() {
        if (`_tent-off` != null) {
            return `_tent-off`!!
        }
        `_tent-off` = Builder(name = "Tent-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tent-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-amie`: ImageVector
    get() {
        if (`_brand-amie` != null) {
            return `_brand-amie`!!
        }
        `_brand-amie` = Builder(name = "Brand-amie", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-amie`: ImageVector? = null

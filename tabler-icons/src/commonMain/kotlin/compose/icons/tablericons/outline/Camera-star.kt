...
public val OutlineGroup.`Camera-star`: ImageVector
    get() {
        if (`_camera-star` != null) {
            return `_camera-star`!!
        }
        `_camera-star` = Builder(name = "Camera-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_camera-star`: ImageVector? = null

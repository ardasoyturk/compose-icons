...
public val LucideIcons.WifiPen: ImageVector
    get() {
        if (_wifiPen != null) {
            return _wifiPen!!
        }
        _wifiPen = Builder(name = "WifiPen", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(5.0f, 12.859f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, true, 10.5f, -2.222f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.5f, 16.429f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 3.0f, -1.406f)
            }
        }
        .build()
        return _wifiPen!!

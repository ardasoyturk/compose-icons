...
public val OutlineGroup.`Sun-high`: ImageVector
    get() {
        if (`_sun-high` != null) {
            return `_sun-high`!!
        }
        `_sun-high` = Builder(name = "Sun-high", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_sun-high`: ImageVector? = null

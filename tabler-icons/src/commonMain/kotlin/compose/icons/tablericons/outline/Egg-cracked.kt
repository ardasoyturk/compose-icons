...
public val OutlineGroup.`Egg-cracked`: ImageVector
    get() {
        if (`_egg-cracked` != null) {
            return `_egg-cracked`!!
        }
        `_egg-cracked` = Builder(name = "Egg-cracked", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_egg-cracked`: ImageVector? = null

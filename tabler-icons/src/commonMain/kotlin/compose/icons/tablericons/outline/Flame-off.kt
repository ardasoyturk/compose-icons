...
public val OutlineGroup.`Flame-off`: ImageVector
    get() {
        if (`_flame-off` != null) {
            return `_flame-off`!!
        }
        `_flame-off` = Builder(name = "Flame-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_flame-off`: ImageVector? = null

...
public val OutlineGroup.`Currency-dinar`: ImageVector
    get() {
        if (`_currency-dinar` != null) {
            return `_currency-dinar`!!
        }
        `_currency-dinar` = Builder(name = "Currency-dinar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_currency-dinar`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-z`: ImageVector
    get() {
        if (`_hexagon-letter-z` != null) {
            return `_hexagon-letter-z`!!
        }
        `_hexagon-letter-z` = Builder(name = "Hexagon-letter-z", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-z`: ImageVector? = null

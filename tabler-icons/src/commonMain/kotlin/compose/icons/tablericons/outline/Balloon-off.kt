...
public val OutlineGroup.`Balloon-off`: ImageVector
    get() {
        if (`_balloon-off` != null) {
            return `_balloon-off`!!
        }
        `_balloon-off` = Builder(name = "Balloon-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_balloon-off`: ImageVector? = null

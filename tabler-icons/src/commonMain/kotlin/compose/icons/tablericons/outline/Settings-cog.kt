...
public val OutlineGroup.`Settings-cog`: ImageVector
    get() {
        if (`_settings-cog` != null) {
            return `_settings-cog`!!
        }
        `_settings-cog` = Builder(name = "Settings-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-cog`: ImageVector? = null

...
public val OutlineGroup.`Settings-ai`: ImageVector
    get() {
        if (`_settings-ai` != null) {
            return `_settings-ai`!!
        }
        `_settings-ai` = Builder(name = "Settings-ai", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-ai`: ImageVector? = null

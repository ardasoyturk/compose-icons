...
public val OutlineGroup.`Cube-plus`: ImageVector
    get() {
        if (`_cube-plus` != null) {
            return `_cube-plus`!!
        }
        `_cube-plus` = Builder(name = "Cube-plus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cube-plus`: ImageVector? = null

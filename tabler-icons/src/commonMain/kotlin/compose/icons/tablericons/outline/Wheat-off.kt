...
public val OutlineGroup.`Wheat-off`: ImageVector
    get() {
        if (`_wheat-off` != null) {
            return `_wheat-off`!!
        }
        `_wheat-off` = Builder(name = "Wheat-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wheat-off`: ImageVector? = null

...
public val OutlineGroup.`Lock-star`: ImageVector
    get() {
        if (`_lock-star` != null) {
            return `_lock-star`!!
        }
        `_lock-star` = Builder(name = "Lock-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lock-star`: ImageVector? = null

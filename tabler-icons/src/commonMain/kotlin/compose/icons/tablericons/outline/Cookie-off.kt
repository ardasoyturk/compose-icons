...
public val OutlineGroup.`Cookie-off`: ImageVector
    get() {
        if (`_cookie-off` != null) {
            return `_cookie-off`!!
        }
        `_cookie-off` = Builder(name = "Cookie-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cookie-off`: ImageVector? = null

...
public val OutlineGroup.`Scale-outline-off`: ImageVector
    get() {
        if (`_scale-outline-off` != null) {
            return `_scale-outline-off`!!
        }
        `_scale-outline-off` = Builder(name = "Scale-outline-off", defaultWidth = 24.0.dp,
...
private var `_scale-outline-off`: ImageVector? = null

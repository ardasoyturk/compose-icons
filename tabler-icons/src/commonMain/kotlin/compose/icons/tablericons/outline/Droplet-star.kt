...
public val OutlineGroup.`Droplet-star`: ImageVector
    get() {
        if (`_droplet-star` != null) {
            return `_droplet-star`!!
        }
        `_droplet-star` = Builder(name = "Droplet-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-star`: ImageVector? = null

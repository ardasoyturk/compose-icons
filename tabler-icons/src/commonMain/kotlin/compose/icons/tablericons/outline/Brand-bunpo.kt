...
public val OutlineGroup.`Brand-bunpo`: ImageVector
    get() {
        if (`_brand-bunpo` != null) {
            return `_brand-bunpo`!!
        }
        `_brand-bunpo` = Builder(name = "Brand-bunpo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-bunpo`: ImageVector? = null

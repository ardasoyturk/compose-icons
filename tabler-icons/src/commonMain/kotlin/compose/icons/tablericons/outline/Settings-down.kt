...
public val OutlineGroup.`Settings-down`: ImageVector
    get() {
        if (`_settings-down` != null) {
            return `_settings-down`!!
        }
        `_settings-down` = Builder(name = "Settings-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-down`: ImageVector? = null

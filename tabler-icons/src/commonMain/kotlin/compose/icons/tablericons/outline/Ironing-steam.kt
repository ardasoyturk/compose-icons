...
public val OutlineGroup.`Ironing-steam`: ImageVector
    get() {
        if (`_ironing-steam` != null) {
            return `_ironing-steam`!!
        }
        `_ironing-steam` = Builder(name = "Ironing-steam", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ironing-steam`: ImageVector? = null

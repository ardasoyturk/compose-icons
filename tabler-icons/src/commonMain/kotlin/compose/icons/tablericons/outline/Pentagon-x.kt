...
public val OutlineGroup.`Pentagon-x`: ImageVector
    get() {
        if (`_pentagon-x` != null) {
            return `_pentagon-x`!!
        }
        `_pentagon-x` = Builder(name = "Pentagon-x", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pentagon-x`: ImageVector? = null

...
public val OutlineGroup.`Brand-rumble`: ImageVector
    get() {
        if (`_brand-rumble` != null) {
            return `_brand-rumble`!!
        }
        `_brand-rumble` = Builder(name = "Brand-rumble", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-rumble`: ImageVector? = null

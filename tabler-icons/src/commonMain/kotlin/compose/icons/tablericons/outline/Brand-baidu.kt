...
public val OutlineGroup.`Brand-baidu`: ImageVector
    get() {
        if (`_brand-baidu` != null) {
            return `_brand-baidu`!!
        }
        `_brand-baidu` = Builder(name = "Brand-baidu", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-baidu`: ImageVector? = null

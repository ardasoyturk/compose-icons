...
public val OutlineGroup.`Stars-off`: ImageVector
    get() {
        if (`_stars-off` != null) {
            return `_stars-off`!!
        }
        `_stars-off` = Builder(name = "Stars-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_stars-off`: ImageVector? = null

...
public val OutlineGroup.`World-star`: ImageVector
    get() {
        if (`_world-star` != null) {
            return `_world-star`!!
        }
        `_world-star` = Builder(name = "World-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_world-star`: ImageVector? = null

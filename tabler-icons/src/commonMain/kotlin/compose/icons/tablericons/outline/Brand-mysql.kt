...
public val OutlineGroup.`Brand-mysql`: ImageVector
    get() {
        if (`_brand-mysql` != null) {
            return `_brand-mysql`!!
        }
        `_brand-mysql` = Builder(name = "Brand-mysql", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-mysql`: ImageVector? = null

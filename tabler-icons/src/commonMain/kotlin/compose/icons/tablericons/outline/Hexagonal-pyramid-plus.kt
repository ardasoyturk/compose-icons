...
public val OutlineGroup.`Hexagonal-pyramid-plus`: ImageVector
    get() {
        if (`_hexagonal-pyramid-plus` != null) {
            return `_hexagonal-pyramid-plus`!!
        }
        `_hexagonal-pyramid-plus` = Builder(name = "Hexagonal-pyramid-plus", defaultWidth = 24.0.dp,
...
private var `_hexagonal-pyramid-plus`: ImageVector? = null

...
public val OutlineGroup.`Wash-temperature-3`: ImageVector
    get() {
        if (`_wash-temperature-3` != null) {
            return `_wash-temperature-3`!!
        }
        `_wash-temperature-3` = Builder(name = "Wash-temperature-3", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-3`: ImageVector? = null

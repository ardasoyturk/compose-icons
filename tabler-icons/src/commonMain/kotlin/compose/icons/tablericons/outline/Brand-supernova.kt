...
public val OutlineGroup.`Brand-supernova`: ImageVector
    get() {
        if (`_brand-supernova` != null) {
            return `_brand-supernova`!!
        }
        `_brand-supernova` = Builder(name = "Brand-supernova", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-supernova`: ImageVector? = null

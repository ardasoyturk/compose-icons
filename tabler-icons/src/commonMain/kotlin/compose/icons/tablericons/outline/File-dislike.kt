...
public val OutlineGroup.`File-dislike`: ImageVector
    get() {
        if (`_file-dislike` != null) {
            return `_file-dislike`!!
        }
        `_file-dislike` = Builder(name = "File-dislike", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-dislike`: ImageVector? = null

...
public val OutlineGroup.`Cloud-pause`: ImageVector
    get() {
        if (`_cloud-pause` != null) {
            return `_cloud-pause`!!
        }
        `_cloud-pause` = Builder(name = "Cloud-pause", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-pause`: ImageVector? = null

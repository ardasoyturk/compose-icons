...
public val OutlineGroup.`Basket-star`: ImageVector
    get() {
        if (`_basket-star` != null) {
            return `_basket-star`!!
        }
        `_basket-star` = Builder(name = "Basket-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-star`: ImageVector? = null

...
public val OutlineGroup.`Direction-sign-off`: ImageVector
    get() {
        if (`_direction-sign-off` != null) {
            return `_direction-sign-off`!!
        }
        `_direction-sign-off` = Builder(name = "Direction-sign-off", defaultWidth = 24.0.dp,
...
private var `_direction-sign-off`: ImageVector? = null

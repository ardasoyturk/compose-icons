...
public val OutlineGroup.`Brand-bluesky`: ImageVector
    get() {
        if (`_brand-bluesky` != null) {
            return `_brand-bluesky`!!
        }
        `_brand-bluesky` = Builder(name = "Brand-bluesky", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-bluesky`: ImageVector? = null

...
public val LucideIcons.FileExclamationPoint: ImageVector
    get() {
        if (_fileExclamationPoint != null) {
            return _fileExclamationPoint!!
        }
        _fileExclamationPoint = Builder(name = "FileExclamationPoint", defaultWidth = 24.0.dp,

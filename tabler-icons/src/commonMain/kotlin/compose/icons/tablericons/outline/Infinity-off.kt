...
public val OutlineGroup.`Infinity-off`: ImageVector
    get() {
        if (`_infinity-off` != null) {
            return `_infinity-off`!!
        }
        `_infinity-off` = Builder(name = "Infinity-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_infinity-off`: ImageVector? = null

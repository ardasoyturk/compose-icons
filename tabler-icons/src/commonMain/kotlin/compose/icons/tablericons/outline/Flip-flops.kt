...
public val OutlineGroup.`Flip-flops`: ImageVector
    get() {
        if (`_flip-flops` != null) {
            return `_flip-flops`!!
        }
        `_flip-flops` = Builder(name = "Flip-flops", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flip-flops`: ImageVector? = null

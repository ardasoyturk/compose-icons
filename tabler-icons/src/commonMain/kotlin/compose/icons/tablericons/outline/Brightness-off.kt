...
public val OutlineGroup.`Brightness-off`: ImageVector
    get() {
        if (`_brightness-off` != null) {
            return `_brightness-off`!!
        }
        `_brightness-off` = Builder(name = "Brightness-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brightness-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-twitch`: ImageVector
    get() {
        if (`_brand-twitch` != null) {
            return `_brand-twitch`!!
        }
        `_brand-twitch` = Builder(name = "Brand-twitch", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-twitch`: ImageVector? = null

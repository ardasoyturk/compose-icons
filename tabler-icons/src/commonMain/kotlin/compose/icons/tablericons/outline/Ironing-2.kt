...
public val OutlineGroup.`Ironing-2`: ImageVector
    get() {
        if (`_ironing-2` != null) {
            return `_ironing-2`!!
        }
        `_ironing-2` = Builder(name = "Ironing-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ironing-2`: ImageVector? = null

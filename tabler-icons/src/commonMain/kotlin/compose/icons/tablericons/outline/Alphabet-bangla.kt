...
public val OutlineGroup.`Alphabet-bangla`: ImageVector
    get() {
        if (`_alphabet-bangla` != null) {
            return `_alphabet-bangla`!!
        }
        `_alphabet-bangla` = Builder(name = "Alphabet-bangla", defaultWidth = 24.0.dp, defaultHeight
...
private var `_alphabet-bangla`: ImageVector? = null

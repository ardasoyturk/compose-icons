...
public val OutlineGroup.`Settings-pin`: ImageVector
    get() {
        if (`_settings-pin` != null) {
            return `_settings-pin`!!
        }
        `_settings-pin` = Builder(name = "Settings-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-pin`: ImageVector? = null

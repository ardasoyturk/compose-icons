...
public val OutlineGroup.`Brand-patreon`: ImageVector
    get() {
        if (`_brand-patreon` != null) {
            return `_brand-patreon`!!
        }
        `_brand-patreon` = Builder(name = "Brand-patreon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-patreon`: ImageVector? = null

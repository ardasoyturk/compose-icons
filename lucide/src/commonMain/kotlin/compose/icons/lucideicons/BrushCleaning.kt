...
public val LucideIcons.BrushCleaning: ImageVector
    get() {
        if (_brushCleaning != null) {
            return _brushCleaning!!
        }
        _brushCleaning = Builder(name = "BrushCleaning", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.973f, -1.233f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =

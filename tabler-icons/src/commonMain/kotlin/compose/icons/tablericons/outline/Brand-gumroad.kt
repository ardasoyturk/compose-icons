...
public val OutlineGroup.`Brand-gumroad`: ImageVector
    get() {
        if (`_brand-gumroad` != null) {
            return `_brand-gumroad`!!
        }
        `_brand-gumroad` = Builder(name = "Brand-gumroad", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-gumroad`: ImageVector? = null

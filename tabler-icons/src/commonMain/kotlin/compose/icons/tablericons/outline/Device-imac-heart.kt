...
public val OutlineGroup.`Device-imac-heart`: ImageVector
    get() {
        if (`_device-imac-heart` != null) {
            return `_device-imac-heart`!!
        }
        `_device-imac-heart` = Builder(name = "Device-imac-heart", defaultWidth = 24.0.dp,
...
private var `_device-imac-heart`: ImageVector? = null

...
public val OutlineGroup.`Filter-star`: ImageVector
    get() {
        if (`_filter-star` != null) {
            return `_filter-star`!!
        }
        `_filter-star` = Builder(name = "Filter-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-star`: ImageVector? = null

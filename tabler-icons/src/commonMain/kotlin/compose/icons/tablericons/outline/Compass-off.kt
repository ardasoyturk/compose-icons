...
public val OutlineGroup.`Compass-off`: ImageVector
    get() {
        if (`_compass-off` != null) {
            return `_compass-off`!!
        }
        `_compass-off` = Builder(name = "Compass-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_compass-off`: ImageVector? = null

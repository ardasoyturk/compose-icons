...
public val OutlineGroup.`Sticker-2`: ImageVector
    get() {
        if (`_sticker-2` != null) {
            return `_sticker-2`!!
        }
        `_sticker-2` = Builder(name = "Sticker-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_sticker-2`: ImageVector? = null

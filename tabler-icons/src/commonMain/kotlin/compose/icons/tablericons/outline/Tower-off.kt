...
public val OutlineGroup.`Tower-off`: ImageVector
    get() {
        if (`_tower-off` != null) {
            return `_tower-off`!!
        }
        `_tower-off` = Builder(name = "Tower-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tower-off`: ImageVector? = null

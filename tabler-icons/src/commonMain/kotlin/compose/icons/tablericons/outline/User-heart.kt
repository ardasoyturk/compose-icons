...
public val OutlineGroup.`User-heart`: ImageVector
    get() {
        if (`_user-heart` != null) {
            return `_user-heart`!!
        }
        `_user-heart` = Builder(name = "User-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_user-heart`: ImageVector? = null

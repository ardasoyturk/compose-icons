...
public val OutlineGroup.`Hexagon-off`: ImageVector
    get() {
        if (`_hexagon-off` != null) {
            return `_hexagon-off`!!
        }
        `_hexagon-off` = Builder(name = "Hexagon-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hexagon-off`: ImageVector? = null

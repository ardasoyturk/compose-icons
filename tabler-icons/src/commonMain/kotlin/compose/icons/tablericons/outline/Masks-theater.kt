...
public val OutlineGroup.`Masks-theater`: ImageVector
    get() {
        if (`_masks-theater` != null) {
            return `_masks-theater`!!
        }
        `_masks-theater` = Builder(name = "Masks-theater", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_masks-theater`: ImageVector? = null

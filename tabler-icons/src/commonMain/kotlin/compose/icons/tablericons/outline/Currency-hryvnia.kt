...
public val OutlineGroup.`Currency-hryvnia`: ImageVector
    get() {
        if (`_currency-hryvnia` != null) {
            return `_currency-hryvnia`!!
        }
        `_currency-hryvnia` = Builder(name = "Currency-hryvnia", defaultWidth = 24.0.dp,
...
private var `_currency-hryvnia`: ImageVector? = null

...
public val OutlineGroup.`Golf-off`: ImageVector
    get() {
        if (`_golf-off` != null) {
            return `_golf-off`!!
        }
        `_golf-off` = Builder(name = "Golf-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_golf-off`: ImageVector? = null

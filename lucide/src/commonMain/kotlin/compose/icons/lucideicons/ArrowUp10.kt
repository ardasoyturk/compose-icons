...
public val LucideIcons.ArrowUp10: ImageVector
    get() {
        if (_arrowUp10 != null) {
            return _arrowUp10!!
        }
        _arrowUp10 = Builder(name = "ArrowUp10", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(15.0f, 16.0f)
                arcTo(2.0f, 2.0f, 0.0f, false, true, 17.0f, 14.0f)
                close()
            }
        }
        .build()

...
public val OutlineGroup.`Settings-cancel`: ImageVector
    get() {
        if (`_settings-cancel` != null) {
            return `_settings-cancel`!!
        }
        `_settings-cancel` = Builder(name = "Settings-cancel", defaultWidth = 24.0.dp, defaultHeight
...
private var `_settings-cancel`: ImageVector? = null

...
public val OutlineGroup.`Rosette-number-6`: ImageVector
    get() {
        if (`_rosette-number-6` != null) {
            return `_rosette-number-6`!!
        }
        `_rosette-number-6` = Builder(name = "Rosette-number-6", defaultWidth = 24.0.dp,
...
private var `_rosette-number-6`: ImageVector? = null

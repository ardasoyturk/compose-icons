...
public val OutlineGroup.`Filter-minus`: ImageVector
    get() {
        if (`_filter-minus` != null) {
            return `_filter-minus`!!
        }
        `_filter-minus` = Builder(name = "Filter-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-minus`: ImageVector? = null

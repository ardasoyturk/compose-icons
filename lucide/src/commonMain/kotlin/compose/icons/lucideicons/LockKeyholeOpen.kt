...
public val LucideIcons.LockKeyholeOpen: ImageVector
    get() {
        if (_lockKeyholeOpen != null) {
            return _lockKeyholeOpen!!
        }
        _lockKeyholeOpen = Builder(name = "LockKeyholeOpen", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(7.0f, 10.0f)
                verticalLineTo(7.0f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 9.33f, -2.5f)
            }
        }
        .build()
        return _lockKeyholeOpen!!

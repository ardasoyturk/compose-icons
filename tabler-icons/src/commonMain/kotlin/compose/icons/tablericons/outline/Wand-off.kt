...
public val OutlineGroup.`Wand-off`: ImageVector
    get() {
        if (`_wand-off` != null) {
            return `_wand-off`!!
        }
        `_wand-off` = Builder(name = "Wand-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wand-off`: ImageVector? = null

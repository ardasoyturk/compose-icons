...
public val OutlineGroup.`Eye-share`: ImageVector
    get() {
        if (`_eye-share` != null) {
            return `_eye-share`!!
        }
        `_eye-share` = Builder(name = "Eye-share", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-share`: ImageVector? = null

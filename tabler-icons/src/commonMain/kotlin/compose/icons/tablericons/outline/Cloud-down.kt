...
public val OutlineGroup.`Cloud-down`: ImageVector
    get() {
        if (`_cloud-down` != null) {
            return `_cloud-down`!!
        }
        `_cloud-down` = Builder(name = "Cloud-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-down`: ImageVector? = null

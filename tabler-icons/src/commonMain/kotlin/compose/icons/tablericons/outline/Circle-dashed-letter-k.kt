...
public val OutlineGroup.`Circle-dashed-letter-k`: ImageVector
    get() {
        if (`_circle-dashed-letter-k` != null) {
            return `_circle-dashed-letter-k`!!
        }
        `_circle-dashed-letter-k` = Builder(name = "Circle-dashed-letter-k", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-k`: ImageVector? = null

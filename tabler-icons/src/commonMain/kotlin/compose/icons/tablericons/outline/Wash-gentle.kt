...
public val OutlineGroup.`Wash-gentle`: ImageVector
    get() {
        if (`_wash-gentle` != null) {
            return `_wash-gentle`!!
        }
        `_wash-gentle` = Builder(name = "Wash-gentle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_wash-gentle`: ImageVector? = null

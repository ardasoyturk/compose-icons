...
public val OutlineGroup.`Brand-auth0`: ImageVector
    get() {
        if (`_brand-auth0` != null) {
            return `_brand-auth0`!!
        }
        `_brand-auth0` = Builder(name = "Brand-auth0", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-auth0`: ImageVector? = null

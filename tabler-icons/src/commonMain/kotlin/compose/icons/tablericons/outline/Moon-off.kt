...
public val OutlineGroup.`Moon-off`: ImageVector
    get() {
        if (`_moon-off` != null) {
            return `_moon-off`!!
        }
        `_moon-off` = Builder(name = "Moon-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_moon-off`: ImageVector? = null

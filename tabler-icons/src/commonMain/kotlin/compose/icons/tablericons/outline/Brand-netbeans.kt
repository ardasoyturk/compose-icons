...
public val OutlineGroup.`Brand-netbeans`: ImageVector
    get() {
        if (`_brand-netbeans` != null) {
            return `_brand-netbeans`!!
        }
        `_brand-netbeans` = Builder(name = "Brand-netbeans", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-netbeans`: ImageVector? = null

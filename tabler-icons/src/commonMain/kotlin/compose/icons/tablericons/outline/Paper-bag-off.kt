...
public val OutlineGroup.`Paper-bag-off`: ImageVector
    get() {
        if (`_paper-bag-off` != null) {
            return `_paper-bag-off`!!
        }
        `_paper-bag-off` = Builder(name = "Paper-bag-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_paper-bag-off`: ImageVector? = null

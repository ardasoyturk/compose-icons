...
public val OutlineGroup.`Shield-question`: ImageVector
    get() {
        if (`_shield-question` != null) {
            return `_shield-question`!!
        }
        `_shield-question` = Builder(name = "Shield-question", defaultWidth = 24.0.dp, defaultHeight
...
private var `_shield-question`: ImageVector? = null

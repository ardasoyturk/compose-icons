...
public val OutlineGroup.`Webhook-off`: ImageVector
    get() {
        if (`_webhook-off` != null) {
            return `_webhook-off`!!
        }
        `_webhook-off` = Builder(name = "Webhook-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_webhook-off`: ImageVector? = null

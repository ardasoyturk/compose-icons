...
public val OutlineGroup.`Phone-calling`: ImageVector
    get() {
        if (`_phone-calling` != null) {
            return `_phone-calling`!!
        }
        `_phone-calling` = Builder(name = "Phone-calling", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-calling`: ImageVector? = null

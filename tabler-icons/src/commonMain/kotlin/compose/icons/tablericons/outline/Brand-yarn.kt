...
public val OutlineGroup.`Brand-yarn`: ImageVector
    get() {
        if (`_brand-yarn` != null) {
            return `_brand-yarn`!!
        }
        `_brand-yarn` = Builder(name = "Brand-yarn", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-yarn`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-number-4`: ImageVector
    get() {
        if (`_hexagon-number-4` != null) {
            return `_hexagon-number-4`!!
        }
        `_hexagon-number-4` = Builder(name = "Hexagon-number-4", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-4`: ImageVector? = null

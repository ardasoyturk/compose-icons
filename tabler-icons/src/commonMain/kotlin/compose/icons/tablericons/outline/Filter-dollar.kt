...
public val OutlineGroup.`Filter-dollar`: ImageVector
    get() {
        if (`_filter-dollar` != null) {
            return `_filter-dollar`!!
        }
        `_filter-dollar` = Builder(name = "Filter-dollar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-dollar`: ImageVector? = null

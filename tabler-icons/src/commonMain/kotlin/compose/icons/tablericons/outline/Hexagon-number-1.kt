...
public val OutlineGroup.`Hexagon-number-1`: ImageVector
    get() {
        if (`_hexagon-number-1` != null) {
            return `_hexagon-number-1`!!
        }
        `_hexagon-number-1` = Builder(name = "Hexagon-number-1", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-1`: ImageVector? = null

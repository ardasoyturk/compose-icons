...
public val OutlineGroup.`Brand-amigo`: ImageVector
    get() {
        if (`_brand-amigo` != null) {
            return `_brand-amigo`!!
        }
        `_brand-amigo` = Builder(name = "Brand-amigo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-amigo`: ImageVector? = null

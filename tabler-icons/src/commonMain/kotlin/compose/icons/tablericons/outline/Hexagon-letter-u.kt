...
public val OutlineGroup.`Hexagon-letter-u`: ImageVector
    get() {
        if (`_hexagon-letter-u` != null) {
            return `_hexagon-letter-u`!!
        }
        `_hexagon-letter-u` = Builder(name = "Hexagon-letter-u", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-u`: ImageVector? = null

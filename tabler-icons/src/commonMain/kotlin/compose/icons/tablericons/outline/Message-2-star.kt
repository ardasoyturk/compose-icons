...
public val OutlineGroup.`Message-2-star`: ImageVector
    get() {
        if (`_message-2-star` != null) {
            return `_message-2-star`!!
        }
        `_message-2-star` = Builder(name = "Message-2-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-2-star`: ImageVector? = null

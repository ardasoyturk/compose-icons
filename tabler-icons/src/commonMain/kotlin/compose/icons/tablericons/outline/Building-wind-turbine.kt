...
public val OutlineGroup.`Building-wind-turbine`: ImageVector
    get() {
        if (`_building-wind-turbine` != null) {
            return `_building-wind-turbine`!!
        }
        `_building-wind-turbine` = Builder(name = "Building-wind-turbine", defaultWidth = 24.0.dp,
...
private var `_building-wind-turbine`: ImageVector? = null

...
public val OutlineGroup.`Settings-off`: ImageVector
    get() {
        if (`_settings-off` != null) {
            return `_settings-off`!!
        }
        `_settings-off` = Builder(name = "Settings-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-off`: ImageVector? = null

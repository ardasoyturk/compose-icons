...
public val OutlineGroup.`Brand-4chan`: ImageVector
    get() {
        if (`_brand-4chan` != null) {
            return `_brand-4chan`!!
        }
        `_brand-4chan` = Builder(name = "Brand-4chan", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-4chan`: ImageVector? = null

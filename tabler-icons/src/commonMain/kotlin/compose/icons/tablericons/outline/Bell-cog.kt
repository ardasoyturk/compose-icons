...
public val OutlineGroup.`Bell-cog`: ImageVector
    get() {
        if (`_bell-cog` != null) {
            return `_bell-cog`!!
        }
        `_bell-cog` = Builder(name = "Bell-cog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bell-cog`: ImageVector? = null

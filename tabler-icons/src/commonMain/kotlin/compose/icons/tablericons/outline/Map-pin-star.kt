...
public val OutlineGroup.`Map-pin-star`: ImageVector
    get() {
        if (`_map-pin-star` != null) {
            return `_map-pin-star`!!
        }
        `_map-pin-star` = Builder(name = "Map-pin-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_map-pin-star`: ImageVector? = null

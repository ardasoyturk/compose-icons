...
public val OutlineGroup.`Cloud-code`: ImageVector
    get() {
        if (`_cloud-code` != null) {
            return `_cloud-code`!!
        }
        `_cloud-code` = Builder(name = "Cloud-code", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-code`: ImageVector? = null

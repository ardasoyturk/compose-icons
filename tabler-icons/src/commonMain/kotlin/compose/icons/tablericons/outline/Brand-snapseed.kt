...
public val OutlineGroup.`Brand-snapseed`: ImageVector
    get() {
        if (`_brand-snapseed` != null) {
            return `_brand-snapseed`!!
        }
        `_brand-snapseed` = Builder(name = "Brand-snapseed", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-snapseed`: ImageVector? = null

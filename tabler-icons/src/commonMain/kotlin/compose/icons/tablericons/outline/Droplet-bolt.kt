...
public val OutlineGroup.`Droplet-bolt`: ImageVector
    get() {
        if (`_droplet-bolt` != null) {
            return `_droplet-bolt`!!
        }
        `_droplet-bolt` = Builder(name = "Droplet-bolt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-bolt`: ImageVector? = null

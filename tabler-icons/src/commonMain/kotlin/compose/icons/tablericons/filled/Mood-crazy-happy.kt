...
public val FilledGroup.`Mood-crazy-happy`: ImageVector
    get() {
        if (`_mood-crazy-happy` != null) {
            return `_mood-crazy-happy`!!
        }
        `_mood-crazy-happy` = Builder(name = "Mood-crazy-happy", defaultWidth = 24.0.dp,
...
private var `_mood-crazy-happy`: ImageVector? = null

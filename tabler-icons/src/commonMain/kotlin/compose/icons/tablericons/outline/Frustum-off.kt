...
public val OutlineGroup.`Frustum-off`: ImageVector
    get() {
        if (`_frustum-off` != null) {
            return `_frustum-off`!!
        }
        `_frustum-off` = Builder(name = "Frustum-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_frustum-off`: ImageVector? = null

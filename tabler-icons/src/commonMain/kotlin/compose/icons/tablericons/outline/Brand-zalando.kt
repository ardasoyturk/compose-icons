...
public val OutlineGroup.`Brand-zalando`: ImageVector
    get() {
        if (`_brand-zalando` != null) {
            return `_brand-zalando`!!
        }
        `_brand-zalando` = Builder(name = "Brand-zalando", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-zalando`: ImageVector? = null

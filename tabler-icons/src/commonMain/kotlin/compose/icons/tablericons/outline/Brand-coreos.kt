...
public val OutlineGroup.`Brand-coreos`: ImageVector
    get() {
        if (`_brand-coreos` != null) {
            return `_brand-coreos`!!
        }
        `_brand-coreos` = Builder(name = "Brand-coreos", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-coreos`: ImageVector? = null

...
public val OutlineGroup.`Brand-torchain`: ImageVector
    get() {
        if (`_brand-torchain` != null) {
            return `_brand-torchain`!!
        }
        `_brand-torchain` = Builder(name = "Brand-torchain", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-torchain`: ImageVector? = null

...
public val OutlineGroup.`Brand-mongodb`: ImageVector
    get() {
        if (`_brand-mongodb` != null) {
            return `_brand-mongodb`!!
        }
        `_brand-mongodb` = Builder(name = "Brand-mongodb", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-mongodb`: ImageVector? = null

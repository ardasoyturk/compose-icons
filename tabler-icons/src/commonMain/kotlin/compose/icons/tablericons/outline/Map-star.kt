...
public val OutlineGroup.`Map-star`: ImageVector
    get() {
        if (`_map-star` != null) {
            return `_map-star`!!
        }
        `_map-star` = Builder(name = "Map-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_map-star`: ImageVector? = null

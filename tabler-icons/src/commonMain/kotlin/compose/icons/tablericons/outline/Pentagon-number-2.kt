...
public val OutlineGroup.`Pentagon-number-2`: ImageVector
    get() {
        if (`_pentagon-number-2` != null) {
            return `_pentagon-number-2`!!
        }
        `_pentagon-number-2` = Builder(name = "Pentagon-number-2", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-2`: ImageVector? = null

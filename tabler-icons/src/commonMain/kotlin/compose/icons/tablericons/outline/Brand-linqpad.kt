...
public val OutlineGroup.`Brand-linqpad`: ImageVector
    get() {
        if (`_brand-linqpad` != null) {
            return `_brand-linqpad`!!
        }
        `_brand-linqpad` = Builder(name = "Brand-linqpad", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-linqpad`: ImageVector? = null

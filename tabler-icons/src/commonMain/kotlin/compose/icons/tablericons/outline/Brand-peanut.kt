...
public val OutlineGroup.`Brand-peanut`: ImageVector
    get() {
        if (`_brand-peanut` != null) {
            return `_brand-peanut`!!
        }
        `_brand-peanut` = Builder(name = "Brand-peanut", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-peanut`: ImageVector? = null

...
public val OutlineGroup.`Rosette-discount`: ImageVector
    get() {
        if (`_rosette-discount` != null) {
            return `_rosette-discount`!!
        }
        `_rosette-discount` = Builder(name = "Rosette-discount", defaultWidth = 24.0.dp,
...
private var `_rosette-discount`: ImageVector? = null

...
public val OutlineGroup.`Device-ipad-heart`: ImageVector
    get() {
        if (`_device-ipad-heart` != null) {
            return `_device-ipad-heart`!!
        }
        `_device-ipad-heart` = Builder(name = "Device-ipad-heart", defaultWidth = 24.0.dp,
...
private var `_device-ipad-heart`: ImageVector? = null

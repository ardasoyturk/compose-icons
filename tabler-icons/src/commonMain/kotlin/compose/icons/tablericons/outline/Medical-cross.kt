...
public val OutlineGroup.`Medical-cross`: ImageVector
    get() {
        if (`_medical-cross` != null) {
            return `_medical-cross`!!
        }
        `_medical-cross` = Builder(name = "Medical-cross", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_medical-cross`: ImageVector? = null

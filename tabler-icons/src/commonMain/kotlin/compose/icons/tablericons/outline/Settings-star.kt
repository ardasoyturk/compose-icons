...
public val OutlineGroup.`Settings-star`: ImageVector
    get() {
        if (`_settings-star` != null) {
            return `_settings-star`!!
        }
        `_settings-star` = Builder(name = "Settings-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-star`: ImageVector? = null

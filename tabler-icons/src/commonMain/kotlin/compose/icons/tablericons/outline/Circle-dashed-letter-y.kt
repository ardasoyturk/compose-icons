...
public val OutlineGroup.`Circle-dashed-letter-y`: ImageVector
    get() {
        if (`_circle-dashed-letter-y` != null) {
            return `_circle-dashed-letter-y`!!
        }
        `_circle-dashed-letter-y` = Builder(name = "Circle-dashed-letter-y", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-y`: ImageVector? = null

...
public val OutlineGroup.`History-off`: ImageVector
    get() {
        if (`_history-off` != null) {
            return `_history-off`!!
        }
        `_history-off` = Builder(name = "History-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_history-off`: ImageVector? = null

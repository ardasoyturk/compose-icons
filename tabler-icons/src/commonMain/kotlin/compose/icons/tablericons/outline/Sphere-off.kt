...
public val OutlineGroup.`Sphere-off`: ImageVector
    get() {
        if (`_sphere-off` != null) {
            return `_sphere-off`!!
        }
        `_sphere-off` = Builder(name = "Sphere-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sphere-off`: ImageVector? = null

...
public val OutlineGroup.`Tag-plus`: ImageVector
    get() {
        if (`_tag-plus` != null) {
            return `_tag-plus`!!
        }
        `_tag-plus` = Builder(name = "Tag-plus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tag-plus`: ImageVector? = null

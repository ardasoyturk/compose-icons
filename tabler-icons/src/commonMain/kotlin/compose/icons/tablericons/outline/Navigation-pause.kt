...
public val OutlineGroup.`Navigation-pause`: ImageVector
    get() {
        if (`_navigation-pause` != null) {
            return `_navigation-pause`!!
        }
        `_navigation-pause` = Builder(name = "Navigation-pause", defaultWidth = 24.0.dp,
...
private var `_navigation-pause`: ImageVector? = null

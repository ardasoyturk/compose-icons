...
public val OutlineGroup.`Settings-search`: ImageVector
    get() {
        if (`_settings-search` != null) {
            return `_settings-search`!!
        }
        `_settings-search` = Builder(name = "Settings-search", defaultWidth = 24.0.dp, defaultHeight
...
private var `_settings-search`: ImageVector? = null

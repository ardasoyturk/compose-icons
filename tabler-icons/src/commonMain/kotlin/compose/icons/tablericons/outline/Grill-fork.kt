...
public val OutlineGroup.`Grill-fork`: ImageVector
    get() {
        if (`_grill-fork` != null) {
            return `_grill-fork`!!
        }
        `_grill-fork` = Builder(name = "Grill-fork", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_grill-fork`: ImageVector? = null

...
public val OutlineGroup.`Language-hiragana`: ImageVector
    get() {
        if (`_language-hiragana` != null) {
            return `_language-hiragana`!!
        }
        `_language-hiragana` = Builder(name = "Language-hiragana", defaultWidth = 24.0.dp,
...
private var `_language-hiragana`: ImageVector? = null

...
public val OutlineGroup.`Shield-bolt`: ImageVector
    get() {
        if (`_shield-bolt` != null) {
            return `_shield-bolt`!!
        }
        `_shield-bolt` = Builder(name = "Shield-bolt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shield-bolt`: ImageVector? = null

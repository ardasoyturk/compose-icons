...
public val OutlineGroup.`Brand-notion`: ImageVector
    get() {
        if (`_brand-notion` != null) {
            return `_brand-notion`!!
        }
        `_brand-notion` = Builder(name = "Brand-notion", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-notion`: ImageVector? = null

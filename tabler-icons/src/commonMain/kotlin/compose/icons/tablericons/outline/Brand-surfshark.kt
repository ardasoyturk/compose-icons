...
public val OutlineGroup.`Brand-surfshark`: ImageVector
    get() {
        if (`_brand-surfshark` != null) {
            return `_brand-surfshark`!!
        }
        `_brand-surfshark` = Builder(name = "Brand-surfshark", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-surfshark`: ImageVector? = null

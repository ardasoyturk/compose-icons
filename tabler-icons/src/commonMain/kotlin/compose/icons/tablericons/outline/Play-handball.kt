...
public val OutlineGroup.`Play-handball`: ImageVector
    get() {
        if (`_play-handball` != null) {
            return `_play-handball`!!
        }
        `_play-handball` = Builder(name = "Play-handball", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_play-handball`: ImageVector? = null

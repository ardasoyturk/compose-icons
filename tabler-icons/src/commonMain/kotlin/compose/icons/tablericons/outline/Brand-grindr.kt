...
public val OutlineGroup.`Brand-grindr`: ImageVector
    get() {
        if (`_brand-grindr` != null) {
            return `_brand-grindr`!!
        }
        `_brand-grindr` = Builder(name = "Brand-grindr", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-grindr`: ImageVector? = null

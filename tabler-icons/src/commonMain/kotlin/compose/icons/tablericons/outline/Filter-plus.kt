...
public val OutlineGroup.`Filter-plus`: ImageVector
    get() {
        if (`_filter-plus` != null) {
            return `_filter-plus`!!
        }
        `_filter-plus` = Builder(name = "Filter-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-plus`: ImageVector? = null

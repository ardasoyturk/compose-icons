...
public val OutlineGroup.`Virus-search`: ImageVector
    get() {
        if (`_virus-search` != null) {
            return `_virus-search`!!
        }
        `_virus-search` = Builder(name = "Virus-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_virus-search`: ImageVector? = null

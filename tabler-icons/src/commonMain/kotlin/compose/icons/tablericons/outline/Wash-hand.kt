...
public val OutlineGroup.`Wash-hand`: ImageVector
    get() {
        if (`_wash-hand` != null) {
            return `_wash-hand`!!
        }
        `_wash-hand` = Builder(name = "Wash-hand", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wash-hand`: ImageVector? = null

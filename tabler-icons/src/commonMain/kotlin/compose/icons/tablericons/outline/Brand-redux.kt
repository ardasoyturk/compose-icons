...
public val OutlineGroup.`Brand-redux`: ImageVector
    get() {
        if (`_brand-redux` != null) {
            return `_brand-redux`!!
        }
        `_brand-redux` = Builder(name = "Brand-redux", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-redux`: ImageVector? = null

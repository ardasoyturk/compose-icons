...
public val OutlineGroup.`Flower-off`: ImageVector
    get() {
        if (`_flower-off` != null) {
            return `_flower-off`!!
        }
        `_flower-off` = Builder(name = "Flower-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flower-off`: ImageVector? = null

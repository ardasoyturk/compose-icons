...
public val LucideIcons.FileMinusCorner: ImageVector
    get() {
        if (_fileMinusCorner != null) {
            return _fileMinusCorner!!
        }
        _fileMinusCorner = Builder(name = "FileMinusCorner", defaultWidth = 24.0.dp, defaultHeight =

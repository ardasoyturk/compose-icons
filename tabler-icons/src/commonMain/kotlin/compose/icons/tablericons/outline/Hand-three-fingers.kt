...
public val OutlineGroup.`Hand-three-fingers`: ImageVector
    get() {
        if (`_hand-three-fingers` != null) {
            return `_hand-three-fingers`!!
        }
        `_hand-three-fingers` = Builder(name = "Hand-three-fingers", defaultWidth = 24.0.dp,
...
private var `_hand-three-fingers`: ImageVector? = null

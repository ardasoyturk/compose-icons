...
public val OutlineGroup.`Ironing-off`: ImageVector
    get() {
        if (`_ironing-off` != null) {
            return `_ironing-off`!!
        }
        `_ironing-off` = Builder(name = "Ironing-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ironing-off`: ImageVector? = null

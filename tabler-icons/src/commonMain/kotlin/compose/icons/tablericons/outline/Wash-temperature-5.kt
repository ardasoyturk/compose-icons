...
public val OutlineGroup.`Wash-temperature-5`: ImageVector
    get() {
        if (`_wash-temperature-5` != null) {
            return `_wash-temperature-5`!!
        }
        `_wash-temperature-5` = Builder(name = "Wash-temperature-5", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-5`: ImageVector? = null

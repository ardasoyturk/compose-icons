...
public val FilledGroup.`Receipt-rupee`: ImageVector
    get() {
        if (`_receipt-rupee` != null) {
            return `_receipt-rupee`!!
        }
        `_receipt-rupee` = Builder(name = "Receipt-rupee", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(4.01f, 4.01f, 0.0f, false, false, 2.538f, -2.77f)
                lineToRelative(1.126f, -0.001f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.0f, -2.0f)
                horizontalLineToRelative(-1.126f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -0.33f, -0.855f)
...
private var `_receipt-rupee`: ImageVector? = null

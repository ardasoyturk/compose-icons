...
public val OutlineGroup.`Hand-little-finger`: ImageVector
    get() {
        if (`_hand-little-finger` != null) {
            return `_hand-little-finger`!!
        }
        `_hand-little-finger` = Builder(name = "Hand-little-finger", defaultWidth = 24.0.dp,
...
private var `_hand-little-finger`: ImageVector? = null

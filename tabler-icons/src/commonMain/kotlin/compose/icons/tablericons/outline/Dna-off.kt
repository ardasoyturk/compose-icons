...
public val OutlineGroup.`Dna-off`: ImageVector
    get() {
        if (`_dna-off` != null) {
            return `_dna-off`!!
        }
        `_dna-off` = Builder(name = "Dna-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_dna-off`: ImageVector? = null

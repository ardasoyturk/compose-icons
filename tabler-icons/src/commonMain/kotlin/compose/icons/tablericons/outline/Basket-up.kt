...
public val OutlineGroup.`Basket-up`: ImageVector
    get() {
        if (`_basket-up` != null) {
            return `_basket-up`!!
        }
        `_basket-up` = Builder(name = "Basket-up", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_basket-up`: ImageVector? = null

...
public val OutlineGroup.`Alphabet-hebrew`: ImageVector
    get() {
        if (`_alphabet-hebrew` != null) {
            return `_alphabet-hebrew`!!
        }
        `_alphabet-hebrew` = Builder(name = "Alphabet-hebrew", defaultWidth = 24.0.dp, defaultHeight
...
private var `_alphabet-hebrew`: ImageVector? = null

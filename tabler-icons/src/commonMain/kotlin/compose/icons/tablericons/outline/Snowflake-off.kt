...
public val OutlineGroup.`Snowflake-off`: ImageVector
    get() {
        if (`_snowflake-off` != null) {
            return `_snowflake-off`!!
        }
        `_snowflake-off` = Builder(name = "Snowflake-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_snowflake-off`: ImageVector? = null

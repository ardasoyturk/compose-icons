...
public val OutlineGroup.`Wash-temperature-1`: ImageVector
    get() {
        if (`_wash-temperature-1` != null) {
            return `_wash-temperature-1`!!
        }
        `_wash-temperature-1` = Builder(name = "Wash-temperature-1", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-1`: ImageVector? = null

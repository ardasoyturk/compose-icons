...
public val OutlineGroup.`Device-desktop-heart`: ImageVector
    get() {
        if (`_device-desktop-heart` != null) {
            return `_device-desktop-heart`!!
        }
        `_device-desktop-heart` = Builder(name = "Device-desktop-heart", defaultWidth = 24.0.dp,
...
private var `_device-desktop-heart`: ImageVector? = null

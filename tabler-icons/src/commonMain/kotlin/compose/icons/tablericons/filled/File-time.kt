...
public val FilledGroup.`File-time`: ImageVector
    get() {
        if (`_file-time` != null) {
            return `_file-time`!!
        }
        `_file-time` = Builder(name = "File-time", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_file-time`: ImageVector? = null

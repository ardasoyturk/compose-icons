...
public val OutlineGroup.`Droplet-exclamation`: ImageVector
    get() {
        if (`_droplet-exclamation` != null) {
            return `_droplet-exclamation`!!
        }
        `_droplet-exclamation` = Builder(name = "Droplet-exclamation", defaultWidth = 24.0.dp,
...
private var `_droplet-exclamation`: ImageVector? = null

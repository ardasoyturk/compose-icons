...
public val OutlineGroup.`Wash-temperature-2`: ImageVector
    get() {
        if (`_wash-temperature-2` != null) {
            return `_wash-temperature-2`!!
        }
        `_wash-temperature-2` = Builder(name = "Wash-temperature-2", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-2`: ImageVector? = null

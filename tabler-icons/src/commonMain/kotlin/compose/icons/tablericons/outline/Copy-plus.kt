...
public val OutlineGroup.`Copy-plus`: ImageVector
    get() {
        if (`_copy-plus` != null) {
            return `_copy-plus`!!
        }
        `_copy-plus` = Builder(name = "Copy-plus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_copy-plus`: ImageVector? = null

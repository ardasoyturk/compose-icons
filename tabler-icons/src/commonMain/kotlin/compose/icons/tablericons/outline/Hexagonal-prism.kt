...
public val OutlineGroup.`Hexagonal-prism`: ImageVector
    get() {
        if (`_hexagonal-prism` != null) {
            return `_hexagonal-prism`!!
        }
        `_hexagonal-prism` = Builder(name = "Hexagonal-prism", defaultWidth = 24.0.dp, defaultHeight
...
private var `_hexagonal-prism`: ImageVector? = null

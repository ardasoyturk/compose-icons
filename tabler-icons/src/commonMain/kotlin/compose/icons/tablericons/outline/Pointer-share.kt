...
public val OutlineGroup.`Pointer-share`: ImageVector
    get() {
        if (`_pointer-share` != null) {
            return `_pointer-share`!!
        }
        `_pointer-share` = Builder(name = "Pointer-share", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-share`: ImageVector? = null

...
public val OutlineGroup.`Brand-couchsurfing`: ImageVector
    get() {
        if (`_brand-couchsurfing` != null) {
            return `_brand-couchsurfing`!!
        }
        `_brand-couchsurfing` = Builder(name = "Brand-couchsurfing", defaultWidth = 24.0.dp,
...
private var `_brand-couchsurfing`: ImageVector? = null

...
public val OutlineGroup.`Brand-oauth`: ImageVector
    get() {
        if (`_brand-oauth` != null) {
            return `_brand-oauth`!!
        }
        `_brand-oauth` = Builder(name = "Brand-oauth", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-oauth`: ImageVector? = null

...
public val OutlineGroup.`Mushroom-off`: ImageVector
    get() {
        if (`_mushroom-off` != null) {
            return `_mushroom-off`!!
        }
        `_mushroom-off` = Builder(name = "Mushroom-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_mushroom-off`: ImageVector? = null

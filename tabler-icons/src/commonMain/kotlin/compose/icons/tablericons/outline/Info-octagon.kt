...
public val OutlineGroup.`Info-octagon`: ImageVector
    get() {
        if (`_info-octagon` != null) {
            return `_info-octagon`!!
        }
        `_info-octagon` = Builder(name = "Info-octagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_info-octagon`: ImageVector? = null

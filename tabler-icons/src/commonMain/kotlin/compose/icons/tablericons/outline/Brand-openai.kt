...
public val OutlineGroup.`Brand-openai`: ImageVector
    get() {
        if (`_brand-openai` != null) {
            return `_brand-openai`!!
        }
        `_brand-openai` = Builder(name = "Brand-openai", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-openai`: ImageVector? = null

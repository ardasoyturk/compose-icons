...
public val OutlineGroup.`Fingerprint-off`: ImageVector
    get() {
        if (`_fingerprint-off` != null) {
            return `_fingerprint-off`!!
        }
        `_fingerprint-off` = Builder(name = "Fingerprint-off", defaultWidth = 24.0.dp, defaultHeight
...
private var `_fingerprint-off`: ImageVector? = null

...
public val OutlineGroup.`Ball-american-football-off`: ImageVector
    get() {
        if (`_ball-american-football-off` != null) {
            return `_ball-american-football-off`!!
        }
        `_ball-american-football-off` = Builder(name = "Ball-american-football-off", defaultWidth =
...
private var `_ball-american-football-off`: ImageVector? = null

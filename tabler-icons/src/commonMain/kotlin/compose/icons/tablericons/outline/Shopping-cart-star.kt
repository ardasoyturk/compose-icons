...
public val OutlineGroup.`Shopping-cart-star`: ImageVector
    get() {
        if (`_shopping-cart-star` != null) {
            return `_shopping-cart-star`!!
        }
        `_shopping-cart-star` = Builder(name = "Shopping-cart-star", defaultWidth = 24.0.dp,
...
private var `_shopping-cart-star`: ImageVector? = null

...
public val OutlineGroup.`Panorama-horizontal-off`: ImageVector
    get() {
        if (`_panorama-horizontal-off` != null) {
            return `_panorama-horizontal-off`!!
        }
        `_panorama-horizontal-off` = Builder(name = "Panorama-horizontal-off", defaultWidth =
...
private var `_panorama-horizontal-off`: ImageVector? = null

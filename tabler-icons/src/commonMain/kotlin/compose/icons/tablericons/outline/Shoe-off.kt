...
public val OutlineGroup.`Shoe-off`: ImageVector
    get() {
        if (`_shoe-off` != null) {
            return `_shoe-off`!!
        }
        `_shoe-off` = Builder(name = "Shoe-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_shoe-off`: ImageVector? = null

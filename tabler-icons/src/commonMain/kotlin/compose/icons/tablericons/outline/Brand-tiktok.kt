...
public val OutlineGroup.`Brand-tiktok`: ImageVector
    get() {
        if (`_brand-tiktok` != null) {
            return `_brand-tiktok`!!
        }
        `_brand-tiktok` = Builder(name = "Brand-tiktok", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-tiktok`: ImageVector? = null

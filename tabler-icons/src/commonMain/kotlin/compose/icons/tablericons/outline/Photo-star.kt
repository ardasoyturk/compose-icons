...
public val OutlineGroup.`Photo-star`: ImageVector
    get() {
        if (`_photo-star` != null) {
            return `_photo-star`!!
        }
        `_photo-star` = Builder(name = "Photo-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-star`: ImageVector? = null

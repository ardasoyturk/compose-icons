...
public val OutlineGroup.`Music-pin`: ImageVector
    get() {
        if (`_music-pin` != null) {
            return `_music-pin`!!
        }
        `_music-pin` = Builder(name = "Music-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_music-pin`: ImageVector? = null

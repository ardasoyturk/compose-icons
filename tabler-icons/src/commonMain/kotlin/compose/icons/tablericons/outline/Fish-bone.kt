...
public val OutlineGroup.`Fish-bone`: ImageVector
    get() {
        if (`_fish-bone` != null) {
            return `_fish-bone`!!
        }
        `_fish-bone` = Builder(name = "Fish-bone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_fish-bone`: ImageVector? = null

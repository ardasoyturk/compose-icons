...
public val OutlineGroup.`Award-off`: ImageVector
    get() {
        if (`_award-off` != null) {
            return `_award-off`!!
        }
        `_award-off` = Builder(name = "Award-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_award-off`: ImageVector? = null

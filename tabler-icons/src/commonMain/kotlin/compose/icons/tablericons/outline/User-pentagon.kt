...
public val OutlineGroup.`User-pentagon`: ImageVector
    get() {
        if (`_user-pentagon` != null) {
            return `_user-pentagon`!!
        }
        `_user-pentagon` = Builder(name = "User-pentagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_user-pentagon`: ImageVector? = null

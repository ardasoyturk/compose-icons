...
public val OutlineGroup.`Flag-cog`: ImageVector
    get() {
        if (`_flag-cog` != null) {
            return `_flag-cog`!!
        }
        `_flag-cog` = Builder(name = "Flag-cog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_flag-cog`: ImageVector? = null

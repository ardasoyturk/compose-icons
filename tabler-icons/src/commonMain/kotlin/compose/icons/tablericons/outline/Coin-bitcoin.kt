...
public val OutlineGroup.`Coin-bitcoin`: ImageVector
    get() {
        if (`_coin-bitcoin` != null) {
            return `_coin-bitcoin`!!
        }
        `_coin-bitcoin` = Builder(name = "Coin-bitcoin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_coin-bitcoin`: ImageVector? = null

...
public val OutlineGroup.`Repeat-off`: ImageVector
    get() {
        if (`_repeat-off` != null) {
            return `_repeat-off`!!
        }
        `_repeat-off` = Builder(name = "Repeat-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_repeat-off`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-x`: ImageVector
    get() {
        if (`_hexagon-letter-x` != null) {
            return `_hexagon-letter-x`!!
        }
        `_hexagon-letter-x` = Builder(name = "Hexagon-letter-x", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-x`: ImageVector? = null

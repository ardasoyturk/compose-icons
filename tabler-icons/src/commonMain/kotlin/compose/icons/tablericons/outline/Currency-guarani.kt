...
public val OutlineGroup.`Currency-guarani`: ImageVector
    get() {
        if (`_currency-guarani` != null) {
            return `_currency-guarani`!!
        }
        `_currency-guarani` = Builder(name = "Currency-guarani", defaultWidth = 24.0.dp,
...
private var `_currency-guarani`: ImageVector? = null

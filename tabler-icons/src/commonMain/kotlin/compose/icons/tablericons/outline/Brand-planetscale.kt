...
public val OutlineGroup.`Brand-planetscale`: ImageVector
    get() {
        if (`_brand-planetscale` != null) {
            return `_brand-planetscale`!!
        }
        `_brand-planetscale` = Builder(name = "Brand-planetscale", defaultWidth = 24.0.dp,
...
private var `_brand-planetscale`: ImageVector? = null

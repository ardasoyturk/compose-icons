...
public val OutlineGroup.`Ship-off`: ImageVector
    get() {
        if (`_ship-off` != null) {
            return `_ship-off`!!
        }
        `_ship-off` = Builder(name = "Ship-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ship-off`: ImageVector? = null

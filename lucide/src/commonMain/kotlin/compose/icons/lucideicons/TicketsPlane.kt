...
public val LucideIcons.TicketsPlane: ImageVector
    get() {
        if (_ticketsPlane != null) {
            return _ticketsPlane!!
        }
        _ticketsPlane = Builder(name = "TicketsPlane", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, 1.345f, -0.52f)
                lineTo(18.0f, 12.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.647f, 0.993f)
                lineTo(18.56f, 8.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =

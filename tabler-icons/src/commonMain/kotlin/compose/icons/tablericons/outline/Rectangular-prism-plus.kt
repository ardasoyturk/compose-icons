...
public val OutlineGroup.`Rectangular-prism-plus`: ImageVector
    get() {
        if (`_rectangular-prism-plus` != null) {
            return `_rectangular-prism-plus`!!
        }
        `_rectangular-prism-plus` = Builder(name = "Rectangular-prism-plus", defaultWidth = 24.0.dp,
...
private var `_rectangular-prism-plus`: ImageVector? = null

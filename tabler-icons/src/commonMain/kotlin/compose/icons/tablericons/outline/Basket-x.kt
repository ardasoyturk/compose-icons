...
public val OutlineGroup.`Basket-x`: ImageVector
    get() {
        if (`_basket-x` != null) {
            return `_basket-x`!!
        }
        `_basket-x` = Builder(name = "Basket-x", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_basket-x`: ImageVector? = null

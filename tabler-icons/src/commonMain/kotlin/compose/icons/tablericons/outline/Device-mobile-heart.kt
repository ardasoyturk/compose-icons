...
public val OutlineGroup.`Device-mobile-heart`: ImageVector
    get() {
        if (`_device-mobile-heart` != null) {
            return `_device-mobile-heart`!!
        }
        `_device-mobile-heart` = Builder(name = "Device-mobile-heart", defaultWidth = 24.0.dp,
...
private var `_device-mobile-heart`: ImageVector? = null

...
public val OutlineGroup.`Building-factory`: ImageVector
    get() {
        if (`_building-factory` != null) {
            return `_building-factory`!!
        }
        `_building-factory` = Builder(name = "Building-factory", defaultWidth = 24.0.dp,
...
private var `_building-factory`: ImageVector? = null

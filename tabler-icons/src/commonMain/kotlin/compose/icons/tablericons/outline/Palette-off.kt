...
public val OutlineGroup.`Palette-off`: ImageVector
    get() {
        if (`_palette-off` != null) {
            return `_palette-off`!!
        }
        `_palette-off` = Builder(name = "Palette-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_palette-off`: ImageVector? = null

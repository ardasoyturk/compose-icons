...
public val SolidGroup.ArrowRightToCity: ImageVector
    get() {
        if (_arrowRightToCity != null) {
            return _arrowRightToCity!!
        }
        _arrowRightToCity = Builder(name = "ArrowRightToCity", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-8.8f, 0.0f, -16.0f, 7.2f, -16.0f, 16.0f)
                close()
                moveTo(166.6f, 153.4f)
                lineToRelative(80.0f, 80.0f)
                curveToRelative(12.5f, 12.5f, 12.5f, 32.8f, 0.0f, 45.3f)
                lineToRelative(-80.0f, 80.0f)
                curveToRelative(-12.5f, 12.5f, -32.8f, 12.5f, -45.3f, 0.0f)
                reflectiveCurveToRelative(-12.5f, -32.8f, 0.0f, -45.3f)
                lineTo(146.7f, 288.0f)
                lineTo(32.0f, 288.0f)

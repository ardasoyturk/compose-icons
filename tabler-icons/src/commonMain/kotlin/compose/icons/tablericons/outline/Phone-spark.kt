...
public val OutlineGroup.`Phone-spark`: ImageVector
    get() {
        if (`_phone-spark` != null) {
            return `_phone-spark`!!
        }
        `_phone-spark` = Builder(name = "Phone-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-spark`: ImageVector? = null

...
public val OutlineGroup.`Zeppelin-off`: ImageVector
    get() {
        if (`_zeppelin-off` != null) {
            return `_zeppelin-off`!!
        }
        `_zeppelin-off` = Builder(name = "Zeppelin-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_zeppelin-off`: ImageVector? = null

...
public val OutlineGroup.`Filter-x`: ImageVector
    get() {
        if (`_filter-x` != null) {
            return `_filter-x`!!
        }
        `_filter-x` = Builder(name = "Filter-x", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_filter-x`: ImageVector? = null

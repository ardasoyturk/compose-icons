...
public val OutlineGroup.`Brand-meetup`: ImageVector
    get() {
        if (`_brand-meetup` != null) {
            return `_brand-meetup`!!
        }
        `_brand-meetup` = Builder(name = "Brand-meetup", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-meetup`: ImageVector? = null

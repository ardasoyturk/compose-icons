...
public val OutlineGroup.`Rectangular-prism`: ImageVector
    get() {
        if (`_rectangular-prism` != null) {
            return `_rectangular-prism`!!
        }
        `_rectangular-prism` = Builder(name = "Rectangular-prism", defaultWidth = 24.0.dp,
...
private var `_rectangular-prism`: ImageVector? = null

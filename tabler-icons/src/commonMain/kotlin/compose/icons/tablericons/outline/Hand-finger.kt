...
public val OutlineGroup.`Hand-finger`: ImageVector
    get() {
        if (`_hand-finger` != null) {
            return `_hand-finger`!!
        }
        `_hand-finger` = Builder(name = "Hand-finger", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hand-finger`: ImageVector? = null

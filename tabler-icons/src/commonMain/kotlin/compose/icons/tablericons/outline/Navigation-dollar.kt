...
public val OutlineGroup.`Navigation-dollar`: ImageVector
    get() {
        if (`_navigation-dollar` != null) {
            return `_navigation-dollar`!!
        }
        `_navigation-dollar` = Builder(name = "Navigation-dollar", defaultWidth = 24.0.dp,
...
private var `_navigation-dollar`: ImageVector? = null

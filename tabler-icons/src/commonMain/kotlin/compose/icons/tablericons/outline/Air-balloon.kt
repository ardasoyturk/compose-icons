...
public val OutlineGroup.`Air-balloon`: ImageVector
    get() {
        if (`_air-balloon` != null) {
            return `_air-balloon`!!
        }
        `_air-balloon` = Builder(name = "Air-balloon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_air-balloon`: ImageVector? = null

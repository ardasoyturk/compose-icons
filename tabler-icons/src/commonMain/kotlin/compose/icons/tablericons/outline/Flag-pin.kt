...
public val OutlineGroup.`Flag-pin`: ImageVector
    get() {
        if (`_flag-pin` != null) {
            return `_flag-pin`!!
        }
        `_flag-pin` = Builder(name = "Flag-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_flag-pin`: ImageVector? = null

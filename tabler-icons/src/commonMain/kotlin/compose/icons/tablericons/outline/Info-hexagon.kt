...
public val OutlineGroup.`Info-hexagon`: ImageVector
    get() {
        if (`_info-hexagon` != null) {
            return `_info-hexagon`!!
        }
        `_info-hexagon` = Builder(name = "Info-hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_info-hexagon`: ImageVector? = null

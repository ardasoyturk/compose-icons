...
public val OutlineGroup.`Shield-pause`: ImageVector
    get() {
        if (`_shield-pause` != null) {
            return `_shield-pause`!!
        }
        `_shield-pause` = Builder(name = "Shield-pause", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shield-pause`: ImageVector? = null

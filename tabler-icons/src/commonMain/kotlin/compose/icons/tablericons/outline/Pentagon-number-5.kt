...
public val OutlineGroup.`Pentagon-number-5`: ImageVector
    get() {
        if (`_pentagon-number-5` != null) {
            return `_pentagon-number-5`!!
        }
        `_pentagon-number-5` = Builder(name = "Pentagon-number-5", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-5`: ImageVector? = null

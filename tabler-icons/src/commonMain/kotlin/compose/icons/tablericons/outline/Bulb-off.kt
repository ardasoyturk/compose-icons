...
public val OutlineGroup.`Bulb-off`: ImageVector
    get() {
        if (`_bulb-off` != null) {
            return `_bulb-off`!!
        }
        `_bulb-off` = Builder(name = "Bulb-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bulb-off`: ImageVector? = null

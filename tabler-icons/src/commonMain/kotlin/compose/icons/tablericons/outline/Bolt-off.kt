...
public val OutlineGroup.`Bolt-off`: ImageVector
    get() {
        if (`_bolt-off` != null) {
            return `_bolt-off`!!
        }
        `_bolt-off` = Builder(name = "Bolt-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bolt-off`: ImageVector? = null

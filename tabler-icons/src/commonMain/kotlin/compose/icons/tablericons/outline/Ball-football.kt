...
public val OutlineGroup.`Ball-football`: ImageVector
    get() {
        if (`_ball-football` != null) {
            return `_ball-football`!!
        }
        `_ball-football` = Builder(name = "Ball-football", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ball-football`: ImageVector? = null

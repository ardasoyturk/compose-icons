...
public val OutlineGroup.`Alarm-smoke`: ImageVector
    get() {
        if (`_alarm-smoke` != null) {
            return `_alarm-smoke`!!
        }
        `_alarm-smoke` = Builder(name = "Alarm-smoke", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_alarm-smoke`: ImageVector? = null

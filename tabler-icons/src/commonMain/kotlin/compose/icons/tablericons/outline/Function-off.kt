...
public val OutlineGroup.`Function-off`: ImageVector
    get() {
        if (`_function-off` != null) {
            return `_function-off`!!
        }
        `_function-off` = Builder(name = "Function-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_function-off`: ImageVector? = null

...
public val OutlineGroup.`Bath-off`: ImageVector
    get() {
        if (`_bath-off` != null) {
            return `_bath-off`!!
        }
        `_bath-off` = Builder(name = "Bath-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bath-off`: ImageVector? = null

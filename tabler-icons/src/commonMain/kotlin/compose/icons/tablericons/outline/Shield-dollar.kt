...
public val OutlineGroup.`Shield-dollar`: ImageVector
    get() {
        if (`_shield-dollar` != null) {
            return `_shield-dollar`!!
        }
        `_shield-dollar` = Builder(name = "Shield-dollar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shield-dollar`: ImageVector? = null

...
public val OutlineGroup.`Creative-commons-off`: ImageVector
    get() {
        if (`_creative-commons-off` != null) {
            return `_creative-commons-off`!!
        }
        `_creative-commons-off` = Builder(name = "Creative-commons-off", defaultWidth = 24.0.dp,
...
private var `_creative-commons-off`: ImageVector? = null

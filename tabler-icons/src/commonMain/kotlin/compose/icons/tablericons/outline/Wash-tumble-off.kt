...
public val OutlineGroup.`Wash-tumble-off`: ImageVector
    get() {
        if (`_wash-tumble-off` != null) {
            return `_wash-tumble-off`!!
        }
        `_wash-tumble-off` = Builder(name = "Wash-tumble-off", defaultWidth = 24.0.dp, defaultHeight
...
private var `_wash-tumble-off`: ImageVector? = null

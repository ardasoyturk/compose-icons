...
public val OutlineGroup.`Brand-nuxt`: ImageVector
    get() {
        if (`_brand-nuxt` != null) {
            return `_brand-nuxt`!!
        }
        `_brand-nuxt` = Builder(name = "Brand-nuxt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-nuxt`: ImageVector? = null

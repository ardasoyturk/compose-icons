...
public val OutlineGroup.`Tags-off`: ImageVector
    get() {
        if (`_tags-off` != null) {
            return `_tags-off`!!
        }
        `_tags-off` = Builder(name = "Tags-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tags-off`: ImageVector? = null

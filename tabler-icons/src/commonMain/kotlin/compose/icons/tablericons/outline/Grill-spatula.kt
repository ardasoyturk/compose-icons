...
public val OutlineGroup.`Grill-spatula`: ImageVector
    get() {
        if (`_grill-spatula` != null) {
            return `_grill-spatula`!!
        }
        `_grill-spatula` = Builder(name = "Grill-spatula", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_grill-spatula`: ImageVector? = null

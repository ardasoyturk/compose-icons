...
public val OutlineGroup.`Rectangular-prism-off`: ImageVector
    get() {
        if (`_rectangular-prism-off` != null) {
            return `_rectangular-prism-off`!!
        }
        `_rectangular-prism-off` = Builder(name = "Rectangular-prism-off", defaultWidth = 24.0.dp,
...
private var `_rectangular-prism-off`: ImageVector? = null

...
public val OutlineGroup.`Rosette-number-9`: ImageVector
    get() {
        if (`_rosette-number-9` != null) {
            return `_rosette-number-9`!!
        }
        `_rosette-number-9` = Builder(name = "Rosette-number-9", defaultWidth = 24.0.dp,
...
private var `_rosette-number-9`: ImageVector? = null

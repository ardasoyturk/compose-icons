...
public val OutlineGroup.`Brand-vlc`: ImageVector
    get() {
        if (`_brand-vlc` != null) {
            return `_brand-vlc`!!
        }
        `_brand-vlc` = Builder(name = "Brand-vlc", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-vlc`: ImageVector? = null

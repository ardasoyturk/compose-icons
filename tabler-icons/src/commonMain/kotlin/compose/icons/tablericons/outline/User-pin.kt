...
public val OutlineGroup.`User-pin`: ImageVector
    get() {
        if (`_user-pin` != null) {
            return `_user-pin`!!
        }
        `_user-pin` = Builder(name = "User-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_user-pin`: ImageVector? = null

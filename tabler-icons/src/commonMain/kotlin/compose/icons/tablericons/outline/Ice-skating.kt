...
public val OutlineGroup.`Ice-skating`: ImageVector
    get() {
        if (`_ice-skating` != null) {
            return `_ice-skating`!!
        }
        `_ice-skating` = Builder(name = "Ice-skating", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ice-skating`: ImageVector? = null

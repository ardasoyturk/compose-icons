...
public val OutlineGroup.`Shirt-off`: ImageVector
    get() {
        if (`_shirt-off` != null) {
            return `_shirt-off`!!
        }
        `_shirt-off` = Builder(name = "Shirt-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_shirt-off`: ImageVector? = null

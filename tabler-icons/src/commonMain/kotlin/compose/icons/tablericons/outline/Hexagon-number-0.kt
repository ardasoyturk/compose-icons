...
public val OutlineGroup.`Hexagon-number-0`: ImageVector
    get() {
        if (`_hexagon-number-0` != null) {
            return `_hexagon-number-0`!!
        }
        `_hexagon-number-0` = Builder(name = "Hexagon-number-0", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-0`: ImageVector? = null

...
public val OutlineGroup.`Filter-cancel`: ImageVector
    get() {
        if (`_filter-cancel` != null) {
            return `_filter-cancel`!!
        }
        `_filter-cancel` = Builder(name = "Filter-cancel", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-cancel`: ImageVector? = null

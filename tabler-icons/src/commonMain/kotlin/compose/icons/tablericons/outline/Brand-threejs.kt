...
public val OutlineGroup.`Brand-threejs`: ImageVector
    get() {
        if (`_brand-threejs` != null) {
            return `_brand-threejs`!!
        }
        `_brand-threejs` = Builder(name = "Brand-threejs", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-threejs`: ImageVector? = null

...
public val OutlineGroup.`Photo-edit`: ImageVector
    get() {
        if (`_photo-edit` != null) {
            return `_photo-edit`!!
        }
        `_photo-edit` = Builder(name = "Photo-edit", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-edit`: ImageVector? = null

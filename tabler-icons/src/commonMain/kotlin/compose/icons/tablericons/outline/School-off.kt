...
public val OutlineGroup.`School-off`: ImageVector
    get() {
        if (`_school-off` != null) {
            return `_school-off`!!
        }
        `_school-off` = Builder(name = "School-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_school-off`: ImageVector? = null

...
public val OutlineGroup.`Circle-off`: ImageVector
    get() {
        if (`_circle-off` != null) {
            return `_circle-off`!!
        }
        `_circle-off` = Builder(name = "Circle-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_circle-off`: ImageVector? = null

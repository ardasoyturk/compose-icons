...
public val OutlineGroup.`Brand-apple`: ImageVector
    get() {
        if (`_brand-apple` != null) {
            return `_brand-apple`!!
        }
        `_brand-apple` = Builder(name = "Brand-apple", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-apple`: ImageVector? = null

...
public val OutlineGroup.`Sphere-plus`: ImageVector
    get() {
        if (`_sphere-plus` != null) {
            return `_sphere-plus`!!
        }
        `_sphere-plus` = Builder(name = "Sphere-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sphere-plus`: ImageVector? = null

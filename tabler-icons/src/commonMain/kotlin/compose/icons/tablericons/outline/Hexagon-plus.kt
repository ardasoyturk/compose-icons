...
public val OutlineGroup.`Hexagon-plus`: ImageVector
    get() {
        if (`_hexagon-plus` != null) {
            return `_hexagon-plus`!!
        }
        `_hexagon-plus` = Builder(name = "Hexagon-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hexagon-plus`: ImageVector? = null

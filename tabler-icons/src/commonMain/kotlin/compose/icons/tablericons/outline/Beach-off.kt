...
public val OutlineGroup.`Beach-off`: ImageVector
    get() {
        if (`_beach-off` != null) {
            return `_beach-off`!!
        }
        `_beach-off` = Builder(name = "Beach-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_beach-off`: ImageVector? = null

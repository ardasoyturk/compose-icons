...
public val OutlineGroup.`Brand-itch`: ImageVector
    get() {
        if (`_brand-itch` != null) {
            return `_brand-itch`!!
        }
        `_brand-itch` = Builder(name = "Brand-itch", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-itch`: ImageVector? = null

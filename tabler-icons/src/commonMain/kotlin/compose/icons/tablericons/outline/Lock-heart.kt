...
public val OutlineGroup.`Lock-heart`: ImageVector
    get() {
        if (`_lock-heart` != null) {
            return `_lock-heart`!!
        }
        `_lock-heart` = Builder(name = "Lock-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_lock-heart`: ImageVector? = null

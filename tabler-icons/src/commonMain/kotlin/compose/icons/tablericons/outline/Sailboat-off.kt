...
public val OutlineGroup.`Sailboat-off`: ImageVector
    get() {
        if (`_sailboat-off` != null) {
            return `_sailboat-off`!!
        }
        `_sailboat-off` = Builder(name = "Sailboat-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sailboat-off`: ImageVector? = null

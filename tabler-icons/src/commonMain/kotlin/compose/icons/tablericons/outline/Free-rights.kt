...
public val OutlineGroup.`Free-rights`: ImageVector
    get() {
        if (`_free-rights` != null) {
            return `_free-rights`!!
        }
        `_free-rights` = Builder(name = "Free-rights", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_free-rights`: ImageVector? = null

...
public val OutlineGroup.`Octagon-plus`: ImageVector
    get() {
        if (`_octagon-plus` != null) {
            return `_octagon-plus`!!
        }
        `_octagon-plus` = Builder(name = "Octagon-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_octagon-plus`: ImageVector? = null

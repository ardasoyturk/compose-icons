...
public val OutlineGroup.`Ghost-2`: ImageVector
    get() {
        if (`_ghost-2` != null) {
            return `_ghost-2`!!
        }
        `_ghost-2` = Builder(name = "Ghost-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ghost-2`: ImageVector? = null

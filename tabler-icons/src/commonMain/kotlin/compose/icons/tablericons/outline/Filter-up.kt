...
public val OutlineGroup.`Filter-up`: ImageVector
    get() {
        if (`_filter-up` != null) {
            return `_filter-up`!!
        }
        `_filter-up` = Builder(name = "Filter-up", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_filter-up`: ImageVector? = null

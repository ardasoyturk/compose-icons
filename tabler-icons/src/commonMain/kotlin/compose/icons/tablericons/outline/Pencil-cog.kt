...
public val OutlineGroup.`Pencil-cog`: ImageVector
    get() {
        if (`_pencil-cog` != null) {
            return `_pencil-cog`!!
        }
        `_pencil-cog` = Builder(name = "Pencil-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pencil-cog`: ImageVector? = null

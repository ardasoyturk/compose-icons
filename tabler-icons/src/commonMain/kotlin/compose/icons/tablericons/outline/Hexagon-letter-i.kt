...
public val OutlineGroup.`Hexagon-letter-i`: ImageVector
    get() {
        if (`_hexagon-letter-i` != null) {
            return `_hexagon-letter-i`!!
        }
        `_hexagon-letter-i` = Builder(name = "Hexagon-letter-i", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-i`: ImageVector? = null

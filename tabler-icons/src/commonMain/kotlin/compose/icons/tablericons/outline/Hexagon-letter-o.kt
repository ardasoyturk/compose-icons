...
public val OutlineGroup.`Hexagon-letter-o`: ImageVector
    get() {
        if (`_hexagon-letter-o` != null) {
            return `_hexagon-letter-o`!!
        }
        `_hexagon-letter-o` = Builder(name = "Hexagon-letter-o", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-o`: ImageVector? = null

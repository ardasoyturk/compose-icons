...
public val OutlineGroup.`Eye-check`: ImageVector
    get() {
        if (`_eye-check` != null) {
            return `_eye-check`!!
        }
        `_eye-check` = Builder(name = "Eye-check", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-check`: ImageVector? = null

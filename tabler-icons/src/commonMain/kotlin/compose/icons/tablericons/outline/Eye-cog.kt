...
public val OutlineGroup.`Eye-cog`: ImageVector
    get() {
        if (`_eye-cog` != null) {
            return `_eye-cog`!!
        }
        `_eye-cog` = Builder(name = "Eye-cog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-cog`: ImageVector? = null

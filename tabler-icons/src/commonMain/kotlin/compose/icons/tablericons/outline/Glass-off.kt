...
public val OutlineGroup.`Glass-off`: ImageVector
    get() {
        if (`_glass-off` != null) {
            return `_glass-off`!!
        }
        `_glass-off` = Builder(name = "Glass-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_glass-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-storybook`: ImageVector
    get() {
        if (`_brand-storybook` != null) {
            return `_brand-storybook`!!
        }
        `_brand-storybook` = Builder(name = "Brand-storybook", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-storybook`: ImageVector? = null

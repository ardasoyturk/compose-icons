...
public val OutlineGroup.`Triangle-minus-2`: ImageVector
    get() {
        if (`_triangle-minus-2` != null) {
            return `_triangle-minus-2`!!
        }
        `_triangle-minus-2` = Builder(name = "Triangle-minus-2", defaultWidth = 24.0.dp,
...
private var `_triangle-minus-2`: ImageVector? = null

...
public val OutlineGroup.`Database-star`: ImageVector
    get() {
        if (`_database-star` != null) {
            return `_database-star`!!
        }
        `_database-star` = Builder(name = "Database-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-star`: ImageVector? = null

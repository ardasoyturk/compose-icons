...
public val OutlineGroup.`Settings-spark`: ImageVector
    get() {
        if (`_settings-spark` != null) {
            return `_settings-spark`!!
        }
        `_settings-spark` = Builder(name = "Settings-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-spark`: ImageVector? = null

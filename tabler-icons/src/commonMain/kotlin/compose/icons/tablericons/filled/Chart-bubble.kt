...
public val FilledGroup.`Chart-bubble`: ImageVector
    get() {
        if (`_chart-bubble` != null) {
            return `_chart-bubble`!!
        }
        `_chart-bubble` = Builder(name = "Chart-bubble", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_chart-bubble`: ImageVector? = null

...
public val OutlineGroup.`Garden-cart`: ImageVector
    get() {
        if (`_garden-cart` != null) {
            return `_garden-cart`!!
        }
        `_garden-cart` = Builder(name = "Garden-cart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_garden-cart`: ImageVector? = null

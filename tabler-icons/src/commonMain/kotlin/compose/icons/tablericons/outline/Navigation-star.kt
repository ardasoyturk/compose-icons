...
public val OutlineGroup.`Navigation-star`: ImageVector
    get() {
        if (`_navigation-star` != null) {
            return `_navigation-star`!!
        }
        `_navigation-star` = Builder(name = "Navigation-star", defaultWidth = 24.0.dp, defaultHeight
...
private var `_navigation-star`: ImageVector? = null

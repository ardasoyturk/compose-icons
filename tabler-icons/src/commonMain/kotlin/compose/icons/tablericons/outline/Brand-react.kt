...
public val OutlineGroup.`Brand-react`: ImageVector
    get() {
        if (`_brand-react` != null) {
            return `_brand-react`!!
        }
        `_brand-react` = Builder(name = "Brand-react", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-react`: ImageVector? = null

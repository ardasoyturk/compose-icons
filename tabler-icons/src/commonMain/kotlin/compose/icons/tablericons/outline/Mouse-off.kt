...
public val OutlineGroup.`Mouse-off`: ImageVector
    get() {
        if (`_mouse-off` != null) {
            return `_mouse-off`!!
        }
        `_mouse-off` = Builder(name = "Mouse-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mouse-off`: ImageVector? = null

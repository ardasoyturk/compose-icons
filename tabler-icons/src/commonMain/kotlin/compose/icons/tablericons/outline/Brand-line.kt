...
public val OutlineGroup.`Brand-line`: ImageVector
    get() {
        if (`_brand-line` != null) {
            return `_brand-line`!!
        }
        `_brand-line` = Builder(name = "Brand-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-line`: ImageVector? = null

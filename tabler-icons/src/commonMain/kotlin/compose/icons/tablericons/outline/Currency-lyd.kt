...
public val OutlineGroup.`Currency-lyd`: ImageVector
    get() {
        if (`_currency-lyd` != null) {
            return `_currency-lyd`!!
        }
        `_currency-lyd` = Builder(name = "Currency-lyd", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_currency-lyd`: ImageVector? = null

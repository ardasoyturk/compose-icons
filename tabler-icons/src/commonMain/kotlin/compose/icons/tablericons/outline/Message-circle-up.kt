...
public val OutlineGroup.`Message-circle-up`: ImageVector
    get() {
        if (`_message-circle-up` != null) {
            return `_message-circle-up`!!
        }
        `_message-circle-up` = Builder(name = "Message-circle-up", defaultWidth = 24.0.dp,
...
private var `_message-circle-up`: ImageVector? = null

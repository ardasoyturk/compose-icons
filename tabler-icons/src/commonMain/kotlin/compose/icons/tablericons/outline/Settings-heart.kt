...
public val OutlineGroup.`Settings-heart`: ImageVector
    get() {
        if (`_settings-heart` != null) {
            return `_settings-heart`!!
        }
        `_settings-heart` = Builder(name = "Settings-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-heart`: ImageVector? = null

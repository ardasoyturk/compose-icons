...
public val OutlineGroup.`Brand-sugarizer`: ImageVector
    get() {
        if (`_brand-sugarizer` != null) {
            return `_brand-sugarizer`!!
        }
        `_brand-sugarizer` = Builder(name = "Brand-sugarizer", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-sugarizer`: ImageVector? = null

...
public val OutlineGroup.`Music-heart`: ImageVector
    get() {
        if (`_music-heart` != null) {
            return `_music-heart`!!
        }
        `_music-heart` = Builder(name = "Music-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_music-heart`: ImageVector? = null

...
public val LucideIcons.LayoutPanelTop: ImageVector
    get() {
        if (_layoutPanelTop != null) {
            return _layoutPanelTop!!
        }
        _layoutPanelTop = Builder(name = "LayoutPanelTop", defaultWidth = 24.0.dp, defaultHeight =

...
public val OutlineGroup.`Heart-pin`: ImageVector
    get() {
        if (`_heart-pin` != null) {
            return `_heart-pin`!!
        }
        `_heart-pin` = Builder(name = "Heart-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_heart-pin`: ImageVector? = null

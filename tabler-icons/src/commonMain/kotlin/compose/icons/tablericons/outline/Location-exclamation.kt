...
public val OutlineGroup.`Location-exclamation`: ImageVector
    get() {
        if (`_location-exclamation` != null) {
            return `_location-exclamation`!!
        }
        `_location-exclamation` = Builder(name = "Location-exclamation", defaultWidth = 24.0.dp,
...
private var `_location-exclamation`: ImageVector? = null

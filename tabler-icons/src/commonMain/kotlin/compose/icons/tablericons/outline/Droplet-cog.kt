...
public val OutlineGroup.`Droplet-cog`: ImageVector
    get() {
        if (`_droplet-cog` != null) {
            return `_droplet-cog`!!
        }
        `_droplet-cog` = Builder(name = "Droplet-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-cog`: ImageVector? = null

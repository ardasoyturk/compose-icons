...
public val OutlineGroup.`Brand-adobe-photoshop`: ImageVector
    get() {
        if (`_brand-adobe-photoshop` != null) {
            return `_brand-adobe-photoshop`!!
        }
        `_brand-adobe-photoshop` = Builder(name = "Brand-adobe-photoshop", defaultWidth = 24.0.dp,
...
private var `_brand-adobe-photoshop`: ImageVector? = null

...
public val OutlineGroup.`Alert-hexagon`: ImageVector
    get() {
        if (`_alert-hexagon` != null) {
            return `_alert-hexagon`!!
        }
        `_alert-hexagon` = Builder(name = "Alert-hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_alert-hexagon`: ImageVector? = null

...
public val OutlineGroup.`Circle-dashed-minus`: ImageVector
    get() {
        if (`_circle-dashed-minus` != null) {
            return `_circle-dashed-minus`!!
        }
        `_circle-dashed-minus` = Builder(name = "Circle-dashed-minus", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-minus`: ImageVector? = null

...
public val OutlineGroup.`Octagon-minus`: ImageVector
    get() {
        if (`_octagon-minus` != null) {
            return `_octagon-minus`!!
        }
        `_octagon-minus` = Builder(name = "Octagon-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_octagon-minus`: ImageVector? = null

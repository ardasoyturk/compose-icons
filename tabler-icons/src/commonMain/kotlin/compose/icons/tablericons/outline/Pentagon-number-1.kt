...
public val OutlineGroup.`Pentagon-number-1`: ImageVector
    get() {
        if (`_pentagon-number-1` != null) {
            return `_pentagon-number-1`!!
        }
        `_pentagon-number-1` = Builder(name = "Pentagon-number-1", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-1`: ImageVector? = null

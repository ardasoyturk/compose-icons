...
public val OutlineGroup.`Brand-bandlab`: ImageVector
    get() {
        if (`_brand-bandlab` != null) {
            return `_brand-bandlab`!!
        }
        `_brand-bandlab` = Builder(name = "Brand-bandlab", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-bandlab`: ImageVector? = null

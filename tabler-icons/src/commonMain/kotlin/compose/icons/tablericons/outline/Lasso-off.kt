...
public val OutlineGroup.`Lasso-off`: ImageVector
    get() {
        if (`_lasso-off` != null) {
            return `_lasso-off`!!
        }
        `_lasso-off` = Builder(name = "Lasso-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lasso-off`: ImageVector? = null

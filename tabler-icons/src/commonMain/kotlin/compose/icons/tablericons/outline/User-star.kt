...
public val OutlineGroup.`User-star`: ImageVector
    get() {
        if (`_user-star` != null) {
            return `_user-star`!!
        }
        `_user-star` = Builder(name = "User-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_user-star`: ImageVector? = null

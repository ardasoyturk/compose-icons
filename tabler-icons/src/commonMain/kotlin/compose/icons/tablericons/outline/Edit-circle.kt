...
public val OutlineGroup.`Edit-circle`: ImageVector
    get() {
        if (`_edit-circle` != null) {
            return `_edit-circle`!!
        }
        `_edit-circle` = Builder(name = "Edit-circle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_edit-circle`: ImageVector? = null

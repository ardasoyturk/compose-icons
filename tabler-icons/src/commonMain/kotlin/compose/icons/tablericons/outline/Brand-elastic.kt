...
public val OutlineGroup.`Brand-elastic`: ImageVector
    get() {
        if (`_brand-elastic` != null) {
            return `_brand-elastic`!!
        }
        `_brand-elastic` = Builder(name = "Brand-elastic", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-elastic`: ImageVector? = null

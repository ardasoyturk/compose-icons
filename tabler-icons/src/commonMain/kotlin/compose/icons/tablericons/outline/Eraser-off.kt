...
public val OutlineGroup.`Eraser-off`: ImageVector
    get() {
        if (`_eraser-off` != null) {
            return `_eraser-off`!!
        }
        `_eraser-off` = Builder(name = "Eraser-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_eraser-off`: ImageVector? = null

...
public val OutlineGroup.`Brand-edge`: ImageVector
    get() {
        if (`_brand-edge` != null) {
            return `_brand-edge`!!
        }
        `_brand-edge` = Builder(name = "Brand-edge", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-edge`: ImageVector? = null

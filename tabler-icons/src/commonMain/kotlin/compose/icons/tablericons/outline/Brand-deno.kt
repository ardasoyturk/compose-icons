...
public val OutlineGroup.`Brand-deno`: ImageVector
    get() {
        if (`_brand-deno` != null) {
            return `_brand-deno`!!
        }
        `_brand-deno` = Builder(name = "Brand-deno", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-deno`: ImageVector? = null

...
public val OutlineGroup.`School-bell`: ImageVector
    get() {
        if (`_school-bell` != null) {
            return `_school-bell`!!
        }
        `_school-bell` = Builder(name = "School-bell", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_school-bell`: ImageVector? = null

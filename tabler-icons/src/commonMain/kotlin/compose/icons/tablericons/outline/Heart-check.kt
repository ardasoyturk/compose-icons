...
public val OutlineGroup.`Heart-check`: ImageVector
    get() {
        if (`_heart-check` != null) {
            return `_heart-check`!!
        }
        `_heart-check` = Builder(name = "Heart-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_heart-check`: ImageVector? = null

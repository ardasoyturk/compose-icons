...
public val OutlineGroup.`Filter-check`: ImageVector
    get() {
        if (`_filter-check` != null) {
            return `_filter-check`!!
        }
        `_filter-check` = Builder(name = "Filter-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-check`: ImageVector? = null

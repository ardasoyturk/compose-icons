...
public val OutlineGroup.`Filter-pin`: ImageVector
    get() {
        if (`_filter-pin` != null) {
            return `_filter-pin`!!
        }
        `_filter-pin` = Builder(name = "Filter-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-pin`: ImageVector? = null

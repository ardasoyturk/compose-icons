...
public val OutlineGroup.`Lungs-off`: ImageVector
    get() {
        if (`_lungs-off` != null) {
            return `_lungs-off`!!
        }
        `_lungs-off` = Builder(name = "Lungs-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lungs-off`: ImageVector? = null

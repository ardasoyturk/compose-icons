...
public val OutlineGroup.`Brand-svelte`: ImageVector
    get() {
        if (`_brand-svelte` != null) {
            return `_brand-svelte`!!
        }
        `_brand-svelte` = Builder(name = "Brand-svelte", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-svelte`: ImageVector? = null

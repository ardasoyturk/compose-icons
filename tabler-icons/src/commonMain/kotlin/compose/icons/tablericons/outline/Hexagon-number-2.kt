...
public val OutlineGroup.`Hexagon-number-2`: ImageVector
    get() {
        if (`_hexagon-number-2` != null) {
            return `_hexagon-number-2`!!
        }
        `_hexagon-number-2` = Builder(name = "Hexagon-number-2", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-2`: ImageVector? = null

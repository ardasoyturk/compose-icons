...
public val OutlineGroup.`Brand-nem`: ImageVector
    get() {
        if (`_brand-nem` != null) {
            return `_brand-nem`!!
        }
        `_brand-nem` = Builder(name = "Brand-nem", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-nem`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-l`: ImageVector
    get() {
        if (`_hexagon-letter-l` != null) {
            return `_hexagon-letter-l`!!
        }
        `_hexagon-letter-l` = Builder(name = "Hexagon-letter-l", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-l`: ImageVector? = null

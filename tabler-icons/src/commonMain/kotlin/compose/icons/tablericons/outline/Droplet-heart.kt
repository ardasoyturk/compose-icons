...
public val OutlineGroup.`Droplet-heart`: ImageVector
    get() {
        if (`_droplet-heart` != null) {
            return `_droplet-heart`!!
        }
        `_droplet-heart` = Builder(name = "Droplet-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-heart`: ImageVector? = null

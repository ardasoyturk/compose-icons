...
public val OutlineGroup.`Settings-code`: ImageVector
    get() {
        if (`_settings-code` != null) {
            return `_settings-code`!!
        }
        `_settings-code` = Builder(name = "Settings-code", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-code`: ImageVector? = null

...
public val OutlineGroup.`Meat-off`: ImageVector
    get() {
        if (`_meat-off` != null) {
            return `_meat-off`!!
        }
        `_meat-off` = Builder(name = "Meat-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_meat-off`: ImageVector? = null

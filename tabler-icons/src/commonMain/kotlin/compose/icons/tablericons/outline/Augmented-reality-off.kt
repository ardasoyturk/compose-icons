...
public val OutlineGroup.`Augmented-reality-off`: ImageVector
    get() {
        if (`_augmented-reality-off` != null) {
            return `_augmented-reality-off`!!
        }
        `_augmented-reality-off` = Builder(name = "Augmented-reality-off", defaultWidth = 24.0.dp,
...
private var `_augmented-reality-off`: ImageVector? = null

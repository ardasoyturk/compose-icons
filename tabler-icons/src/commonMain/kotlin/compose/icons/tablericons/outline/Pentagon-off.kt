...
public val OutlineGroup.`Pentagon-off`: ImageVector
    get() {
        if (`_pentagon-off` != null) {
            return `_pentagon-off`!!
        }
        `_pentagon-off` = Builder(name = "Pentagon-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pentagon-off`: ImageVector? = null

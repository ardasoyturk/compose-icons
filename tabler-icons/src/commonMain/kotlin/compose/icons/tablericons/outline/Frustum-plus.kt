...
public val OutlineGroup.`Frustum-plus`: ImageVector
    get() {
        if (`_frustum-plus` != null) {
            return `_frustum-plus`!!
        }
        `_frustum-plus` = Builder(name = "Frustum-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_frustum-plus`: ImageVector? = null

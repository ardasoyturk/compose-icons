...
public val OutlineGroup.`Lasso-polygon`: ImageVector
    get() {
        if (`_lasso-polygon` != null) {
            return `_lasso-polygon`!!
        }
        `_lasso-polygon` = Builder(name = "Lasso-polygon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_lasso-polygon`: ImageVector? = null

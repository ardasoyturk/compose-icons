...
public val OutlineGroup.`Hexagon-letter-c`: ImageVector
    get() {
        if (`_hexagon-letter-c` != null) {
            return `_hexagon-letter-c`!!
        }
        `_hexagon-letter-c` = Builder(name = "Hexagon-letter-c", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-c`: ImageVector? = null

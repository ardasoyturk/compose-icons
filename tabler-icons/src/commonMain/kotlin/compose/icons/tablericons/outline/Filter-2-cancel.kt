...
public val OutlineGroup.`Filter-2-cancel`: ImageVector
    get() {
        if (`_filter-2-cancel` != null) {
            return `_filter-2-cancel`!!
        }
        `_filter-2-cancel` = Builder(name = "Filter-2-cancel", defaultWidth = 24.0.dp, defaultHeight
...
private var `_filter-2-cancel`: ImageVector? = null

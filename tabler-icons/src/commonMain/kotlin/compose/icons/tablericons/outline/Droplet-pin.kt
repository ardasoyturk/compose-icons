...
public val OutlineGroup.`Droplet-pin`: ImageVector
    get() {
        if (`_droplet-pin` != null) {
            return `_droplet-pin`!!
        }
        `_droplet-pin` = Builder(name = "Droplet-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-pin`: ImageVector? = null

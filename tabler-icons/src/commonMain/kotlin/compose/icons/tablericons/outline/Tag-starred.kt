...
public val OutlineGroup.`Tag-starred`: ImageVector
    get() {
        if (`_tag-starred` != null) {
            return `_tag-starred`!!
        }
        `_tag-starred` = Builder(name = "Tag-starred", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_tag-starred`: ImageVector? = null

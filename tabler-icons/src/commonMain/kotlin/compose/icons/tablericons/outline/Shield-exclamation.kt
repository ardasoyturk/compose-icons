...
public val OutlineGroup.`Shield-exclamation`: ImageVector
    get() {
        if (`_shield-exclamation` != null) {
            return `_shield-exclamation`!!
        }
        `_shield-exclamation` = Builder(name = "Shield-exclamation", defaultWidth = 24.0.dp,
...
private var `_shield-exclamation`: ImageVector? = null

...
public val OutlineGroup.`Rainbow-off`: ImageVector
    get() {
        if (`_rainbow-off` != null) {
            return `_rainbow-off`!!
        }
        `_rainbow-off` = Builder(name = "Rainbow-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rainbow-off`: ImageVector? = null

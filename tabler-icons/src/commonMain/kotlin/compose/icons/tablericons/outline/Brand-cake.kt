...
public val OutlineGroup.`Brand-cake`: ImageVector
    get() {
        if (`_brand-cake` != null) {
            return `_brand-cake`!!
        }
        `_brand-cake` = Builder(name = "Brand-cake", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cake`: ImageVector? = null

...
public val OutlineGroup.`Brand-minecraft`: ImageVector
    get() {
        if (`_brand-minecraft` != null) {
            return `_brand-minecraft`!!
        }
        `_brand-minecraft` = Builder(name = "Brand-minecraft", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-minecraft`: ImageVector? = null

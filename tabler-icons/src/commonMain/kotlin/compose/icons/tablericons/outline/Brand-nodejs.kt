...
public val OutlineGroup.`Brand-nodejs`: ImageVector
    get() {
        if (`_brand-nodejs` != null) {
            return `_brand-nodejs`!!
        }
        `_brand-nodejs` = Builder(name = "Brand-nodejs", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-nodejs`: ImageVector? = null

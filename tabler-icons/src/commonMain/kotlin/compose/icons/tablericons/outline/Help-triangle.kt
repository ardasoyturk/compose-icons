...
public val OutlineGroup.`Help-triangle`: ImageVector
    get() {
        if (`_help-triangle` != null) {
            return `_help-triangle`!!
        }
        `_help-triangle` = Builder(name = "Help-triangle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_help-triangle`: ImageVector? = null

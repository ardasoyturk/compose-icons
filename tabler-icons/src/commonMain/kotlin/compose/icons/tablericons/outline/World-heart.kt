...
public val OutlineGroup.`World-heart`: ImageVector
    get() {
        if (`_world-heart` != null) {
            return `_world-heart`!!
        }
        `_world-heart` = Builder(name = "World-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_world-heart`: ImageVector? = null

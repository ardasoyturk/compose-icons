...
public val OutlineGroup.`Mountain-off`: ImageVector
    get() {
        if (`_mountain-off` != null) {
            return `_mountain-off`!!
        }
        `_mountain-off` = Builder(name = "Mountain-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_mountain-off`: ImageVector? = null

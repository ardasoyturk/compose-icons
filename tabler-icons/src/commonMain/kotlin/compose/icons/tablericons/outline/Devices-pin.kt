...
public val OutlineGroup.`Devices-pin`: ImageVector
    get() {
        if (`_devices-pin` != null) {
            return `_devices-pin`!!
        }
        `_devices-pin` = Builder(name = "Devices-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_devices-pin`: ImageVector? = null

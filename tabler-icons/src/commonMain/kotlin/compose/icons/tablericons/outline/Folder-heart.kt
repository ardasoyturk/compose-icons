...
public val OutlineGroup.`Folder-heart`: ImageVector
    get() {
        if (`_folder-heart` != null) {
            return `_folder-heart`!!
        }
        `_folder-heart` = Builder(name = "Folder-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-heart`: ImageVector? = null

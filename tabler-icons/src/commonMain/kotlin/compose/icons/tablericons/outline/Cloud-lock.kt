...
public val OutlineGroup.`Cloud-lock`: ImageVector
    get() {
        if (`_cloud-lock` != null) {
            return `_cloud-lock`!!
        }
        `_cloud-lock` = Builder(name = "Cloud-lock", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-lock`: ImageVector? = null

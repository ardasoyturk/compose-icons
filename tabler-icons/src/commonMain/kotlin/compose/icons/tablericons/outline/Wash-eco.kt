...
public val OutlineGroup.`Wash-eco`: ImageVector
    get() {
        if (`_wash-eco` != null) {
            return `_wash-eco`!!
        }
        `_wash-eco` = Builder(name = "Wash-eco", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wash-eco`: ImageVector? = null

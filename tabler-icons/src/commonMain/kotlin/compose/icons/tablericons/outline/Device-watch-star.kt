...
public val OutlineGroup.`Device-watch-star`: ImageVector
    get() {
        if (`_device-watch-star` != null) {
            return `_device-watch-star`!!
        }
        `_device-watch-star` = Builder(name = "Device-watch-star", defaultWidth = 24.0.dp,
...
private var `_device-watch-star`: ImageVector? = null

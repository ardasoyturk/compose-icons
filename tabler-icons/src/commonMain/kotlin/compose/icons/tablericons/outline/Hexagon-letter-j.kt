...
public val OutlineGroup.`Hexagon-letter-j`: ImageVector
    get() {
        if (`_hexagon-letter-j` != null) {
            return `_hexagon-letter-j`!!
        }
        `_hexagon-letter-j` = Builder(name = "Hexagon-letter-j", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-j`: ImageVector? = null

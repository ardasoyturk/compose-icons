...
public val OutlineGroup.`Basket-heart`: ImageVector
    get() {
        if (`_basket-heart` != null) {
            return `_basket-heart`!!
        }
        `_basket-heart` = Builder(name = "Basket-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-heart`: ImageVector? = null

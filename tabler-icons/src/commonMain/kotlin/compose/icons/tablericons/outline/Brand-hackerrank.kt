...
public val OutlineGroup.`Brand-hackerrank`: ImageVector
    get() {
        if (`_brand-hackerrank` != null) {
            return `_brand-hackerrank`!!
        }
        `_brand-hackerrank` = Builder(name = "Brand-hackerrank", defaultWidth = 24.0.dp,
...
private var `_brand-hackerrank`: ImageVector? = null

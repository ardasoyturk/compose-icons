...
public val OutlineGroup.`Circle-dashed-letter-m`: ImageVector
    get() {
        if (`_circle-dashed-letter-m` != null) {
            return `_circle-dashed-letter-m`!!
        }
        `_circle-dashed-letter-m` = Builder(name = "Circle-dashed-letter-m", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-m`: ImageVector? = null

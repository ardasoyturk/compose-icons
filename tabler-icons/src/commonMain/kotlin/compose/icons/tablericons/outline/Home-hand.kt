...
public val OutlineGroup.`Home-hand`: ImageVector
    get() {
        if (`_home-hand` != null) {
            return `_home-hand`!!
        }
        `_home-hand` = Builder(name = "Home-hand", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_home-hand`: ImageVector? = null

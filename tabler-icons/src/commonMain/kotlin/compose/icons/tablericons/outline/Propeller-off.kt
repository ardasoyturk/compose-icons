...
public val OutlineGroup.`Propeller-off`: ImageVector
    get() {
        if (`_propeller-off` != null) {
            return `_propeller-off`!!
        }
        `_propeller-off` = Builder(name = "Propeller-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_propeller-off`: ImageVector? = null

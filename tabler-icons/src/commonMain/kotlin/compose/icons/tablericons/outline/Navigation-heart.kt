...
public val OutlineGroup.`Navigation-heart`: ImageVector
    get() {
        if (`_navigation-heart` != null) {
            return `_navigation-heart`!!
        }
        `_navigation-heart` = Builder(name = "Navigation-heart", defaultWidth = 24.0.dp,
...
private var `_navigation-heart`: ImageVector? = null

...
public val LucideIcons.HardDriveUpload: ImageVector
    get() {
        if (_hardDriveUpload != null) {
            return _hardDriveUpload!!
        }
        _hardDriveUpload = Builder(name = "HardDriveUpload", defaultWidth = 24.0.dp, defaultHeight =

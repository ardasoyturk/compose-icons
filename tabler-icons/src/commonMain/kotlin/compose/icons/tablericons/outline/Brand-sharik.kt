...
public val OutlineGroup.`Brand-sharik`: ImageVector
    get() {
        if (`_brand-sharik` != null) {
            return `_brand-sharik`!!
        }
        `_brand-sharik` = Builder(name = "Brand-sharik", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-sharik`: ImageVector? = null

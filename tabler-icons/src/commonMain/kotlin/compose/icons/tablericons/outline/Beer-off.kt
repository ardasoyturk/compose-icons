...
public val OutlineGroup.`Beer-off`: ImageVector
    get() {
        if (`_beer-off` != null) {
            return `_beer-off`!!
        }
        `_beer-off` = Builder(name = "Beer-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_beer-off`: ImageVector? = null

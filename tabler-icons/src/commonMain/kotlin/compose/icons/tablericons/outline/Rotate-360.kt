...
public val OutlineGroup.`Rotate-360`: ImageVector
    get() {
        if (`_rotate-360` != null) {
            return `_rotate-360`!!
        }
        `_rotate-360` = Builder(name = "Rotate-360", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rotate-360`: ImageVector? = null

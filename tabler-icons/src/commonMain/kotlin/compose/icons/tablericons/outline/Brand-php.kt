...
public val OutlineGroup.`Brand-php`: ImageVector
    get() {
        if (`_brand-php` != null) {
            return `_brand-php`!!
        }
        `_brand-php` = Builder(name = "Brand-php", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-php`: ImageVector? = null

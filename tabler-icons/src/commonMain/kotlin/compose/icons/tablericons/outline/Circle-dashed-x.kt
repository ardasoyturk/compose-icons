...
public val OutlineGroup.`Circle-dashed-x`: ImageVector
    get() {
        if (`_circle-dashed-x` != null) {
            return `_circle-dashed-x`!!
        }
        `_circle-dashed-x` = Builder(name = "Circle-dashed-x", defaultWidth = 24.0.dp, defaultHeight
...
private var `_circle-dashed-x`: ImageVector? = null

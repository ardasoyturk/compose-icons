...
public val OutlineGroup.`Ripple-off`: ImageVector
    get() {
        if (`_ripple-off` != null) {
            return `_ripple-off`!!
        }
        `_ripple-off` = Builder(name = "Ripple-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ripple-off`: ImageVector? = null

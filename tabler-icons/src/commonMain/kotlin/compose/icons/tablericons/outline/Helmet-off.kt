...
public val OutlineGroup.`Helmet-off`: ImageVector
    get() {
        if (`_helmet-off` != null) {
            return `_helmet-off`!!
        }
        `_helmet-off` = Builder(name = "Helmet-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_helmet-off`: ImageVector? = null

...
public val OutlineGroup.`Target-off`: ImageVector
    get() {
        if (`_target-off` != null) {
            return `_target-off`!!
        }
        `_target-off` = Builder(name = "Target-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_target-off`: ImageVector? = null

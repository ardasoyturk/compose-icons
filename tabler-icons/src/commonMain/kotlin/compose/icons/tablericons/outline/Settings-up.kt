...
public val OutlineGroup.`Settings-up`: ImageVector
    get() {
        if (`_settings-up` != null) {
            return `_settings-up`!!
        }
        `_settings-up` = Builder(name = "Settings-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-up`: ImageVector? = null

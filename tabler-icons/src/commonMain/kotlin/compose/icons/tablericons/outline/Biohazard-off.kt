...
public val OutlineGroup.`Biohazard-off`: ImageVector
    get() {
        if (`_biohazard-off` != null) {
            return `_biohazard-off`!!
        }
        `_biohazard-off` = Builder(name = "Biohazard-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_biohazard-off`: ImageVector? = null

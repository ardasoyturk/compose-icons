...
public val OutlineGroup.`Flag-spark`: ImageVector
    get() {
        if (`_flag-spark` != null) {
            return `_flag-spark`!!
        }
        `_flag-spark` = Builder(name = "Flag-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flag-spark`: ImageVector? = null

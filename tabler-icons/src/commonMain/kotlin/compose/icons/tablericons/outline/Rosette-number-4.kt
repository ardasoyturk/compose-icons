...
public val OutlineGroup.`Rosette-number-4`: ImageVector
    get() {
        if (`_rosette-number-4` != null) {
            return `_rosette-number-4`!!
        }
        `_rosette-number-4` = Builder(name = "Rosette-number-4", defaultWidth = 24.0.dp,
...
private var `_rosette-number-4`: ImageVector? = null

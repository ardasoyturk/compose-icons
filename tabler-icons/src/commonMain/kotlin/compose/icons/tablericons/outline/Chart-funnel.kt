...
public val OutlineGroup.`Chart-funnel`: ImageVector
    get() {
        if (`_chart-funnel` != null) {
            return `_chart-funnel`!!
        }
        `_chart-funnel` = Builder(name = "Chart-funnel", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_chart-funnel`: ImageVector? = null

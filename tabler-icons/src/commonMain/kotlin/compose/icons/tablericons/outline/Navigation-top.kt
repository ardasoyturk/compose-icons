...
public val OutlineGroup.`Navigation-top`: ImageVector
    get() {
        if (`_navigation-top` != null) {
            return `_navigation-top`!!
        }
        `_navigation-top` = Builder(name = "Navigation-top", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_navigation-top`: ImageVector? = null

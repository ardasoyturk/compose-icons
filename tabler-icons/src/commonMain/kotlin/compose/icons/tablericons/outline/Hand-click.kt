...
public val OutlineGroup.`Hand-click`: ImageVector
    get() {
        if (`_hand-click` != null) {
            return `_hand-click`!!
        }
        `_hand-click` = Builder(name = "Hand-click", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hand-click`: ImageVector? = null

...
public val OutlineGroup.`Signature-off`: ImageVector
    get() {
        if (`_signature-off` != null) {
            return `_signature-off`!!
        }
        `_signature-off` = Builder(name = "Signature-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_signature-off`: ImageVector? = null

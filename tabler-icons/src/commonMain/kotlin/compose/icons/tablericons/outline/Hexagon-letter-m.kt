...
public val OutlineGroup.`Hexagon-letter-m`: ImageVector
    get() {
        if (`_hexagon-letter-m` != null) {
            return `_hexagon-letter-m`!!
        }
        `_hexagon-letter-m` = Builder(name = "Hexagon-letter-m", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-m`: ImageVector? = null

...
public val OutlineGroup.`User-hexagon`: ImageVector
    get() {
        if (`_user-hexagon` != null) {
            return `_user-hexagon`!!
        }
        `_user-hexagon` = Builder(name = "User-hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_user-hexagon`: ImageVector? = null

...
public val OutlineGroup.`Brand-vimeo`: ImageVector
    get() {
        if (`_brand-vimeo` != null) {
            return `_brand-vimeo`!!
        }
        `_brand-vimeo` = Builder(name = "Brand-vimeo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-vimeo`: ImageVector? = null

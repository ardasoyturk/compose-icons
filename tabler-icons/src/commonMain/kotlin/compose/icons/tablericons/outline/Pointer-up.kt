...
public val OutlineGroup.`Pointer-up`: ImageVector
    get() {
        if (`_pointer-up` != null) {
            return `_pointer-up`!!
        }
        `_pointer-up` = Builder(name = "Pointer-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-up`: ImageVector? = null

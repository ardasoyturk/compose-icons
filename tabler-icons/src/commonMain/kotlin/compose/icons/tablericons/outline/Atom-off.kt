...
public val OutlineGroup.`Atom-off`: ImageVector
    get() {
        if (`_atom-off` != null) {
            return `_atom-off`!!
        }
        `_atom-off` = Builder(name = "Atom-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_atom-off`: ImageVector? = null

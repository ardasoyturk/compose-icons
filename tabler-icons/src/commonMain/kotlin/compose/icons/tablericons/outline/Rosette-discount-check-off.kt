...
public val OutlineGroup.`Rosette-discount-check-off`: ImageVector
    get() {
        if (`_rosette-discount-check-off` != null) {
            return `_rosette-discount-check-off`!!
        }
        `_rosette-discount-check-off` = Builder(name = "Rosette-discount-check-off", defaultWidth =
...
private var `_rosette-discount-check-off`: ImageVector? = null

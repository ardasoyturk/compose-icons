...
public val OutlineGroup.`Rosette-number-2`: ImageVector
    get() {
        if (`_rosette-number-2` != null) {
            return `_rosette-number-2`!!
        }
        `_rosette-number-2` = Builder(name = "Rosette-number-2", defaultWidth = 24.0.dp,
...
private var `_rosette-number-2`: ImageVector? = null

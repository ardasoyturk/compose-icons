...
public val LucideIcons.Dam: ImageVector
    get() {
        if (_dam != null) {
            return _dam!!
        }
        _dam = Builder(name = "Dam", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(11.75f, 18.0f)
                curveToRelative(0.35f, 0.5f, 1.45f, 1.0f, 2.75f, 1.0f)
                curveToRelative(2.5f, 0.0f, 2.5f, -2.0f, 5.0f, -2.0f)
                curveToRelative(1.3f, 0.0f, 1.9f, 0.5f, 2.5f, 1.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),

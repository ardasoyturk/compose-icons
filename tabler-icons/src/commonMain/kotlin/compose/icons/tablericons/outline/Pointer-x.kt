...
public val OutlineGroup.`Pointer-x`: ImageVector
    get() {
        if (`_pointer-x` != null) {
            return `_pointer-x`!!
        }
        `_pointer-x` = Builder(name = "Pointer-x", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_pointer-x`: ImageVector? = null

...
public val OutlineGroup.`Basket-discount`: ImageVector
    get() {
        if (`_basket-discount` != null) {
            return `_basket-discount`!!
        }
        `_basket-discount` = Builder(name = "Basket-discount", defaultWidth = 24.0.dp, defaultHeight
...
private var `_basket-discount`: ImageVector? = null

...
public val OutlineGroup.`Building-plus`: ImageVector
    get() {
        if (`_building-plus` != null) {
            return `_building-plus`!!
        }
        `_building-plus` = Builder(name = "Building-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_building-plus`: ImageVector? = null

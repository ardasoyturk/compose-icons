...
public val LucideIcons.BadgeSwissFranc: ImageVector
    get() {
        if (_badgeSwissFranc != null) {
            return _badgeSwissFranc!!
        }
        _badgeSwissFranc = Builder(name = "BadgeSwissFranc", defaultWidth = 24.0.dp, defaultHeight =

...
public val OutlineGroup.`Filter-question`: ImageVector
    get() {
        if (`_filter-question` != null) {
            return `_filter-question`!!
        }
        `_filter-question` = Builder(name = "Filter-question", defaultWidth = 24.0.dp, defaultHeight
...
private var `_filter-question`: ImageVector? = null

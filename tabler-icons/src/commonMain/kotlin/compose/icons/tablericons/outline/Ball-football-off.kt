...
public val OutlineGroup.`Ball-football-off`: ImageVector
    get() {
        if (`_ball-football-off` != null) {
            return `_ball-football-off`!!
        }
        `_ball-football-off` = Builder(name = "Ball-football-off", defaultWidth = 24.0.dp,
...
private var `_ball-football-off`: ImageVector? = null

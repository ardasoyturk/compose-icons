...
public val OutlineGroup.`Writing-sign`: ImageVector
    get() {
        if (`_writing-sign` != null) {
            return `_writing-sign`!!
        }
        `_writing-sign` = Builder(name = "Writing-sign", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_writing-sign`: ImageVector? = null

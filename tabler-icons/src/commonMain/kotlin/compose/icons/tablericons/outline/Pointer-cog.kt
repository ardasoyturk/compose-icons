...
public val OutlineGroup.`Pointer-cog`: ImageVector
    get() {
        if (`_pointer-cog` != null) {
            return `_pointer-cog`!!
        }
        `_pointer-cog` = Builder(name = "Pointer-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-cog`: ImageVector? = null

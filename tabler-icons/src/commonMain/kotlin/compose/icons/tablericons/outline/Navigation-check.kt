...
public val OutlineGroup.`Navigation-check`: ImageVector
    get() {
        if (`_navigation-check` != null) {
            return `_navigation-check`!!
        }
        `_navigation-check` = Builder(name = "Navigation-check", defaultWidth = 24.0.dp,
...
private var `_navigation-check`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-q`: ImageVector
    get() {
        if (`_hexagon-letter-q` != null) {
            return `_hexagon-letter-q`!!
        }
        `_hexagon-letter-q` = Builder(name = "Hexagon-letter-q", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-q`: ImageVector? = null

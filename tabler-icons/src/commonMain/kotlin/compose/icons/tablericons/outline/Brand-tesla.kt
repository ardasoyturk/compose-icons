...
public val OutlineGroup.`Brand-tesla`: ImageVector
    get() {
        if (`_brand-tesla` != null) {
            return `_brand-tesla`!!
        }
        `_brand-tesla` = Builder(name = "Brand-tesla", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-tesla`: ImageVector? = null

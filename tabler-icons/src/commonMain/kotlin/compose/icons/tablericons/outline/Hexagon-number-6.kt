...
public val OutlineGroup.`Hexagon-number-6`: ImageVector
    get() {
        if (`_hexagon-number-6` != null) {
            return `_hexagon-number-6`!!
        }
        `_hexagon-number-6` = Builder(name = "Hexagon-number-6", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-6`: ImageVector? = null

...
public val OutlineGroup.`Heart-minus`: ImageVector
    get() {
        if (`_heart-minus` != null) {
            return `_heart-minus`!!
        }
        `_heart-minus` = Builder(name = "Heart-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_heart-minus`: ImageVector? = null

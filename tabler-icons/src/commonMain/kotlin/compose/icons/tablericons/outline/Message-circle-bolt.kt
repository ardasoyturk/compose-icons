...
public val OutlineGroup.`Message-circle-bolt`: ImageVector
    get() {
        if (`_message-circle-bolt` != null) {
            return `_message-circle-bolt`!!
        }
        `_message-circle-bolt` = Builder(name = "Message-circle-bolt", defaultWidth = 24.0.dp,
...
private var `_message-circle-bolt`: ImageVector? = null

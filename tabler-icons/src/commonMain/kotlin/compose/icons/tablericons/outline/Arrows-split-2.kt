...
public val OutlineGroup.`Arrows-split-2`: ImageVector
    get() {
        if (`_arrows-split-2` != null) {
            return `_arrows-split-2`!!
        }
        `_arrows-split-2` = Builder(name = "Arrows-split-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrows-split-2`: ImageVector? = null

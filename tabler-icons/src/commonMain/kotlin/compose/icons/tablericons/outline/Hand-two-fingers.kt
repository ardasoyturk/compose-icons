...
public val OutlineGroup.`Hand-two-fingers`: ImageVector
    get() {
        if (`_hand-two-fingers` != null) {
            return `_hand-two-fingers`!!
        }
        `_hand-two-fingers` = Builder(name = "Hand-two-fingers", defaultWidth = 24.0.dp,
...
private var `_hand-two-fingers`: ImageVector? = null

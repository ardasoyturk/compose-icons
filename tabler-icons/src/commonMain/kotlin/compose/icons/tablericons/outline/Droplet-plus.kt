...
public val OutlineGroup.`Droplet-plus`: ImageVector
    get() {
        if (`_droplet-plus` != null) {
            return `_droplet-plus`!!
        }
        `_droplet-plus` = Builder(name = "Droplet-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-plus`: ImageVector? = null

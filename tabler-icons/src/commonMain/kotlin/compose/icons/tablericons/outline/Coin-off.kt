...
public val OutlineGroup.`Coin-off`: ImageVector
    get() {
        if (`_coin-off` != null) {
            return `_coin-off`!!
        }
        `_coin-off` = Builder(name = "Coin-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_coin-off`: ImageVector? = null

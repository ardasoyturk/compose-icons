...
public val OutlineGroup.`Badges-off`: ImageVector
    get() {
        if (`_badges-off` != null) {
            return `_badges-off`!!
        }
        `_badges-off` = Builder(name = "Badges-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_badges-off`: ImageVector? = null

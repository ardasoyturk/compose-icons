...
public val OutlineGroup.`Shopping-bag-heart`: ImageVector
    get() {
        if (`_shopping-bag-heart` != null) {
            return `_shopping-bag-heart`!!
        }
        `_shopping-bag-heart` = Builder(name = "Shopping-bag-heart", defaultWidth = 24.0.dp,
...
private var `_shopping-bag-heart`: ImageVector? = null

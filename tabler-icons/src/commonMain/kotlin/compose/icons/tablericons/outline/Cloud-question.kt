...
public val OutlineGroup.`Cloud-question`: ImageVector
    get() {
        if (`_cloud-question` != null) {
            return `_cloud-question`!!
        }
        `_cloud-question` = Builder(name = "Cloud-question", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-question`: ImageVector? = null

...
public val LucideIcons.DecimalsArrowRight: ImageVector
    get() {
        if (_decimalsArrowRight != null) {
            return _decimalsArrowRight!!
        }
        _decimalsArrowRight = Builder(name = "DecimalsArrowRight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(20.0f, 8.5f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 17.5f, 11.0f)
                lineTo(17.5f, 11.0f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 15.0f, 8.5f)
                lineTo(15.0f, 5.5f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 17.5f, 3.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =

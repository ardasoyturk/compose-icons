...
public val OutlineGroup.`Blur-off`: ImageVector
    get() {
        if (`_blur-off` != null) {
            return `_blur-off`!!
        }
        `_blur-off` = Builder(name = "Blur-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_blur-off`: ImageVector? = null

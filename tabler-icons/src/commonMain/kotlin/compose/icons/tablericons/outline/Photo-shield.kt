...
public val OutlineGroup.`Photo-shield`: ImageVector
    get() {
        if (`_photo-shield` != null) {
            return `_photo-shield`!!
        }
        `_photo-shield` = Builder(name = "Photo-shield", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-shield`: ImageVector? = null

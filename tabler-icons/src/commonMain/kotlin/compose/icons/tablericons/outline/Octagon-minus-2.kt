...
public val OutlineGroup.`Octagon-minus-2`: ImageVector
    get() {
        if (`_octagon-minus-2` != null) {
            return `_octagon-minus-2`!!
        }
        `_octagon-minus-2` = Builder(name = "Octagon-minus-2", defaultWidth = 24.0.dp, defaultHeight
...
private var `_octagon-minus-2`: ImageVector? = null

...
public val OutlineGroup.`Feather-off`: ImageVector
    get() {
        if (`_feather-off` != null) {
            return `_feather-off`!!
        }
        `_feather-off` = Builder(name = "Feather-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_feather-off`: ImageVector? = null

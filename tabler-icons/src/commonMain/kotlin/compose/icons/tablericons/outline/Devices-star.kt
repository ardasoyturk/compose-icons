...
public val OutlineGroup.`Devices-star`: ImageVector
    get() {
        if (`_devices-star` != null) {
            return `_devices-star`!!
        }
        `_devices-star` = Builder(name = "Devices-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_devices-star`: ImageVector? = null

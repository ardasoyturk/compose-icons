...
public val OutlineGroup.`Satellite-off`: ImageVector
    get() {
        if (`_satellite-off` != null) {
            return `_satellite-off`!!
        }
        `_satellite-off` = Builder(name = "Satellite-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_satellite-off`: ImageVector? = null

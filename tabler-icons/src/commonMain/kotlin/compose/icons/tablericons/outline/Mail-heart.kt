...
public val OutlineGroup.`Mail-heart`: ImageVector
    get() {
        if (`_mail-heart` != null) {
            return `_mail-heart`!!
        }
        `_mail-heart` = Builder(name = "Mail-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_mail-heart`: ImageVector? = null

...
public val FilledGroup.`Play-card-q`: ImageVector
    get() {
        if (`_play-card-q` != null) {
            return `_play-card-q`!!
        }
        `_play-card-q` = Builder(name = "Play-card-q", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_play-card-q`: ImageVector? = null

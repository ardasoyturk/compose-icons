...
public val OutlineGroup.`Brand-aws`: ImageVector
    get() {
        if (`_brand-aws` != null) {
            return `_brand-aws`!!
        }
        `_brand-aws` = Builder(name = "Brand-aws", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-aws`: ImageVector? = null

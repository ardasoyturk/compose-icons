...
public val OutlineGroup.`Recycle-off`: ImageVector
    get() {
        if (`_recycle-off` != null) {
            return `_recycle-off`!!
        }
        `_recycle-off` = Builder(name = "Recycle-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_recycle-off`: ImageVector? = null

...
public val OutlineGroup.`Circle-dashed-percentage`: ImageVector
    get() {
        if (`_circle-dashed-percentage` != null) {
            return `_circle-dashed-percentage`!!
        }
        `_circle-dashed-percentage` = Builder(name = "Circle-dashed-percentage", defaultWidth =
...
private var `_circle-dashed-percentage`: ImageVector? = null

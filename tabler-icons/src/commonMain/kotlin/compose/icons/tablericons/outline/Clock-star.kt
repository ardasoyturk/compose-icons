...
public val OutlineGroup.`Clock-star`: ImageVector
    get() {
        if (`_clock-star` != null) {
            return `_clock-star`!!
        }
        `_clock-star` = Builder(name = "Clock-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_clock-star`: ImageVector? = null

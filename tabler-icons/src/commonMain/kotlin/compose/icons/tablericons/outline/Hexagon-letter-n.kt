...
public val OutlineGroup.`Hexagon-letter-n`: ImageVector
    get() {
        if (`_hexagon-letter-n` != null) {
            return `_hexagon-letter-n`!!
        }
        `_hexagon-letter-n` = Builder(name = "Hexagon-letter-n", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-n`: ImageVector? = null

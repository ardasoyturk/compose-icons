...
public val OutlineGroup.`Cloud-share`: ImageVector
    get() {
        if (`_cloud-share` != null) {
            return `_cloud-share`!!
        }
        `_cloud-share` = Builder(name = "Cloud-share", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-share`: ImageVector? = null

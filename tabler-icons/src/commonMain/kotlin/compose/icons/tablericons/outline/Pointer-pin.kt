...
public val OutlineGroup.`Pointer-pin`: ImageVector
    get() {
        if (`_pointer-pin` != null) {
            return `_pointer-pin`!!
        }
        `_pointer-pin` = Builder(name = "Pointer-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-pin`: ImageVector? = null

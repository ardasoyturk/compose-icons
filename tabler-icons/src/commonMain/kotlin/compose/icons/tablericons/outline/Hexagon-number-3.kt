...
public val OutlineGroup.`Hexagon-number-3`: ImageVector
    get() {
        if (`_hexagon-number-3` != null) {
            return `_hexagon-number-3`!!
        }
        `_hexagon-number-3` = Builder(name = "Hexagon-number-3", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-3`: ImageVector? = null

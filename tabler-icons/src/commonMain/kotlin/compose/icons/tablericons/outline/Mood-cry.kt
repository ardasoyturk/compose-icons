...
public val OutlineGroup.`Mood-cry`: ImageVector
    get() {
        if (`_mood-cry` != null) {
            return `_mood-cry`!!
        }
        `_mood-cry` = Builder(name = "Mood-cry", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mood-cry`: ImageVector? = null

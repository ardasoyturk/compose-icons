...
public val OutlineGroup.`Writing-sign-off`: ImageVector
    get() {
        if (`_writing-sign-off` != null) {
            return `_writing-sign-off`!!
        }
        `_writing-sign-off` = Builder(name = "Writing-sign-off", defaultWidth = 24.0.dp,
...
private var `_writing-sign-off`: ImageVector? = null

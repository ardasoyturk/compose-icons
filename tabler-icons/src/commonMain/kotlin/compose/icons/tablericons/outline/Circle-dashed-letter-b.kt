...
public val OutlineGroup.`Circle-dashed-letter-b`: ImageVector
    get() {
        if (`_circle-dashed-letter-b` != null) {
            return `_circle-dashed-letter-b`!!
        }
        `_circle-dashed-letter-b` = Builder(name = "Circle-dashed-letter-b", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-b`: ImageVector? = null

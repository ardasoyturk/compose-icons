...
public val OutlineGroup.`Brand-leetcode`: ImageVector
    get() {
        if (`_brand-leetcode` != null) {
            return `_brand-leetcode`!!
        }
        `_brand-leetcode` = Builder(name = "Brand-leetcode", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-leetcode`: ImageVector? = null

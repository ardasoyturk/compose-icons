...
public val OutlineGroup.`Filter-pause`: ImageVector
    get() {
        if (`_filter-pause` != null) {
            return `_filter-pause`!!
        }
        `_filter-pause` = Builder(name = "Filter-pause", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-pause`: ImageVector? = null

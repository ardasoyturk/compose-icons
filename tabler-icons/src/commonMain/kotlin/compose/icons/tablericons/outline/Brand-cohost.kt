...
public val OutlineGroup.`Brand-cohost`: ImageVector
    get() {
        if (`_brand-cohost` != null) {
            return `_brand-cohost`!!
        }
        `_brand-cohost` = Builder(name = "Brand-cohost", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cohost`: ImageVector? = null

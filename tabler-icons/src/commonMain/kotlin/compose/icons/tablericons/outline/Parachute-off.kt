...
public val OutlineGroup.`Parachute-off`: ImageVector
    get() {
        if (`_parachute-off` != null) {
            return `_parachute-off`!!
        }
        `_parachute-off` = Builder(name = "Parachute-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_parachute-off`: ImageVector? = null

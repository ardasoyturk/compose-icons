...
public val LucideIcons.BadgeTurkishLira: ImageVector
    get() {
        if (_badgeTurkishLira != null) {
            return _badgeTurkishLira!!
        }
        _badgeTurkishLira = Builder(name = "BadgeTurkishLira", defaultWidth = 24.0.dp, defaultHeight

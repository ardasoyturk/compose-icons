...
public val OutlineGroup.`Rosette-number-1`: ImageVector
    get() {
        if (`_rosette-number-1` != null) {
            return `_rosette-number-1`!!
        }
        `_rosette-number-1` = Builder(name = "Rosette-number-1", defaultWidth = 24.0.dp,
...
private var `_rosette-number-1`: ImageVector? = null

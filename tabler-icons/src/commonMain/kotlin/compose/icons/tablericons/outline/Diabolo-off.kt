...
public val OutlineGroup.`Diabolo-off`: ImageVector
    get() {
        if (`_diabolo-off` != null) {
            return `_diabolo-off`!!
        }
        `_diabolo-off` = Builder(name = "Diabolo-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_diabolo-off`: ImageVector? = null

...
public val OutlineGroup.`Building-cog`: ImageVector
    get() {
        if (`_building-cog` != null) {
            return `_building-cog`!!
        }
        `_building-cog` = Builder(name = "Building-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_building-cog`: ImageVector? = null

...
public val OutlineGroup.`Phone-done`: ImageVector
    get() {
        if (`_phone-done` != null) {
            return `_phone-done`!!
        }
        `_phone-done` = Builder(name = "Phone-done", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-done`: ImageVector? = null

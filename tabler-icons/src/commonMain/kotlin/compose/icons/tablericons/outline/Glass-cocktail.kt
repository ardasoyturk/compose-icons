...
public val OutlineGroup.`Glass-cocktail`: ImageVector
    get() {
        if (`_glass-cocktail` != null) {
            return `_glass-cocktail`!!
        }
        `_glass-cocktail` = Builder(name = "Glass-cocktail", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_glass-cocktail`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-minus`: ImageVector
    get() {
        if (`_hexagon-minus` != null) {
            return `_hexagon-minus`!!
        }
        `_hexagon-minus` = Builder(name = "Hexagon-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hexagon-minus`: ImageVector? = null

...
public val OutlineGroup.`Pencil-pin`: ImageVector
    get() {
        if (`_pencil-pin` != null) {
            return `_pencil-pin`!!
        }
        `_pencil-pin` = Builder(name = "Pencil-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pencil-pin`: ImageVector? = null

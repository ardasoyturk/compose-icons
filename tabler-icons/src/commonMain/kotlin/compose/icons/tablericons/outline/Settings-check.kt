...
public val OutlineGroup.`Settings-check`: ImageVector
    get() {
        if (`_settings-check` != null) {
            return `_settings-check`!!
        }
        `_settings-check` = Builder(name = "Settings-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-check`: ImageVector? = null

...
public val OutlineGroup.`Brand-solidjs`: ImageVector
    get() {
        if (`_brand-solidjs` != null) {
            return `_brand-solidjs`!!
        }
        `_brand-solidjs` = Builder(name = "Brand-solidjs", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-solidjs`: ImageVector? = null

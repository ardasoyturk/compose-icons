...
public val OutlineGroup.`Copyleft-off`: ImageVector
    get() {
        if (`_copyleft-off` != null) {
            return `_copyleft-off`!!
        }
        `_copyleft-off` = Builder(name = "Copyleft-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_copyleft-off`: ImageVector? = null

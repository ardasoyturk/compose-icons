...
public val OutlineGroup.`Message-circle-off`: ImageVector
    get() {
        if (`_message-circle-off` != null) {
            return `_message-circle-off`!!
        }
        `_message-circle-off` = Builder(name = "Message-circle-off", defaultWidth = 24.0.dp,
...
private var `_message-circle-off`: ImageVector? = null

...
public val OutlineGroup.`Pointer-check`: ImageVector
    get() {
        if (`_pointer-check` != null) {
            return `_pointer-check`!!
        }
        `_pointer-check` = Builder(name = "Pointer-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-check`: ImageVector? = null

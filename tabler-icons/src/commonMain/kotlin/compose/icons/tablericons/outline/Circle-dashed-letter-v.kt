...
public val OutlineGroup.`Circle-dashed-letter-v`: ImageVector
    get() {
        if (`_circle-dashed-letter-v` != null) {
            return `_circle-dashed-letter-v`!!
        }
        `_circle-dashed-letter-v` = Builder(name = "Circle-dashed-letter-v", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-v`: ImageVector? = null

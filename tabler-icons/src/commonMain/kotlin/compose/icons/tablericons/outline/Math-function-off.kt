...
public val OutlineGroup.`Math-function-off`: ImageVector
    get() {
        if (`_math-function-off` != null) {
            return `_math-function-off`!!
        }
        `_math-function-off` = Builder(name = "Math-function-off", defaultWidth = 24.0.dp,
...
private var `_math-function-off`: ImageVector? = null

...
public val OutlineGroup.`Bleach-no-chlorine`: ImageVector
    get() {
        if (`_bleach-no-chlorine` != null) {
            return `_bleach-no-chlorine`!!
        }
        `_bleach-no-chlorine` = Builder(name = "Bleach-no-chlorine", defaultWidth = 24.0.dp,
...
private var `_bleach-no-chlorine`: ImageVector? = null

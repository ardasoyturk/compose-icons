...
public val FilledGroup.`Forbid-2`: ImageVector
    get() {
        if (`_forbid-2` != null) {
            return `_forbid-2`!!
        }
        `_forbid-2` = Builder(name = "Forbid-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_forbid-2`: ImageVector? = null

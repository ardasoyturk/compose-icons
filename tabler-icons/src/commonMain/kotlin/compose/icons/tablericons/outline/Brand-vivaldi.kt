...
public val OutlineGroup.`Brand-vivaldi`: ImageVector
    get() {
        if (`_brand-vivaldi` != null) {
            return `_brand-vivaldi`!!
        }
        `_brand-vivaldi` = Builder(name = "Brand-vivaldi", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-vivaldi`: ImageVector? = null

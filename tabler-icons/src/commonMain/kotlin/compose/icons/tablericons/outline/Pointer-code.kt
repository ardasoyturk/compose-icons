...
public val OutlineGroup.`Pointer-code`: ImageVector
    get() {
        if (`_pointer-code` != null) {
            return `_pointer-code`!!
        }
        `_pointer-code` = Builder(name = "Pointer-code", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-code`: ImageVector? = null

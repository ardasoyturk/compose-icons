...
public val OutlineGroup.`Brand-wordpress`: ImageVector
    get() {
        if (`_brand-wordpress` != null) {
            return `_brand-wordpress`!!
        }
        `_brand-wordpress` = Builder(name = "Brand-wordpress", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-wordpress`: ImageVector? = null

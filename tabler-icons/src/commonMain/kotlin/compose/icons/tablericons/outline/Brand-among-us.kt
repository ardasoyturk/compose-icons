...
public val OutlineGroup.`Brand-among-us`: ImageVector
    get() {
        if (`_brand-among-us` != null) {
            return `_brand-among-us`!!
        }
        `_brand-among-us` = Builder(name = "Brand-among-us", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-among-us`: ImageVector? = null

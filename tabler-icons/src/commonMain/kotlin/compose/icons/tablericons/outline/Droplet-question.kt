...
public val OutlineGroup.`Droplet-question`: ImageVector
    get() {
        if (`_droplet-question` != null) {
            return `_droplet-question`!!
        }
        `_droplet-question` = Builder(name = "Droplet-question", defaultWidth = 24.0.dp,
...
private var `_droplet-question`: ImageVector? = null

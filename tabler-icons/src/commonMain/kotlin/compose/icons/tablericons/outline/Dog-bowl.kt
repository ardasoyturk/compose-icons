...
public val OutlineGroup.`Dog-bowl`: ImageVector
    get() {
        if (`_dog-bowl` != null) {
            return `_dog-bowl`!!
        }
        `_dog-bowl` = Builder(name = "Dog-bowl", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_dog-bowl`: ImageVector? = null

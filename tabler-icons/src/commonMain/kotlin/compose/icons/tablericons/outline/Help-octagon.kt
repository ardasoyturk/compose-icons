...
public val OutlineGroup.`Help-octagon`: ImageVector
    get() {
        if (`_help-octagon` != null) {
            return `_help-octagon`!!
        }
        `_help-octagon` = Builder(name = "Help-octagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_help-octagon`: ImageVector? = null

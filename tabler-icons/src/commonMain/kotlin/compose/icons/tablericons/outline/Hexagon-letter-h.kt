...
public val OutlineGroup.`Hexagon-letter-h`: ImageVector
    get() {
        if (`_hexagon-letter-h` != null) {
            return `_hexagon-letter-h`!!
        }
        `_hexagon-letter-h` = Builder(name = "Hexagon-letter-h", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-h`: ImageVector? = null

...
public val OutlineGroup.`Plane-arrival`: ImageVector
    get() {
        if (`_plane-arrival` != null) {
            return `_plane-arrival`!!
        }
        `_plane-arrival` = Builder(name = "Plane-arrival", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_plane-arrival`: ImageVector? = null

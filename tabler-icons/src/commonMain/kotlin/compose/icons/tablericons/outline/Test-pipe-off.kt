...
public val OutlineGroup.`Test-pipe-off`: ImageVector
    get() {
        if (`_test-pipe-off` != null) {
            return `_test-pipe-off`!!
        }
        `_test-pipe-off` = Builder(name = "Test-pipe-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_test-pipe-off`: ImageVector? = null

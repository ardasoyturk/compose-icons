...
public val OutlineGroup.`Brand-paypal`: ImageVector
    get() {
        if (`_brand-paypal` != null) {
            return `_brand-paypal`!!
        }
        `_brand-paypal` = Builder(name = "Brand-paypal", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-paypal`: ImageVector? = null

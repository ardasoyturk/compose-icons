...
public val OutlineGroup.`Photo-heart`: ImageVector
    get() {
        if (`_photo-heart` != null) {
            return `_photo-heart`!!
        }
        `_photo-heart` = Builder(name = "Photo-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-heart`: ImageVector? = null

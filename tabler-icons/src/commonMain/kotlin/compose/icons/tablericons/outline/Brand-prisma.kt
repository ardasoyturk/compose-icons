...
public val OutlineGroup.`Brand-prisma`: ImageVector
    get() {
        if (`_brand-prisma` != null) {
            return `_brand-prisma`!!
        }
        `_brand-prisma` = Builder(name = "Brand-prisma", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-prisma`: ImageVector? = null

...
public val OutlineGroup.`Navigation-share`: ImageVector
    get() {
        if (`_navigation-share` != null) {
            return `_navigation-share`!!
        }
        `_navigation-share` = Builder(name = "Navigation-share", defaultWidth = 24.0.dp,
...
private var `_navigation-share`: ImageVector? = null

...
public val OutlineGroup.`Plant-2-off`: ImageVector
    get() {
        if (`_plant-2-off` != null) {
            return `_plant-2-off`!!
        }
        `_plant-2-off` = Builder(name = "Plant-2-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_plant-2-off`: ImageVector? = null

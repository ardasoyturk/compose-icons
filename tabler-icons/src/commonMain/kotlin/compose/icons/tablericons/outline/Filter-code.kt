...
public val OutlineGroup.`Filter-code`: ImageVector
    get() {
        if (`_filter-code` != null) {
            return `_filter-code`!!
        }
        `_filter-code` = Builder(name = "Filter-code", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-code`: ImageVector? = null

...
public val OutlineGroup.`Camera-moon`: ImageVector
    get() {
        if (`_camera-moon` != null) {
            return `_camera-moon`!!
        }
        `_camera-moon` = Builder(name = "Camera-moon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_camera-moon`: ImageVector? = null

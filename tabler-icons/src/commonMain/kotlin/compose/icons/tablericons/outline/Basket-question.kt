...
public val OutlineGroup.`Basket-question`: ImageVector
    get() {
        if (`_basket-question` != null) {
            return `_basket-question`!!
        }
        `_basket-question` = Builder(name = "Basket-question", defaultWidth = 24.0.dp, defaultHeight
...
private var `_basket-question`: ImageVector? = null

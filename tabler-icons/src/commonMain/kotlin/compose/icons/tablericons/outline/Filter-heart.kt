...
public val OutlineGroup.`Filter-heart`: ImageVector
    get() {
        if (`_filter-heart` != null) {
            return `_filter-heart`!!
        }
        `_filter-heart` = Builder(name = "Filter-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-heart`: ImageVector? = null

...
public val OutlineGroup.`Empathize-off`: ImageVector
    get() {
        if (`_empathize-off` != null) {
            return `_empathize-off`!!
        }
        `_empathize-off` = Builder(name = "Empathize-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_empathize-off`: ImageVector? = null

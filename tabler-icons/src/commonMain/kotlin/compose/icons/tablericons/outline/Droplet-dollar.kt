...
public val OutlineGroup.`Droplet-dollar`: ImageVector
    get() {
        if (`_droplet-dollar` != null) {
            return `_droplet-dollar`!!
        }
        `_droplet-dollar` = Builder(name = "Droplet-dollar", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-dollar`: ImageVector? = null

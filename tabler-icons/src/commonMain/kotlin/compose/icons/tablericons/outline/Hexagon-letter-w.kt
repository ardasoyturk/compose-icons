...
public val OutlineGroup.`Hexagon-letter-w`: ImageVector
    get() {
        if (`_hexagon-letter-w` != null) {
            return `_hexagon-letter-w`!!
        }
        `_hexagon-letter-w` = Builder(name = "Hexagon-letter-w", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-w`: ImageVector? = null

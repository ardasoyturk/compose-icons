...
public val OutlineGroup.`Wash-press`: ImageVector
    get() {
        if (`_wash-press` != null) {
            return `_wash-press`!!
        }
        `_wash-press` = Builder(name = "Wash-press", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_wash-press`: ImageVector? = null

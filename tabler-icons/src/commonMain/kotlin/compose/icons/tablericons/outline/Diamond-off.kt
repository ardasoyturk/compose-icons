...
public val OutlineGroup.`Diamond-off`: ImageVector
    get() {
        if (`_diamond-off` != null) {
            return `_diamond-off`!!
        }
        `_diamond-off` = Builder(name = "Diamond-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_diamond-off`: ImageVector? = null

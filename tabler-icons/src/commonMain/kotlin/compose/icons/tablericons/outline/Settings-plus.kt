...
public val OutlineGroup.`Settings-plus`: ImageVector
    get() {
        if (`_settings-plus` != null) {
            return `_settings-plus`!!
        }
        `_settings-plus` = Builder(name = "Settings-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-plus`: ImageVector? = null

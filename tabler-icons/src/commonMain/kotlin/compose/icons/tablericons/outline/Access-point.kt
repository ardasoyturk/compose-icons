...
public val OutlineGroup.`Access-point`: ImageVector
    get() {
        if (`_access-point` != null) {
            return `_access-point`!!
        }
        `_access-point` = Builder(name = "Access-point", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_access-point`: ImageVector? = null

...
public val OutlineGroup.`Mood-boy`: ImageVector
    get() {
        if (`_mood-boy` != null) {
            return `_mood-boy`!!
        }
        `_mood-boy` = Builder(name = "Mood-boy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mood-boy`: ImageVector? = null

...
public val OutlineGroup.`Rosette-number-0`: ImageVector
    get() {
        if (`_rosette-number-0` != null) {
            return `_rosette-number-0`!!
        }
        `_rosette-number-0` = Builder(name = "Rosette-number-0", defaultWidth = 24.0.dp,
...
private var `_rosette-number-0`: ImageVector? = null

...
public val OutlineGroup.`Location-code`: ImageVector
    get() {
        if (`_location-code` != null) {
            return `_location-code`!!
        }
        `_location-code` = Builder(name = "Location-code", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_location-code`: ImageVector? = null

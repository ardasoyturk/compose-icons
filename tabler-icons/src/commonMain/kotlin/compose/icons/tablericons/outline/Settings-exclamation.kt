...
public val OutlineGroup.`Settings-exclamation`: ImageVector
    get() {
        if (`_settings-exclamation` != null) {
            return `_settings-exclamation`!!
        }
        `_settings-exclamation` = Builder(name = "Settings-exclamation", defaultWidth = 24.0.dp,
...
private var `_settings-exclamation`: ImageVector? = null

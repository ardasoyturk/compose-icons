...
public val OutlineGroup.`Cloud-up`: ImageVector
    get() {
        if (`_cloud-up` != null) {
            return `_cloud-up`!!
        }
        `_cloud-up` = Builder(name = "Cloud-up", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cloud-up`: ImageVector? = null

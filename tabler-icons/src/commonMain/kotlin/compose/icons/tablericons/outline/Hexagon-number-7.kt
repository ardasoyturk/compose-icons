...
public val OutlineGroup.`Hexagon-number-7`: ImageVector
    get() {
        if (`_hexagon-number-7` != null) {
            return `_hexagon-number-7`!!
        }
        `_hexagon-number-7` = Builder(name = "Hexagon-number-7", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-7`: ImageVector? = null

...
public val FilledGroup.`Alarm-minus`: ImageVector
    get() {
        if (`_alarm-minus` != null) {
            return `_alarm-minus`!!
        }
        `_alarm-minus` = Builder(name = "Alarm-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_alarm-minus`: ImageVector? = null

...
public val OutlineGroup.`Rosette-number-7`: ImageVector
    get() {
        if (`_rosette-number-7` != null) {
            return `_rosette-number-7`!!
        }
        `_rosette-number-7` = Builder(name = "Rosette-number-7", defaultWidth = 24.0.dp,
...
private var `_rosette-number-7`: ImageVector? = null

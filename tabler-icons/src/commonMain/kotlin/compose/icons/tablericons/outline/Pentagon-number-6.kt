...
public val OutlineGroup.`Pentagon-number-6`: ImageVector
    get() {
        if (`_pentagon-number-6` != null) {
            return `_pentagon-number-6`!!
        }
        `_pentagon-number-6` = Builder(name = "Pentagon-number-6", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-6`: ImageVector? = null

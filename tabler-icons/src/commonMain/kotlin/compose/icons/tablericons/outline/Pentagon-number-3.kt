...
public val OutlineGroup.`Pentagon-number-3`: ImageVector
    get() {
        if (`_pentagon-number-3` != null) {
            return `_pentagon-number-3`!!
        }
        `_pentagon-number-3` = Builder(name = "Pentagon-number-3", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-3`: ImageVector? = null

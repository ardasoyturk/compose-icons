...
public val OutlineGroup.`Package-off`: ImageVector
    get() {
        if (`_package-off` != null) {
            return `_package-off`!!
        }
        `_package-off` = Builder(name = "Package-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_package-off`: ImageVector? = null

...
public val OutlineGroup.`Panorama-vertical`: ImageVector
    get() {
        if (`_panorama-vertical` != null) {
            return `_panorama-vertical`!!
        }
        `_panorama-vertical` = Builder(name = "Panorama-vertical", defaultWidth = 24.0.dp,
...
private var `_panorama-vertical`: ImageVector? = null

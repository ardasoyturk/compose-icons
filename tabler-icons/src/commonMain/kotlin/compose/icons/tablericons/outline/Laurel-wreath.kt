...
public val OutlineGroup.`Laurel-wreath`: ImageVector
    get() {
        if (`_laurel-wreath` != null) {
            return `_laurel-wreath`!!
        }
        `_laurel-wreath` = Builder(name = "Laurel-wreath", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_laurel-wreath`: ImageVector? = null

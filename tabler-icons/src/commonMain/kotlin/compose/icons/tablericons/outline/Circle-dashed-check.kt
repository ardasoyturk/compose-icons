...
public val OutlineGroup.`Circle-dashed-check`: ImageVector
    get() {
        if (`_circle-dashed-check` != null) {
            return `_circle-dashed-check`!!
        }
        `_circle-dashed-check` = Builder(name = "Circle-dashed-check", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-check`: ImageVector? = null

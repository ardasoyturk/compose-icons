...
public val FilledGroup.`Box-align-right`: ImageVector
    get() {
        if (`_box-align-right` != null) {
            return `_box-align-right`!!
        }
        `_box-align-right` = Builder(name = "Box-align-right", defaultWidth = 24.0.dp, defaultHeight
...
private var `_box-align-right`: ImageVector? = null

...
public val OutlineGroup.`Device-desktop-star`: ImageVector
    get() {
        if (`_device-desktop-star` != null) {
            return `_device-desktop-star`!!
        }
        `_device-desktop-star` = Builder(name = "Device-desktop-star", defaultWidth = 24.0.dp,
...
private var `_device-desktop-star`: ImageVector? = null

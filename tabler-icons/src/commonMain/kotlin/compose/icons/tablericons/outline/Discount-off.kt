...
public val OutlineGroup.`Discount-off`: ImageVector
    get() {
        if (`_discount-off` != null) {
            return `_discount-off`!!
        }
        `_discount-off` = Builder(name = "Discount-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_discount-off`: ImageVector? = null

...
public val OutlineGroup.`Filter-down`: ImageVector
    get() {
        if (`_filter-down` != null) {
            return `_filter-down`!!
        }
        `_filter-down` = Builder(name = "Filter-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-down`: ImageVector? = null

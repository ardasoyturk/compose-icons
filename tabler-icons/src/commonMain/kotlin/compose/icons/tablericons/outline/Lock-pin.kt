...
public val OutlineGroup.`Lock-pin`: ImageVector
    get() {
        if (`_lock-pin` != null) {
            return `_lock-pin`!!
        }
        `_lock-pin` = Builder(name = "Lock-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lock-pin`: ImageVector? = null

...
public val OutlineGroup.`Droplet-off`: ImageVector
    get() {
        if (`_droplet-off` != null) {
            return `_droplet-off`!!
        }
        `_droplet-off` = Builder(name = "Droplet-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-off`: ImageVector? = null

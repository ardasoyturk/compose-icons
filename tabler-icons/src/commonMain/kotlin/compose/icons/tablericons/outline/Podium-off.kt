...
public val OutlineGroup.`Podium-off`: ImageVector
    get() {
        if (`_podium-off` != null) {
            return `_podium-off`!!
        }
        `_podium-off` = Builder(name = "Podium-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_podium-off`: ImageVector? = null

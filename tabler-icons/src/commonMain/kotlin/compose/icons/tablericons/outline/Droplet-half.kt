...
public val OutlineGroup.`Droplet-half`: ImageVector
    get() {
        if (`_droplet-half` != null) {
            return `_droplet-half`!!
        }
        `_droplet-half` = Builder(name = "Droplet-half", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-half`: ImageVector? = null

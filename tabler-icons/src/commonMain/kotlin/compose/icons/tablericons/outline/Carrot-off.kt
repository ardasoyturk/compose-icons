...
public val OutlineGroup.`Carrot-off`: ImageVector
    get() {
        if (`_carrot-off` != null) {
            return `_carrot-off`!!
        }
        `_carrot-off` = Builder(name = "Carrot-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_carrot-off`: ImageVector? = null

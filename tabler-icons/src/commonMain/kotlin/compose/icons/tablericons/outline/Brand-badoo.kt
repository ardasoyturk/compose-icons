...
public val OutlineGroup.`Brand-badoo`: ImageVector
    get() {
        if (`_brand-badoo` != null) {
            return `_brand-badoo`!!
        }
        `_brand-badoo` = Builder(name = "Brand-badoo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-badoo`: ImageVector? = null

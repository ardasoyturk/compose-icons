...
public val OutlineGroup.`Hand-finger-left`: ImageVector
    get() {
        if (`_hand-finger-left` != null) {
            return `_hand-finger-left`!!
        }
        `_hand-finger-left` = Builder(name = "Hand-finger-left", defaultWidth = 24.0.dp,
...
private var `_hand-finger-left`: ImageVector? = null

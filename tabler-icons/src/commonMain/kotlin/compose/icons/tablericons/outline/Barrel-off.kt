...
public val OutlineGroup.`Barrel-off`: ImageVector
    get() {
        if (`_barrel-off` != null) {
            return `_barrel-off`!!
        }
        `_barrel-off` = Builder(name = "Barrel-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_barrel-off`: ImageVector? = null

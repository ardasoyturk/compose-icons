...
public val OutlineGroup.`Hexagon-asterisk`: ImageVector
    get() {
        if (`_hexagon-asterisk` != null) {
            return `_hexagon-asterisk`!!
        }
        `_hexagon-asterisk` = Builder(name = "Hexagon-asterisk", defaultWidth = 24.0.dp,
...
private var `_hexagon-asterisk`: ImageVector? = null

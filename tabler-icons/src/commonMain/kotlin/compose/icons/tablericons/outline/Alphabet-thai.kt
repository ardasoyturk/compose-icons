...
public val OutlineGroup.`Alphabet-thai`: ImageVector
    get() {
        if (`_alphabet-thai` != null) {
            return `_alphabet-thai`!!
        }
        `_alphabet-thai` = Builder(name = "Alphabet-thai", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_alphabet-thai`: ImageVector? = null

...
public val OutlineGroup.`Hand-grab`: ImageVector
    get() {
        if (`_hand-grab` != null) {
            return `_hand-grab`!!
        }
        `_hand-grab` = Builder(name = "Hand-grab", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_hand-grab`: ImageVector? = null

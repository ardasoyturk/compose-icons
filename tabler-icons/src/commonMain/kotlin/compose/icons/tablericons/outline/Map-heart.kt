...
public val OutlineGroup.`Map-heart`: ImageVector
    get() {
        if (`_map-heart` != null) {
            return `_map-heart`!!
        }
        `_map-heart` = Builder(name = "Map-heart", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_map-heart`: ImageVector? = null

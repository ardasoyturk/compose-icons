...
public val OutlineGroup.`Circle-dashed-plus`: ImageVector
    get() {
        if (`_circle-dashed-plus` != null) {
            return `_circle-dashed-plus`!!
        }
        `_circle-dashed-plus` = Builder(name = "Circle-dashed-plus", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-plus`: ImageVector? = null

...
public val OutlineGroup.`Brand-cucumber`: ImageVector
    get() {
        if (`_brand-cucumber` != null) {
            return `_brand-cucumber`!!
        }
        `_brand-cucumber` = Builder(name = "Brand-cucumber", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cucumber`: ImageVector? = null

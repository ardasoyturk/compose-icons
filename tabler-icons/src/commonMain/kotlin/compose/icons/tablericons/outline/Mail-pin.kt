...
public val OutlineGroup.`Mail-pin`: ImageVector
    get() {
        if (`_mail-pin` != null) {
            return `_mail-pin`!!
        }
        `_mail-pin` = Builder(name = "Mail-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mail-pin`: ImageVector? = null

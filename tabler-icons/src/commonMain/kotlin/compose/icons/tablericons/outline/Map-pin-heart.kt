...
public val OutlineGroup.`Map-pin-heart`: ImageVector
    get() {
        if (`_map-pin-heart` != null) {
            return `_map-pin-heart`!!
        }
        `_map-pin-heart` = Builder(name = "Map-pin-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_map-pin-heart`: ImageVector? = null

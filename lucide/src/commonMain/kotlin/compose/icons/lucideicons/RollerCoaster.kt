...
public val LucideIcons.RollerCoaster: ImageVector
    get() {
        ...
        _rollerCoaster = Builder(name = "RollerCoaster", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(2.0f, 0.0f, 4.0f, 1.33f, 6.0f, 4.0f)
                reflectiveCurveToRelative(4.0f, 4.0f, 6.0f, 4.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, false, -3.0f, -6.65f)
            }
        }
        .build()
        return _rollerCoaster!!

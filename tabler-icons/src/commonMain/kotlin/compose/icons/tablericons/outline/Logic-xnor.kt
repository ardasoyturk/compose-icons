...
public val OutlineGroup.`Logic-xnor`: ImageVector
    get() {
        if (`_logic-xnor` != null) {
            return `_logic-xnor`!!
        }
        `_logic-xnor` = Builder(name = "Logic-xnor", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_logic-xnor`: ImageVector? = null

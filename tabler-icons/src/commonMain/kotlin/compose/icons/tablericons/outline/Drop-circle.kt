...
public val OutlineGroup.`Drop-circle`: ImageVector
    get() {
        if (`_drop-circle` != null) {
            return `_drop-circle`!!
        }
        `_drop-circle` = Builder(name = "Drop-circle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_drop-circle`: ImageVector? = null

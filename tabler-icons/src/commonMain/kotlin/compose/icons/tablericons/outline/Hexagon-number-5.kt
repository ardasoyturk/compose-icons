...
public val OutlineGroup.`Hexagon-number-5`: ImageVector
    get() {
        if (`_hexagon-number-5` != null) {
            return `_hexagon-number-5`!!
        }
        `_hexagon-number-5` = Builder(name = "Hexagon-number-5", defaultWidth = 24.0.dp,
...
private var `_hexagon-number-5`: ImageVector? = null

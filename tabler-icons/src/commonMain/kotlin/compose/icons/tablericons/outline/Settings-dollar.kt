...
public val OutlineGroup.`Settings-dollar`: ImageVector
    get() {
        if (`_settings-dollar` != null) {
            return `_settings-dollar`!!
        }
        `_settings-dollar` = Builder(name = "Settings-dollar", defaultWidth = 24.0.dp, defaultHeight
...
private var `_settings-dollar`: ImageVector? = null

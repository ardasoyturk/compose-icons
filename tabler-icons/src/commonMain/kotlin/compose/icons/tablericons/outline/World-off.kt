...
public val OutlineGroup.`World-off`: ImageVector
    get() {
        if (`_world-off` != null) {
            return `_world-off`!!
        }
        `_world-off` = Builder(name = "World-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_world-off`: ImageVector? = null

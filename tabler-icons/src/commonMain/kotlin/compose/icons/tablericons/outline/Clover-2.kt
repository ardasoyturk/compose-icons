...
public val OutlineGroup.`Clover-2`: ImageVector
    get() {
        if (`_clover-2` != null) {
            return `_clover-2`!!
        }
        `_clover-2` = Builder(name = "Clover-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_clover-2`: ImageVector? = null

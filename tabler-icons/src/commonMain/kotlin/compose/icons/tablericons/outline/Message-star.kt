...
public val OutlineGroup.`Message-star`: ImageVector
    get() {
        if (`_message-star` != null) {
            return `_message-star`!!
        }
        `_message-star` = Builder(name = "Message-star", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-star`: ImageVector? = null

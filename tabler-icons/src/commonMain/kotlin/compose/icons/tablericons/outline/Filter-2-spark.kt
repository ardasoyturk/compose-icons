...
public val OutlineGroup.`Filter-2-spark`: ImageVector
    get() {
        if (`_filter-2-spark` != null) {
            return `_filter-2-spark`!!
        }
        `_filter-2-spark` = Builder(name = "Filter-2-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-2-spark`: ImageVector? = null

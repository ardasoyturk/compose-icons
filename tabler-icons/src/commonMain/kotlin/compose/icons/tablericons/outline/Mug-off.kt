...
public val OutlineGroup.`Mug-off`: ImageVector
    get() {
        if (`_mug-off` != null) {
            return `_mug-off`!!
        }
        `_mug-off` = Builder(name = "Mug-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mug-off`: ImageVector? = null

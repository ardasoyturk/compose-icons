...
public val OutlineGroup.`Pentagon-number-8`: ImageVector
    get() {
        if (`_pentagon-number-8` != null) {
            return `_pentagon-number-8`!!
        }
        `_pentagon-number-8` = Builder(name = "Pentagon-number-8", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-8`: ImageVector? = null

...
public val OutlineGroup.`Basket-down`: ImageVector
    get() {
        if (`_basket-down` != null) {
            return `_basket-down`!!
        }
        `_basket-down` = Builder(name = "Basket-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_basket-down`: ImageVector? = null

...
public val OutlineGroup.`Pointer-pause`: ImageVector
    get() {
        if (`_pointer-pause` != null) {
            return `_pointer-pause`!!
        }
        `_pointer-pause` = Builder(name = "Pointer-pause", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-pause`: ImageVector? = null

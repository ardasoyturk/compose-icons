...
public val LucideIcons.BadgeCent: ImageVector
    get() {
        if (_badgeCent != null) {
            return _badgeCent!!
        }
        _badgeCent = Builder(name = "BadgeCent", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.4f, 10.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, false, 0.0f, 4.0f)
            }
        }
        .build()
        return _badgeCent!!

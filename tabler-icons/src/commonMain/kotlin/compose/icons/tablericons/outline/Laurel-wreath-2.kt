...
public val OutlineGroup.`Laurel-wreath-2`: ImageVector
    get() {
        if (`_laurel-wreath-2` != null) {
            return `_laurel-wreath-2`!!
        }
        `_laurel-wreath-2` = Builder(name = "Laurel-wreath-2", defaultWidth = 24.0.dp, defaultHeight
...
private var `_laurel-wreath-2`: ImageVector? = null

...
public val OutlineGroup.`Guitar-pick`: ImageVector
    get() {
        if (`_guitar-pick` != null) {
            return `_guitar-pick`!!
        }
        `_guitar-pick` = Builder(name = "Guitar-pick", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_guitar-pick`: ImageVector? = null

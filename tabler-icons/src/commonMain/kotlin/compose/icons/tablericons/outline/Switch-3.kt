...
public val OutlineGroup.`Switch-3`: ImageVector
    get() {
        if (`_switch-3` != null) {
            return `_switch-3`!!
        }
        `_switch-3` = Builder(name = "Switch-3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_switch-3`: ImageVector? = null

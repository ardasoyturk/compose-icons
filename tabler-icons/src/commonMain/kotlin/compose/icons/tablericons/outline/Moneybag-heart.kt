...
public val OutlineGroup.`Moneybag-heart`: ImageVector
    get() {
        if (`_moneybag-heart` != null) {
            return `_moneybag-heart`!!
        }
        `_moneybag-heart` = Builder(name = "Moneybag-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_moneybag-heart`: ImageVector? = null

...
public val LucideIcons.FileBracesCorner: ImageVector
    get() {
        if (_fileBracesCorner != null) {
            return _fileBracesCorner!!
        }
        _fileBracesCorner = Builder(name = "FileBracesCorner", defaultWidth = 24.0.dp, defaultHeight

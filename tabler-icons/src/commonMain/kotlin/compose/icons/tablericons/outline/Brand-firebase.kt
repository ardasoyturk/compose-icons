...
public val OutlineGroup.`Brand-firebase`: ImageVector
    get() {
        if (`_brand-firebase` != null) {
            return `_brand-firebase`!!
        }
        `_brand-firebase` = Builder(name = "Brand-firebase", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-firebase`: ImageVector? = null

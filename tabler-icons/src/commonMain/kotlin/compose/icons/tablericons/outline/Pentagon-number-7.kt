...
public val OutlineGroup.`Pentagon-number-7`: ImageVector
    get() {
        if (`_pentagon-number-7` != null) {
            return `_pentagon-number-7`!!
        }
        `_pentagon-number-7` = Builder(name = "Pentagon-number-7", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-7`: ImageVector? = null

...
public val OutlineGroup.`Alert-hexagon-off`: ImageVector
    get() {
        if (`_alert-hexagon-off` != null) {
            return `_alert-hexagon-off`!!
        }
        `_alert-hexagon-off` = Builder(name = "Alert-hexagon-off", defaultWidth = 24.0.dp,
...
private var `_alert-hexagon-off`: ImageVector? = null

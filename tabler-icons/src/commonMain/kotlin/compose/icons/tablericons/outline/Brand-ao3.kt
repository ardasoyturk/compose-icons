...
public val OutlineGroup.`Brand-ao3`: ImageVector
    get() {
        if (`_brand-ao3` != null) {
            return `_brand-ao3`!!
        }
        `_brand-ao3` = Builder(name = "Brand-ao3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-ao3`: ImageVector? = null

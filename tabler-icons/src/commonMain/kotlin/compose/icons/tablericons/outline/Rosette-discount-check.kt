...
public val OutlineGroup.`Rosette-discount-check`: ImageVector
    get() {
        if (`_rosette-discount-check` != null) {
            return `_rosette-discount-check`!!
        }
        `_rosette-discount-check` = Builder(name = "Rosette-discount-check", defaultWidth = 24.0.dp,
...
private var `_rosette-discount-check`: ImageVector? = null

...
public val OutlineGroup.`Navigation-off`: ImageVector
    get() {
        if (`_navigation-off` != null) {
            return `_navigation-off`!!
        }
        `_navigation-off` = Builder(name = "Navigation-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_navigation-off`: ImageVector? = null

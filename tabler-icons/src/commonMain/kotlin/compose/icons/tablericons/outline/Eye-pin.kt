...
public val OutlineGroup.`Eye-pin`: ImageVector
    get() {
        if (`_eye-pin` != null) {
            return `_eye-pin`!!
        }
        `_eye-pin` = Builder(name = "Eye-pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-pin`: ImageVector? = null

...
public val OutlineGroup.`Ironing-3`: ImageVector
    get() {
        if (`_ironing-3` != null) {
            return `_ironing-3`!!
        }
        `_ironing-3` = Builder(name = "Ironing-3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ironing-3`: ImageVector? = null

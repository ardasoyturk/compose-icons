...
public val OutlineGroup.`Bleach-off`: ImageVector
    get() {
        if (`_bleach-off` != null) {
            return `_bleach-off`!!
        }
        `_bleach-off` = Builder(name = "Bleach-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bleach-off`: ImageVector? = null

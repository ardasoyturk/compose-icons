...
public val OutlineGroup.`Aerial-lift`: ImageVector
    get() {
        if (`_aerial-lift` != null) {
            return `_aerial-lift`!!
        }
        `_aerial-lift` = Builder(name = "Aerial-lift", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_aerial-lift`: ImageVector? = null

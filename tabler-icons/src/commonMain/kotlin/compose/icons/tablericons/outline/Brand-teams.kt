...
public val OutlineGroup.`Brand-teams`: ImageVector
    get() {
        if (`_brand-teams` != null) {
            return `_brand-teams`!!
        }
        `_brand-teams` = Builder(name = "Brand-teams", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-teams`: ImageVector? = null

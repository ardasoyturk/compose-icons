...
public val OutlineGroup.`Brand-cakephp`: ImageVector
    get() {
        if (`_brand-cakephp` != null) {
            return `_brand-cakephp`!!
        }
        `_brand-cakephp` = Builder(name = "Brand-cakephp", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cakephp`: ImageVector? = null

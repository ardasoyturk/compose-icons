...
public val OutlineGroup.`Copy-minus`: ImageVector
    get() {
        if (`_copy-minus` != null) {
            return `_copy-minus`!!
        }
        `_copy-minus` = Builder(name = "Copy-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_copy-minus`: ImageVector? = null

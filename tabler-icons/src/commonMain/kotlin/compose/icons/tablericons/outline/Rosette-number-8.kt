...
public val OutlineGroup.`Rosette-number-8`: ImageVector
    get() {
        if (`_rosette-number-8` != null) {
            return `_rosette-number-8`!!
        }
        `_rosette-number-8` = Builder(name = "Rosette-number-8", defaultWidth = 24.0.dp,
...
private var `_rosette-number-8`: ImageVector? = null

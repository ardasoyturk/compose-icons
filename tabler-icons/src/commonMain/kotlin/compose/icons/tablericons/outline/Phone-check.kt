...
public val OutlineGroup.`Phone-check`: ImageVector
    get() {
        if (`_phone-check` != null) {
            return `_phone-check`!!
        }
        `_phone-check` = Builder(name = "Phone-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-check`: ImageVector? = null

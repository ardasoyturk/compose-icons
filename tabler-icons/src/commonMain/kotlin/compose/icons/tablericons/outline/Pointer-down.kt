...
public val OutlineGroup.`Pointer-down`: ImageVector
    get() {
        if (`_pointer-down` != null) {
            return `_pointer-down`!!
        }
        `_pointer-down` = Builder(name = "Pointer-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-down`: ImageVector? = null

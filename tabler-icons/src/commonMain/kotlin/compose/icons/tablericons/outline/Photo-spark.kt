...
public val OutlineGroup.`Photo-spark`: ImageVector
    get() {
        if (`_photo-spark` != null) {
            return `_photo-spark`!!
        }
        `_photo-spark` = Builder(name = "Photo-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_photo-spark`: ImageVector? = null

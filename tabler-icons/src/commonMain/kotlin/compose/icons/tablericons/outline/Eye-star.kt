...
public val OutlineGroup.`Eye-star`: ImageVector
    get() {
        if (`_eye-star` != null) {
            return `_eye-star`!!
        }
        `_eye-star` = Builder(name = "Eye-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eye-star`: ImageVector? = null

...
public val OutlineGroup.`Device-tablet-heart`: ImageVector
    get() {
        if (`_device-tablet-heart` != null) {
            return `_device-tablet-heart`!!
        }
        `_device-tablet-heart` = Builder(name = "Device-tablet-heart", defaultWidth = 24.0.dp,
...
private var `_device-tablet-heart`: ImageVector? = null

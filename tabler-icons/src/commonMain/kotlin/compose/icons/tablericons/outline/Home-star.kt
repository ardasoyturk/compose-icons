...
public val OutlineGroup.`Home-star`: ImageVector
    get() {
        if (`_home-star` != null) {
            return `_home-star`!!
        }
        `_home-star` = Builder(name = "Home-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_home-star`: ImageVector? = null

...
public val OutlineGroup.`Brand-apple-podcast`: ImageVector
    get() {
        if (`_brand-apple-podcast` != null) {
            return `_brand-apple-podcast`!!
        }
        `_brand-apple-podcast` = Builder(name = "Brand-apple-podcast", defaultWidth = 24.0.dp,
...
private var `_brand-apple-podcast`: ImageVector? = null

...
public val OutlineGroup.`Prism-plus`: ImageVector
    get() {
        if (`_prism-plus` != null) {
            return `_prism-plus`!!
        }
        `_prism-plus` = Builder(name = "Prism-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_prism-plus`: ImageVector? = null

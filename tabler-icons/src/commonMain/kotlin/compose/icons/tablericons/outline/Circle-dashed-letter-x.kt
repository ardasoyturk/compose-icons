...
public val OutlineGroup.`Circle-dashed-letter-x`: ImageVector
    get() {
        if (`_circle-dashed-letter-x` != null) {
            return `_circle-dashed-letter-x`!!
        }
        `_circle-dashed-letter-x` = Builder(name = "Circle-dashed-letter-x", defaultWidth = 24.0.dp,
...
private var `_circle-dashed-letter-x`: ImageVector? = null

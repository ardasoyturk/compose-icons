...
public val OutlineGroup.`Rotate-rectangle`: ImageVector
    get() {
        if (`_rotate-rectangle` != null) {
            return `_rotate-rectangle`!!
        }
        `_rotate-rectangle` = Builder(name = "Rotate-rectangle", defaultWidth = 24.0.dp,
...
private var `_rotate-rectangle`: ImageVector? = null

...
public val LucideIcons.ClipboardPenLine: ImageVector
    get() {
        if (_clipboardPenLine != null) {
            return _clipboardPenLine!!
        }
        _clipboardPenLine = Builder(name = "ClipboardPenLine", defaultWidth = 24.0.dp, defaultHeight

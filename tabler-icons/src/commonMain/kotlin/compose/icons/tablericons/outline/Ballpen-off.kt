...
public val OutlineGroup.`Ballpen-off`: ImageVector
    get() {
        if (`_ballpen-off` != null) {
            return `_ballpen-off`!!
        }
        `_ballpen-off` = Builder(name = "Ballpen-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ballpen-off`: ImageVector? = null

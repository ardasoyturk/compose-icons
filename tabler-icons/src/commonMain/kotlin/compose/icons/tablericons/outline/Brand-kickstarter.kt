...
public val OutlineGroup.`Brand-kickstarter`: ImageVector
    get() {
        if (`_brand-kickstarter` != null) {
            return `_brand-kickstarter`!!
        }
        `_brand-kickstarter` = Builder(name = "Brand-kickstarter", defaultWidth = 24.0.dp,
...
private var `_brand-kickstarter`: ImageVector? = null

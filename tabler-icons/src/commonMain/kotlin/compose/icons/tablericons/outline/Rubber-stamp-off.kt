...
public val OutlineGroup.`Rubber-stamp-off`: ImageVector
    get() {
        if (`_rubber-stamp-off` != null) {
            return `_rubber-stamp-off`!!
        }
        `_rubber-stamp-off` = Builder(name = "Rubber-stamp-off", defaultWidth = 24.0.dp,
...
private var `_rubber-stamp-off`: ImageVector? = null

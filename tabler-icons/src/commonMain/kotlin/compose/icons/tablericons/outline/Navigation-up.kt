...
public val OutlineGroup.`Navigation-up`: ImageVector
    get() {
        if (`_navigation-up` != null) {
            return `_navigation-up`!!
        }
        `_navigation-up` = Builder(name = "Navigation-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_navigation-up`: ImageVector? = null

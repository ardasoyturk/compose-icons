...
public val LucideIcons.FlameKindling: ImageVector
    get() {
        if (_flameKindling != null) {
            return _flameKindling!!
        }
        _flameKindling = Builder(name = "FlameKindling", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(8.0f, 4.5f, 11.0f, 2.0f, 12.0f, 2.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = strokeCapRound, strokeLineJoin =

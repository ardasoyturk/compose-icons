...
public val OutlineGroup.`Cardboards-off`: ImageVector
    get() {
        if (`_cardboards-off` != null) {
            return `_cardboards-off`!!
        }
        `_cardboards-off` = Builder(name = "Cardboards-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cardboards-off`: ImageVector? = null

...
public val OutlineGroup.`Variable-minus`: ImageVector
    get() {
        if (`_variable-minus` != null) {
            return `_variable-minus`!!
        }
        `_variable-minus` = Builder(name = "Variable-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_variable-minus`: ImageVector? = null

...
public val OutlineGroup.`Michelin-star-green`: ImageVector
    get() {
        if (`_michelin-star-green` != null) {
            return `_michelin-star-green`!!
        }
        `_michelin-star-green` = Builder(name = "Michelin-star-green", defaultWidth = 24.0.dp,
...
private var `_michelin-star-green`: ImageVector? = null

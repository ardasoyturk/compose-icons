...
public val OutlineGroup.`Filter-cog`: ImageVector
    get() {
        if (`_filter-cog` != null) {
            return `_filter-cog`!!
        }
        `_filter-cog` = Builder(name = "Filter-cog", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_filter-cog`: ImageVector? = null

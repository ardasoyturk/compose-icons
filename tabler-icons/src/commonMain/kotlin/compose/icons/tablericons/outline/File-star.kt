...
public val OutlineGroup.`File-star`: ImageVector
    get() {
        if (`_file-star` != null) {
            return `_file-star`!!
        }
        `_file-star` = Builder(name = "File-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_file-star`: ImageVector? = null

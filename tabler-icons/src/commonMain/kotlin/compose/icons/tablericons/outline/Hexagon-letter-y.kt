...
public val OutlineGroup.`Hexagon-letter-y`: ImageVector
    get() {
        if (`_hexagon-letter-y` != null) {
            return `_hexagon-letter-y`!!
        }
        `_hexagon-letter-y` = Builder(name = "Hexagon-letter-y", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-y`: ImageVector? = null

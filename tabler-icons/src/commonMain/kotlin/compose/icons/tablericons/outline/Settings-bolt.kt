...
public val OutlineGroup.`Settings-bolt`: ImageVector
    get() {
        if (`_settings-bolt` != null) {
            return `_settings-bolt`!!
        }
        `_settings-bolt` = Builder(name = "Settings-bolt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-bolt`: ImageVector? = null

...
public val OutlineGroup.`Triangle-off`: ImageVector
    get() {
        if (`_triangle-off` != null) {
            return `_triangle-off`!!
        }
        `_triangle-off` = Builder(name = "Triangle-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_triangle-off`: ImageVector? = null

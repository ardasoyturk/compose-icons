...
public val OutlineGroup.`Hexagon-letter-p`: ImageVector
    get() {
        if (`_hexagon-letter-p` != null) {
            return `_hexagon-letter-p`!!
        }
        `_hexagon-letter-p` = Builder(name = "Hexagon-letter-p", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-p`: ImageVector? = null

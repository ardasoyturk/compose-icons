...
public val OutlineGroup.`Brand-d3`: ImageVector
    get() {
        if (`_brand-d3` != null) {
            return `_brand-d3`!!
        }
        `_brand-d3` = Builder(name = "Brand-d3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brand-d3`: ImageVector? = null

...
public val OutlineGroup.`Brand-redhat`: ImageVector
    get() {
        if (`_brand-redhat` != null) {
            return `_brand-redhat`!!
        }
        `_brand-redhat` = Builder(name = "Brand-redhat", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-redhat`: ImageVector? = null

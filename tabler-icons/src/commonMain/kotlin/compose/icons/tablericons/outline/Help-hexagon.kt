...
public val OutlineGroup.`Help-hexagon`: ImageVector
    get() {
        if (`_help-hexagon` != null) {
            return `_help-hexagon`!!
        }
        `_help-hexagon` = Builder(name = "Help-hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_help-hexagon`: ImageVector? = null

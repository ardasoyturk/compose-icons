...
public val OutlineGroup.`Medal-2`: ImageVector
    get() {
        if (`_medal-2` != null) {
            return `_medal-2`!!
        }
        `_medal-2` = Builder(name = "Medal-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_medal-2`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-e`: ImageVector
    get() {
        if (`_hexagon-letter-e` != null) {
            return `_hexagon-letter-e`!!
        }
        `_hexagon-letter-e` = Builder(name = "Hexagon-letter-e", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-e`: ImageVector? = null

...
public val OutlineGroup.`Brand-discord`: ImageVector
    get() {
        if (`_brand-discord` != null) {
            return `_brand-discord`!!
        }
        `_brand-discord` = Builder(name = "Brand-discord", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-discord`: ImageVector? = null

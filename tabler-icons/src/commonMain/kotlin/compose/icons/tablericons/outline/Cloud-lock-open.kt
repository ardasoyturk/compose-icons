...
public val OutlineGroup.`Cloud-lock-open`: ImageVector
    get() {
        if (`_cloud-lock-open` != null) {
            return `_cloud-lock-open`!!
        }
        `_cloud-lock-open` = Builder(name = "Cloud-lock-open", defaultWidth = 24.0.dp, defaultHeight
...
private var `_cloud-lock-open`: ImageVector? = null

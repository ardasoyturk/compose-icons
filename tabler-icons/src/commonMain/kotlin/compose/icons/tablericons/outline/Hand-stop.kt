...
public val OutlineGroup.`Hand-stop`: ImageVector
    get() {
        if (`_hand-stop` != null) {
            return `_hand-stop`!!
        }
        `_hand-stop` = Builder(name = "Hand-stop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_hand-stop`: ImageVector? = null

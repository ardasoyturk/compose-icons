...
public val OutlineGroup.`Pentagon-number-4`: ImageVector
    get() {
        if (`_pentagon-number-4` != null) {
            return `_pentagon-number-4`!!
        }
        `_pentagon-number-4` = Builder(name = "Pentagon-number-4", defaultWidth = 24.0.dp,
...
private var `_pentagon-number-4`: ImageVector? = null

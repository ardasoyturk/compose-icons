...
public val OutlineGroup.`Brand-github`: ImageVector
    get() {
        if (`_brand-github` != null) {
            return `_brand-github`!!
        }
        `_brand-github` = Builder(name = "Brand-github", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-github`: ImageVector? = null

...
public val OutlineGroup.`Settings-question`: ImageVector
    get() {
        if (`_settings-question` != null) {
            return `_settings-question`!!
        }
        `_settings-question` = Builder(name = "Settings-question", defaultWidth = 24.0.dp,
...
private var `_settings-question`: ImageVector? = null

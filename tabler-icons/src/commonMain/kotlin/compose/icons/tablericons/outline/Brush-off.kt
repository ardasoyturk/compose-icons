...
public val OutlineGroup.`Brush-off`: ImageVector
    get() {
        if (`_brush-off` != null) {
            return `_brush-off`!!
        }
        `_brush-off` = Builder(name = "Brush-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_brush-off`: ImageVector? = null

...
public val OutlineGroup.`Shopping-bag-plus`: ImageVector
    get() {
        if (`_shopping-bag-plus` != null) {
            return `_shopping-bag-plus`!!
        }
        `_shopping-bag-plus` = Builder(name = "Shopping-bag-plus", defaultWidth = 24.0.dp,
...
private var `_shopping-bag-plus`: ImageVector? = null

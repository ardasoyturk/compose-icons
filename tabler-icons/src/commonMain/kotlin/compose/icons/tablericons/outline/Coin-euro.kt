...
public val OutlineGroup.`Coin-euro`: ImageVector
    get() {
        if (`_coin-euro` != null) {
            return `_coin-euro`!!
        }
        `_coin-euro` = Builder(name = "Coin-euro", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_coin-euro`: ImageVector? = null

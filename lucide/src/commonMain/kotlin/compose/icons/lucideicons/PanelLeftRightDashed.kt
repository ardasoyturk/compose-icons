...
public val LucideIcons.PanelLeftRightDashed: ImageVector
    get() {
        if (_panelLeftRightDashed != null) {
            return _panelLeftRightDashed!!
        }
        _panelLeftRightDashed = Builder(name = "PanelLeftRightDashed", defaultWidth = 24.0.dp,

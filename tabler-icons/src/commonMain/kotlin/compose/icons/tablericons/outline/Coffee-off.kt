...
public val OutlineGroup.`Coffee-off`: ImageVector
    get() {
        if (`_coffee-off` != null) {
            return `_coffee-off`!!
        }
        `_coffee-off` = Builder(name = "Coffee-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_coffee-off`: ImageVector? = null

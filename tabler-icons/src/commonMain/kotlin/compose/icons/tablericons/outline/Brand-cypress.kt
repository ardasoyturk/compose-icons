...
public val OutlineGroup.`Brand-cypress`: ImageVector
    get() {
        if (`_brand-cypress` != null) {
            return `_brand-cypress`!!
        }
        `_brand-cypress` = Builder(name = "Brand-cypress", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-cypress`: ImageVector? = null

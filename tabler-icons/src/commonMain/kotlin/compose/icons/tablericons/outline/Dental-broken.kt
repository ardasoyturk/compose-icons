...
public val OutlineGroup.`Dental-broken`: ImageVector
    get() {
        if (`_dental-broken` != null) {
            return `_dental-broken`!!
        }
        `_dental-broken` = Builder(name = "Dental-broken", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_dental-broken`: ImageVector? = null

...
public val OutlineGroup.`Pointer-search`: ImageVector
    get() {
        if (`_pointer-search` != null) {
            return `_pointer-search`!!
        }
        `_pointer-search` = Builder(name = "Pointer-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-search`: ImageVector? = null

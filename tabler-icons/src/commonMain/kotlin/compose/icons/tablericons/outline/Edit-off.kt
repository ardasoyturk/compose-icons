...
public val OutlineGroup.`Edit-off`: ImageVector
    get() {
        if (`_edit-off` != null) {
            return `_edit-off`!!
        }
        `_edit-off` = Builder(name = "Edit-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_edit-off`: ImageVector? = null

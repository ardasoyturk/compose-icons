...
public val OutlineGroup.`Device-watch-heart`: ImageVector
    get() {
        if (`_device-watch-heart` != null) {
            return `_device-watch-heart`!!
        }
        `_device-watch-heart` = Builder(name = "Device-watch-heart", defaultWidth = 24.0.dp,
...
private var `_device-watch-heart`: ImageVector? = null

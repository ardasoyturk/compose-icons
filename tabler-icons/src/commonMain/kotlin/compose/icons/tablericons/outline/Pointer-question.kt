...
public val OutlineGroup.`Pointer-question`: ImageVector
    get() {
        if (`_pointer-question` != null) {
            return `_pointer-question`!!
        }
        `_pointer-question` = Builder(name = "Pointer-question", defaultWidth = 24.0.dp,
...
private var `_pointer-question`: ImageVector? = null

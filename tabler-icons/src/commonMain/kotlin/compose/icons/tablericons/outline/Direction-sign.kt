...
public val OutlineGroup.`Direction-sign`: ImageVector
    get() {
        if (`_direction-sign` != null) {
            return `_direction-sign`!!
        }
        `_direction-sign` = Builder(name = "Direction-sign", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_direction-sign`: ImageVector? = null

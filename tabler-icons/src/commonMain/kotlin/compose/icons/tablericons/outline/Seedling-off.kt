...
public val OutlineGroup.`Seedling-off`: ImageVector
    get() {
        if (`_seedling-off` != null) {
            return `_seedling-off`!!
        }
        `_seedling-off` = Builder(name = "Seedling-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_seedling-off`: ImageVector? = null

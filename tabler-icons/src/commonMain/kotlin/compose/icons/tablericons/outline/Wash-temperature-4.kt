...
public val OutlineGroup.`Wash-temperature-4`: ImageVector
    get() {
        if (`_wash-temperature-4` != null) {
            return `_wash-temperature-4`!!
        }
        `_wash-temperature-4` = Builder(name = "Wash-temperature-4", defaultWidth = 24.0.dp,
...
private var `_wash-temperature-4`: ImageVector? = null

...
public val OutlineGroup.`Crown-off`: ImageVector
    get() {
        if (`_crown-off` != null) {
            return `_crown-off`!!
        }
        `_crown-off` = Builder(name = "Crown-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_crown-off`: ImageVector? = null

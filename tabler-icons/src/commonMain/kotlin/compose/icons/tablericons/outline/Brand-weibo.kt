...
public val OutlineGroup.`Brand-weibo`: ImageVector
    get() {
        if (`_brand-weibo` != null) {
            return `_brand-weibo`!!
        }
        `_brand-weibo` = Builder(name = "Brand-weibo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-weibo`: ImageVector? = null

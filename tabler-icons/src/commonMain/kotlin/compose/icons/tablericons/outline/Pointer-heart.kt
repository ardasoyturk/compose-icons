...
public val OutlineGroup.`Pointer-heart`: ImageVector
    get() {
        if (`_pointer-heart` != null) {
            return `_pointer-heart`!!
        }
        `_pointer-heart` = Builder(name = "Pointer-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pointer-heart`: ImageVector? = null

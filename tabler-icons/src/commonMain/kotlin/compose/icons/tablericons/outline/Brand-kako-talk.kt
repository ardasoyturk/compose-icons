...
public val OutlineGroup.`Brand-kako-talk`: ImageVector
    get() {
        if (`_brand-kako-talk` != null) {
            return `_brand-kako-talk`!!
        }
        `_brand-kako-talk` = Builder(name = "Brand-kako-talk", defaultWidth = 24.0.dp, defaultHeight
...
private var `_brand-kako-talk`: ImageVector? = null

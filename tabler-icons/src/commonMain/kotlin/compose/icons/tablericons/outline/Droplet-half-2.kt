...
public val OutlineGroup.`Droplet-half-2`: ImageVector
    get() {
        if (`_droplet-half-2` != null) {
            return `_droplet-half-2`!!
        }
        `_droplet-half-2` = Builder(name = "Droplet-half-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_droplet-half-2`: ImageVector? = null

...
public val OutlineGroup.`Solar-panel-2`: ImageVector
    get() {
        if (`_solar-panel-2` != null) {
            return `_solar-panel-2`!!
        }
        `_solar-panel-2` = Builder(name = "Solar-panel-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_solar-panel-2`: ImageVector? = null

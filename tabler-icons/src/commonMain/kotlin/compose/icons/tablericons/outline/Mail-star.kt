...
public val OutlineGroup.`Mail-star`: ImageVector
    get() {
        if (`_mail-star` != null) {
            return `_mail-star`!!
        }
        `_mail-star` = Builder(name = "Mail-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mail-star`: ImageVector? = null

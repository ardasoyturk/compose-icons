...
public val OutlineGroup.`Message-circle-heart`: ImageVector
    get() {
        if (`_message-circle-heart` != null) {
            return `_message-circle-heart`!!
        }
        `_message-circle-heart` = Builder(name = "Message-circle-heart", defaultWidth = 24.0.dp,
...
private var `_message-circle-heart`: ImageVector? = null

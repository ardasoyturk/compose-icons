...
public val OutlineGroup.`Device-mobile-star`: ImageVector
    get() {
        if (`_device-mobile-star` != null) {
            return `_device-mobile-star`!!
        }
        `_device-mobile-star` = Builder(name = "Device-mobile-star", defaultWidth = 24.0.dp,
...
private var `_device-mobile-star`: ImageVector? = null

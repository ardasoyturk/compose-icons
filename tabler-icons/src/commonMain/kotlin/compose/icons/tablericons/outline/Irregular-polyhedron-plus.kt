...
public val OutlineGroup.`Irregular-polyhedron-plus`: ImageVector
    get() {
        if (`_irregular-polyhedron-plus` != null) {
            return `_irregular-polyhedron-plus`!!
        }
        `_irregular-polyhedron-plus` = Builder(name = "Irregular-polyhedron-plus", defaultWidth =
...
private var `_irregular-polyhedron-plus`: ImageVector? = null

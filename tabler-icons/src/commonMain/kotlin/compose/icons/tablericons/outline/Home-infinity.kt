...
public val OutlineGroup.`Home-infinity`: ImageVector
    get() {
        if (`_home-infinity` != null) {
            return `_home-infinity`!!
        }
        `_home-infinity` = Builder(name = "Home-infinity", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-infinity`: ImageVector? = null

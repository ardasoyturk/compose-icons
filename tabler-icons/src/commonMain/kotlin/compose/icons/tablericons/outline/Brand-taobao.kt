...
public val OutlineGroup.`Brand-taobao`: ImageVector
    get() {
        if (`_brand-taobao` != null) {
            return `_brand-taobao`!!
        }
        `_brand-taobao` = Builder(name = "Brand-taobao", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-taobao`: ImageVector? = null

...
public val OutlineGroup.`Hexagon-letter-v`: ImageVector
    get() {
        if (`_hexagon-letter-v` != null) {
            return `_hexagon-letter-v`!!
        }
        `_hexagon-letter-v` = Builder(name = "Hexagon-letter-v", defaultWidth = 24.0.dp,
...
private var `_hexagon-letter-v`: ImageVector? = null

...
public val OutlineGroup.`Cube-spark`: ImageVector
    get() {
        if (`_cube-spark` != null) {
            return `_cube-spark`!!
        }
        `_cube-spark` = Builder(name = "Cube-spark", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cube-spark`: ImageVector? = null

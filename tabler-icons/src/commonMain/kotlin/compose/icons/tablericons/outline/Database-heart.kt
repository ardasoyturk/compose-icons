...
public val OutlineGroup.`Database-heart`: ImageVector
    get() {
        if (`_database-heart` != null) {
            return `_database-heart`!!
        }
        `_database-heart` = Builder(name = "Database-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-heart`: ImageVector? = null

...
public val OutlineGroup.`Hand-move`: ImageVector
    get() {
        if (`_hand-move` != null) {
            return `_hand-move`!!
        }
        `_hand-move` = Builder(name = "Hand-move", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_hand-move`: ImageVector? = null

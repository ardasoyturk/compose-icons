...
public val LucideIcons.BookmarkX: ImageVector
    get() {
        if (_bookmarkX != null) {
            return _bookmarkX!!
        }
        _bookmarkX = Builder(name = "BookmarkX", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -1.984f, 0.0f)
                lineToRelative(-4.512f, 2.578f)

...
public val OutlineGroup.`Brand-hexo`: ImageVector
    get() {
        if (`_brand-hexo` != null) {
            return `_brand-hexo`!!
        }
        `_brand-hexo` = Builder(name = "Brand-hexo", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-hexo`: ImageVector? = null

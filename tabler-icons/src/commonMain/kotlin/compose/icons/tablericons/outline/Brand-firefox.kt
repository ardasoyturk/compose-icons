...
public val OutlineGroup.`Brand-firefox`: ImageVector
    get() {
        if (`_brand-firefox` != null) {
            return `_brand-firefox`!!
        }
        `_brand-firefox` = Builder(name = "Brand-firefox", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brand-firefox`: ImageVector? = null

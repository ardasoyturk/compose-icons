...
public val OutlineGroup.`Assembly-off`: ImageVector
    get() {
        if (`_assembly-off` != null) {
            return `_assembly-off`!!
        }
        `_assembly-off` = Builder(name = "Assembly-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_assembly-off`: ImageVector? = null

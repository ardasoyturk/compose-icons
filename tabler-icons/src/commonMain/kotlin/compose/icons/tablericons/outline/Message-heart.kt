...
public val OutlineGroup.`Message-heart`: ImageVector
    get() {
        if (`_message-heart` != null) {
            return `_message-heart`!!
        }
        `_message-heart` = Builder(name = "Message-heart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-heart`: ImageVector? = null

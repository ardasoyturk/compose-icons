...
public val OutlineGroup.`Michelin-bib-gourmand`: ImageVector
    get() {
        if (`_michelin-bib-gourmand` != null) {
            return `_michelin-bib-gourmand`!!
        }
        `_michelin-bib-gourmand` = Builder(name = "Michelin-bib-gourmand", defaultWidth = 24.0.dp,
...
private var `_michelin-bib-gourmand`: ImageVector? = null

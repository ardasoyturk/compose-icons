...
public val OutlineGroup.`Scribble-off`: ImageVector
    get() {
        if (`_scribble-off` != null) {
            return `_scribble-off`!!
        }
        `_scribble-off` = Builder(name = "Scribble-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_scribble-off`: ImageVector? = null

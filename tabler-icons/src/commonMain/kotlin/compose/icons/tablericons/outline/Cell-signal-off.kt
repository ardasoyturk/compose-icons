...
public val OutlineGroup.`Cell-signal-off`: ImageVector
    get() {
        if (`_cell-signal-off` != null) {
            return `_cell-signal-off`!!
        }
        `_cell-signal-off` = Builder(name = "Cell-signal-off", defaultWidth = 24.0.dp, defaultHeight
...
private var `_cell-signal-off`: ImageVector? = null

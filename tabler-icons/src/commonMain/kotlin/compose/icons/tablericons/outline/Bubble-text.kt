...
public val OutlineGroup.`Bubble-text`: ImageVector
    get() {
        if (`_bubble-text` != null) {
            return `_bubble-text`!!
        }
        `_bubble-text` = Builder(name = "Bubble-text", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bubble-text`: ImageVector? = null

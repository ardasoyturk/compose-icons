...
public val OutlineGroup.`Settings-share`: ImageVector
    get() {
        if (`_settings-share` != null) {
            return `_settings-share`!!
        }
        `_settings-share` = Builder(name = "Settings-share", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_settings-share`: ImageVector? = null

...
public val OutlineGroup.`Device-vision-pro`: ImageVector
    get() {
        if (`_device-vision-pro` != null) {
            return `_device-vision-pro`!!
        }
        `_device-vision-pro` = Builder(name = "Device-vision-pro", defaultWidth = 24.0.dp,
...
private var `_device-vision-pro`: ImageVector? = null

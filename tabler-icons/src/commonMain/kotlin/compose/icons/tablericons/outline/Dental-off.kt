...
public val OutlineGroup.`Dental-off`: ImageVector
    get() {
        if (`_dental-off` != null) {
            return `_dental-off`!!
        }
        `_dental-off` = Builder(name = "Dental-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_dental-off`: ImageVector? = null

...
public val OutlineGroup.`Settings-automation`: ImageVector
    get() {
        if (`_settings-automation` != null) {
            return `_settings-automation`!!
        }
        `_settings-automation` = Builder(name = "Settings-automation", defaultWidth = 24.0.dp,
...
private var `_settings-automation`: ImageVector? = null

...
public val OutlineGroup.`Folder-pin`: ImageVector
    get() {
        if (`_folder-pin` != null) {
            return `_folder-pin`!!
        }
        `_folder-pin` = Builder(name = "Folder-pin", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-pin`: ImageVector? = null
